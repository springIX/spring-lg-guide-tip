          ...
          <section id="line-up" name="buying-guide-content">
            ...
            <div class="tab-content">
              ...
              >
                ...
                <div class="text-wrap">
                  <h4>공간이 넉넉하지 않아도 단정하고 청결하게</h4>
                  <p>
                    좁은 공간에서도 설치 걱정 없이 사용해요. 셔츠 3벌까지 한
                    번에 케어하고, 고압 스티머로 잔주름부터 소매 끝까지 깔끔하게
                    관리해 단정한 출근룩을 완성해 보세요.
                  </p>
                </div>
                <p class="note">
                  * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및
                    ...
                    >
                      ...
                      <div class="content">
                        ...
                        <p>
                          ...
                          실용성이 뛰어납니다. 빌트인 고압 스티머로 셔츠의
                          잔주름부터 소매 끝까지 매끄럽게 다림질하듯 관리할 수
                          있으며, 내부 공간을 효율적으로 활용해 부담 없이 깔끔한
                  ...
                  <div class="subtab-content">
                    ...
                    >
                      ...
                      <div class="content">
                        <h5>스팀 탈취</h5>
                        <p>
                          강력한 트루스팀으로 생활 속 냄새를 제거해 의류를 깔끔하게 관리합니다. 한 번의 코스로 음식 냄새, 땀 냄새, 담배 냄새 등 일상에서 자연스럽게 발생하는 냄새를 99% 제거해 더욱 쾌적한 의류 관리가 가능합니다.
                        </p>
                        <div class="img">
                          <img
                    ...
                    >
                      ...
                      <div class="content">
                        <h5>건조</h5>
                        <p>
                          장마철 비에 젖은 옷이나 세탁 후 바로 입기 어려운 의류,
                          매일 세탁하는 운동복까지 저온으로 부드럽게 건조해 옷감
                          손상 없이 쾌적한 착용감을 제공합니다. 의류에 맞게 자연
                          건조보다 빠르고 섬세하게 말리며, 무빙행어가 옷을
                          부드럽게 흔들어 구김을 최소화합니다. 한 올 한 올의
                          촉감을 살려 뽀송하고 산뜻하게 건조합니다.
                        </p>
                        <div class="img">
                          <img
