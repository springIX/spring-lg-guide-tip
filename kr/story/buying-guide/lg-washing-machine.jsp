        ...
        <div class="tab-content">
          <div id="product-type-1" name="product-type">
            ...
            <div class="text-wrap">
              ...
              <p>
                세탁기와 건조기가 아래 위로 놓여 있어 하나의 바디에서 세탁과 건조를 편리하게 할 수 있어요. 디스플레이가 제품 중간에 있어 조작이 편리하고 세탁기와 건조기를 각각 직렬로 설치했을 때보다
          ...
          <div id="product-type-2" name="product-type" style="display: none">
            ...
            <div class="text-wrap">
              ...
              <p>
                세탁부터 건조까지 세탁물을 옮길 필요없이 하나의 통안에서 한번에 세탁건조하는 올인원 제품입니다. 세탁기 한대의 공간만 있으면 설치가 가능하여 공간을 효율적으로 활용 할 수 있어요.
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr class="procuct-spec">
                        <td>
                          ...
                          <p>
                            ...
                            <span class="des">
                              <button class="info pc-only"></button>
                              <span class="bubble">세탁물의 무게와 재질, 오염도 등을 감지해 최적의 모션으로<br class="mo-only"> 세탁부터 건조까지</span>
                            </span>
                          </p>
                        </td>
                        <td>
                      ...
                      <tr class="procuct-spec">
                        <td>
                          <div class="spec-img">
                            <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_steam.svg" alt="트루스팀" />
                          </div>
                          <p>
                            트루스팀
                            <span class="des">
                      ...
                      <tr class="procuct-spec">
                        <td class="disabled">
                          ...
                          <p>
                            ...
                            <span class="des">
                              <button class="info pc-only"></button>
                              <span class="bubble">4kg 용량의 미니 세탁기로 함께 빨기 걱정되는 다양한<br class="mo-only"> 세탁물을 간편하게 분리 세탁</span>
                            </span>
                          </p>
                        </td>
                        <td>
              ...
              <div class="subtab-content">
                <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                  ...
                  <div class="content">
                    <h5>워시타워</h5>
                    <p>
                      25kg 용량의 세탁기와 25kg의 용량의 건조기가 수직으로 쌓인 구조를 통해 세탁과 건조를 동시에 진행할 수 있어요. 기본적으로 용량이 넉넉해 이불처럼 부피가 큰 빨래를 자주
                  ...
                  <div class="content">
                    <h5>워시타워 컴팩트</h5>
                    <p>
                      13kg 용량의 세탁기와 10kg 용량의 건조기가 수직으로 쌓인 구조를 통해 세탁과 건조를 동시에 진행할 수 있는 건 물론, 컴팩트한 사이즈로 설치 공간에 대한 걱정은
                ...
                <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                  ...
                  <div class="content">
                    <h5>워시콤보</h5>
                    <p>
                      하나의 통 안에서 세탁과 건조를 한 번에 해결할 수 있는 제품입니다. 23/15kg와 25/15kg 종류가 있어서  가정에서 유연하게 용량을 선택할 수 있어요. 세탁기 한 대의
                ...
                <div class="point-wrap" id="buying-point-1-3" name="buying-point-1" style="display: none">
                  ...
                  <div class="content">
                    <h5>25kg 최대용량</h5>
                    <p>
                      구성원이 많거나 대체적으로 세탁물이 많은 가족이라면 대용량 세탁기로 한 번에 빨래를 끝낼 수 있는 21~25kg의 대용량을 추천합니다. 이불, 커튼, 겨울 점퍼처럼 부피가 큰
            ...
            <div class="point-tip" id="point-tip1">
              ...
              <div class="tip-content">
                <div class="content">
                  ...
                  <p class="tip-text">
                    워시타워는 넉넉한 용량의 세탁기와 건조기가 직렬로 구성되어, 평소 세탁량이 많거나 이불처럼 부피가 큰 세탁물의 세탁이 잦은 가구에 추천드립니다. 세탁기가 작동하는 동안 건조기를
                    동시에 사용할 수 있어, 세탁 효율을 높일 수 있는 점도 장점입니다. 반면, 설치 공간에 대한 고민이 있다면 워시콤보를 추천드립니다. 세탁기 한 대의 컴팩트한 사이즈로 설치가
                    가능하면서도, 25kg의 넉넉한 세탁 용량과 15kg의 합리적인 건조 용량을 하나의 통 안에서 구현해 세탁물을 옮길 필요 없이 세탁부터 건조까지 이어서 사용할 수 있습니다.
                  </p>
                </div>
                <div class="img">
            ...
            <div class="point-tip" id="point-tip2" style="display: none">
              ...
              <div class="tip-content">
                <div class="content">
                  ...
                  <p class="tip-text">
                    세균이 특히 걱정되는 아기 옷이나 반려동물 용품, 속옷처럼 따로 관리하고 싶은 세탁물이 있을 때가 있죠. 이럴 때는 미니워시로 분리 세탁해보세요. 4kg 용량으로 부피가 크지 않은
                    빨래를 효율적으로 동시에 세탁이 가능하고, 세탁기 하단에 설치되어 투입구 높이를 높여주어 허리를 덜 숙이고 편리하게 사용할 수 있습니다. 분리 세탁이 크게 필요 없으신 경우,
                    내부가 바구니 형태로 설계된 키높이 수납함을 활용해보세요. 세탁 용품을 깔끔하게 정리할 수 있고, 세탁기 투입구 높이도 함께 높여 세탁 동선을 한층 편리하게 만들어줍니다.
                  </p>
                </div>
                <div class="img">
          ...
          <div class="point-tip" id="point-tip4">
            ...
            <div class="tip-content">
              <div class="content">
                ...
                <p class="tip-text">
                  매일 반복되는 세탁과 건조, 이제는 더 여유롭게 바꿔보세요. AI 기능이 세탁물의 무게와 재질, 오염도까지 감지해 세탁부터 건조까지 알아서 최적의 코스로 진행해줘요. 옷감에 맞는
                  코스를 고민할 필요 없이, 손상은 줄이고 세탁의 효율은 높여줘요. 시간이 부족해도 세탁만큼은 완벽하게 마무리할 수 있어요. 일상적인 루틴에 고민할 여유가 부족한 맞벌이 부부, 직장인
                  분들께 최고의 선택이에요.
                </p>
              </div>
              <div class="img">
          ...
          <div class="point-tip" id="point-tip5" style="display: none">
            ...
            <div class="tip-content">
              <div class="content">
                ...
                <p class="tip-text">
                  바쁜 출근 준비 시간도 효율적으로 사용하고 싶은 바쁜 직장인이나 맞벌이 부부처럼 시간 계획이 중요한 분들에게 추천드려요. AI가 나의 세탁량과 세탁 루틴을 분석하여 매번 시간을
                  확인하거나 설정을 일일이 조정해야 하는 번거로움을 줄여줘요. 세탁이 끝나는 시점에 맞춰 일정이나 다른 집안일을 병행할 수 있어, 불필요한 대기 시간을 줄이고 하루의 리듬을 깔끔하게
                  정돈할 수 있어요.
                </p>
              </div>
              <div class="img">
          ...
          <div class="point-tip" id="point-tip6" style="display: none">
            ...
            <div class="tip-content">
              <div class="content">
                ...
                <p class="tip-text">
                  매일 입는 일상복, 운동복부터 관리가 어려운 다양한 소재의 의류를 간편하게 관리해보세요. 세탁부터 건조까지 AI로 맞춤 관리가 가능한 워시타워는 옷의 무게와 오염도를 파악해 알맞은
                  모션으로 의류 관리를 도와줍니다.
                </p>
              </div>
              <div class="img">
            ...
            <div class="subtab-content">
              <div class="point-wrap" id="buying-point-2-3" name="buying-point-2">
                ...
                <div class="content">
                  ...
                  <button class="btn-collapse-toggle">
                    <span>* 바이러스 제거-세탁 / 유해세균 살균-세탁 / 알러지 유발물질 제거-세탁 / 유해세균 살균-건조 / 바이러스 제거-건조 / 알러지 유발물질 제거-건조 / 꽃가루 알레르겐 불활성화-건조 / 탈취-건조 / 구김제거-건조</span>
                  </button>
                  <div class="collapse-content">
                    ...
                    <p>
                      ...
                      * 시험 코스 : 스팀살균<br />
                      * 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하, UL Solutions 마른상태 4kg/ KATRI 마른상태 4kg, 젖은상태 6.5kg<br />
                      * 시험 균 : 유해세균 3종 (황색포도상구균, 녹농균, 폐렴간균)<br />
                      * 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />
                    ...
                    <p>
                      ...
                      <br />* 시험 기관 : Environmental Allergens Info and Care Inc.(일본소재) / 시험 일자 : ‘25년 04월<br />* 시험 코스 : 스팀살균<br />* 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 1.5kg, 젖은상태 2.7kg<br />* 시험 알레르겐 : 집먼지진드기 성충, 고양이 (Fel d 1), 개(Can f 1), 집먼지진드기 (Der f1)<br />* 시험 방법 : 집먼지 진드기 및 알레르겐이 오염된 면직물 부착하여 스팀살균 코스 동작 후 집먼지 진드기 살충 및 알레르겐 제거율 확인<br />* 시험 결과 : 집먼지 진드기 성충 100% 살충, 고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f 1) 알레르겐 99.9% 제거<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                    </p>
                    <p>
                      <b>[꽃가루 알레르겐 불활성화-건조]</b><br />
                      <br />* 시험 기관 : Environmental Allergens Info and Care Inc.(일본소재) / 시험 일자 : ‘25년 04월<br />* 시험 코스 : 스팀살균코스<br />* 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 4.5kg, 젖은상태 7kg<br />* 시험 알레르겐 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet v 1), 벼과(Phl p 5)<br />* 시험 방법 : 꽃가루 알레르겐이 오염된 면직물 부착하여 스팀살균 코스 동작 후 꽃가루 알레르겐 불활성화율 확인<br />* 시험 결과 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet v 1), 벼과(Phl p 5) 99% 이상 불활성화<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                    </p>
                    <p>
                      <b>[탈취-건조]</b><br />
                      <br />* 시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월<br />* 시험 코스 : 스팀리프레쉬<br />* 시험 부하 : KS C IEC60456 표준셔츠 7벌<br />* 냄새 분자 : 땀냄새, 담배냄새<br />* 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />* 시험 방법 : 스팀리프레쉬 코스 동작 후 탈취력 측정<br />* 시험 결과 : 땀냄새, 담배냄새 99% 제거<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                    </p>
                    <p>
                      <b>[구김제거-건조]</b><br />
                      <br />* 시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월<br />* 시험 코스 : 스팀리프레쉬<br />* 시험 부하 : KS C IEC60456 표준셔츠 2장, 5장<br />* 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />* 시험 방법 : 자사가 제시한 시험 기준으로, 셔츠 등판 300mm x 300mm 기준 셔츠에 임의 구김을 부여한 후, 셔츠를 무작위로 선택하여건조기 동작 전, 후 AATCC 시험평가판으로 비교<br />* 시험 결과 : 구김정도 시험 전 대비 2배 이상 완화 됨.<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                    </p>
                    <button class="btn-collapse-close">접기</button>
                  </div>
                </div>
              ...
              <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                ...
                <div class="content">
                  <h5>자동세제함 플러스</h5>
                  <p>
                    세제와 유연제를 원하는 대로 선택은 물론 세탁물의 무게와 오염도를 감지해 자동으로 적정량을 투입해 줍니다. 세탁 코스에 따라 알맞은 세제를 투입하고 세제 종류에 따라 투입량도
                    원하는 대로 설정할 수 있습니다.
                  </p>
                  <div class="img">
                  ...
                  <div>
                    <div class="content-wrap">
                      <div>
                        <h4>콘덴서 자동 세척</h4>
                        <p>
                          콘덴서는 젖은 빨래에서 발생하는 따뜻하고 습한 공기를 건조한 공기로 바꿔주는 핵심 부품입니다. 콘덴서 자동 세척 기능은 필터에서 거르지 못한 먼지가 쌓이는 것을 방지해,
                    ...
                    <div class="detail-wrap">
                      ...
                      <div class="collapse-content">
                        <p>
                          * 모든 건조코스에서 콘덴서 자동세척 시스템 동작 , 단 건조 코스가 아닌 침구털기코스, 송풍코스 등은 이후 젖은 옷감으로 건조행정 시 콘덴서 자동세척 진행. 
                          <br />
                    ...
                    <div class="detail-wrap">
                      ...
                      <div class="collapse-content">
                        <p>
                          ...
                          * 시험 결과 : 필터 내부, 콘덴서 전면, 열교환기 전면, 드럼 후면, 팬, 드럼 내부, 드럼 리프터, 도어 내부, 열교환기 하단, 필터 하단, 시작점, 열풍이동 끝점
      ...
      <section class="useful-tip">
        ...
        <div class="tip-wrap">
          ...
          <div class="tip-subscribe">
            ...
            <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
              <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/washing_machines">세탁기 구독 상품</a>
