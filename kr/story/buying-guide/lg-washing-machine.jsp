  ...
  <%@ include file="/WEB-INF/jsp/common/includes/doctype.jsp" %>
    <% Cookie[] cookies=request.getCookies(); if (cookies !=null) { for (Cookie cookie : cookies) { if
      ...
      <head>
        ...
        <meta name="keywords" content="LG전자, 세탁기, 건조기, 워시타워, 워시콤보, 트롬 세탁기, 통돌이 세탁기, 디오스, 오브제컬렉션, 구매가이드">
        <meta name="description" content="세척과 의류 관리를 더 스마트하게">
        <meta content="NOODP, NOYDIR" name="robots">
        <link rel="canonical" href="canonical">
        <title>워시타워·워시콤보·트롬 세탁기·통돌이 세탁기 구매 가이드 | 구매 가이드 | 가이드 | 스토리 | LG전자</title>

        <meta property="fb:app_id" content="562434687259858">
        <meta property="og:locale" content="ko_KR">
        <meta property="og:site_name" content="LG전자">
        <meta property="og:type" content="website">
        <meta property="og:title" content="워시타워·워시콤보·트롬 세탁기·통돌이 세탁기 구매 가이드 | 구매 가이드 | 가이드 | 스토리 | LG전자">
      ...
      <body>
        ...
        <div class="wrap subRenewWrap subRenewWrap--share subRenewWrap--story">
          ...
          <div itemtype="http://schema.org/WebPage" itemscope class="sr-only">
            <meta itemprop="name" content="워시타워·워시콤보·트롬 세탁기·통돌이 세탁기 구매 가이드 | 구매 가이드 | 가이드 | 스토리 | LG전자" />
            ...
            <meta itemprop="Keywords" content="LG전자, 세탁기, 건조기, 워시타워, 워시콤보, 트롬 세탁기, 통돌이 세탁기, 디오스, 오브제컬렉션, 구매가이드" />
          </div>
          ...
          <div class="top-banner autoplay-slider-wrap">
            <div class="content">
              <div class="inner-wrap">
                <h2>워시타워·워시콤보·트롬 세탁기·<br />통돌이 세탁기 구매 가이드</h2>
                <p>세척과 의류 관리를 더 스마트하게</p>
              </div>
            </div>
            <div class="slider">
              <div>
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_01.jpg"
                  alt="크림색 바닥 위에 LG 오브제컬렉션 세탁기가 정면으로 놓여 있고, 옆에는 세탁물 바구니가 놓여 있습니다." class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_01.jpg"
                  alt="크림색 바닥 위에 LG 오브제컬렉션 세탁기가 정면으로 놓여 있고, 옆에는 세탁물 바구니가 놓여 있습니다." class="mobile-only" />
              </div>
              <div>
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_04.jpg"
                  alt="밝은 색상의 LG 세탁기가 실내 공간에 놓여 있으며, 옆에는 빨래 바구니와 장식용 꽃병이 있습니다." class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_04.jpg"
                  alt="밝은 색상의 LG 세탁기가 실내 공간에 놓여 있으며, 옆에는 빨래 바구니와 장식용 꽃병이 있습니다." class="mobile-only" />
              </div>
              <div>
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_03.jpg"
                  ...
                  class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_03.jpg"
                  alt="흰색 바닥 위에 놓인 LG 세탁·건조기 콤보 제품의 전면 모습입니다. 위쪽 기기는 짙은 녹색, 아래쪽 기기는 흰색이며, 왼쪽에는 옅은 베이지색 의자와 작은 탁자가 놓여 있습니다. 오른쪽에는 화분이 배치되어 있고, 배경은 흰색 벽과 아치형 나무 격자 장식으로 꾸며져 있습니다."
                  class="mobile-only" />
              </div>
            </div>
          ...
          <div class="guide-wrap inner-wrap">
            <section id="line-up" name="buying-guide-content">
              ...
              <h3 class="section-title">
                ...
                <b>워시타워·워시콤보·트롬 세탁기·통돌이 세탁기</b>를
                추천해드려요.<br />
                공간과 사용 목적에 따라 꼭 맞는 제품을 골라보세요.
              </h3>
              <div class="tab-wrap sticky" style="--btn-width: 280px; --btn-m-width: 215px">
              ...
              <button class="nav nav-right">></button> -->
                <div class="vertical-scroll-box">
                  <button class="tab-img active" name="buying-guide-tab" data-target="#product-type-1"
                    ...
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_07.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-2"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_08.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-3"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_05.png"
                      alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 2" />
                    <span><b>트롬 세탁기</b>#AI #맞춤세탁</span>
                  </button>
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-4"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_40.png"
              ...
              <div class="tab-content">
                <div id="product-type-1" name="product-type">
                  <div class="img-wrap">
                    ...
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_11.jpg"
                      alt="실내에 설치된 LG 워시타워로, 상단에는 녹색 건조기, 하단에는 흰색 세탁기가 세로로 구성되어 있습니다. 오른쪽에는 선반과 수납장이 있는 모듈형 선반이 배치되어 있으며, 양쪽 벽은 흰색 타일로 마감되어 있습니다."
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_07.jpg"
                      alt="실내에 설치된 LG 워시타워로, 상단에는 녹색 건조기, 하단에는 흰색 세탁기가 세로로 구성되어 있습니다. 오른쪽에는 선반과 수납장이 있는 모듈형 선반이 배치되어 있으며, 양쪽 벽은 흰색 타일로 마감되어 있습니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                    ...
                    <p>
                      세탁기와 건조기가 아래 위로 놓여 있어 하나의 바디에서 세탁과 건조를 편리하게 할 수 있어요. 디스플레이가 제품 중간에 있어 조작이 편리하고 세탁기와 건조기를 각각 직렬로
                      설치했을 때보다
                      투입구 높이가 낮아 세탁물을 넣고, 빼기가 편리합니다. 건조와 동시에 세탁이 가능해 평소 세탁물의 양이 많다면, 효율적인 세탁을 위해 워시타워를 선택해보세요.
                    </p>
                  </div>
                  <p class="note">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_60.png"
                                    alt="워시타워 LG 트롬 AI 오브제컬렉션 워시타워 (WA2525EGZF.AKOR) 메인이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_61.png"
                                    alt="워시타워 LG 트롬 AI 오브제컬렉션 워시타워 (WA2525EGZF.AKOR) 줌이미지 10" class="side" />
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_62.png"
                                    alt="워시타워 LG 트롬 AI 오브제컬렉션 워시타워 (WA2525EGZF.AKOR) 메인이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_63.png"
                                    alt="워시타워 LG 트롬 AI 오브제컬렉션 워시타워 (WA2525EGZF.AKOR) 줌이미지 10" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_64.png"
                                    alt="워시타워 LG 트롬 오브제컬렉션 워시타워 (WL21WDU.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_65.png"
                                    alt="워시타워 LG 트롬 오브제컬렉션 워시타워 (WL21WDU.AKOR) 줌이미지 8" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_66.png"
                                    alt="워시타워 LG 트롬 오브제컬렉션 워시타워 컴팩트 (W10BN.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_67.png"
                                    alt="워시타워 LG 트롬 오브제컬렉션 워시타워 컴팩트 (W10BN.AKOR) 줌이미지 8" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_weight.svg"
                                    alt="세탁 25kg / 건조 25kg" />
                                </div>
                                <p>
                                  세탁 25kg / 건조 25kg
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_AItime.svg"
                                    alt="AI 타임센싱" />
                                </div>
                                <p>
                                  AI 타임센싱
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">
                                      세탁물 투입 후 3초 안에 빠르게 알려주는 코스별 세탁·건조 예상 시간
                                    </span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁물 투입 후 3초 안에 빠르게 알려주는 코스별 세탁·건조 예상 시간
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_AInotify.svg"
                                    alt="AI 시간안내" />
                                </div>
                                <p>
                                  AI 시간안내
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">건조기를 사용할수록 더욱 정확도가 높아지는 건조 예상 시간
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_AIreport.svg"
                                    alt="AI 세탁리포트" />
                                </div>
                                <p>
                                  AI 세탁리포트
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁·건조가 끝나면 물, 에너지 사용량 등을 한눈에 볼 수 있는 리포트
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_autocleanerplus.svg"
                                    alt="자동세제함 플러스" />
                                </div>
                                <p>
                                  자동세제함 플러스
                              ...
                              <td class="disabled">
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_1h.svg"
                                    alt="1시간 세탁-건조 코스" />
                                </div>
                                <p>
                                  1시간 세탁-건조 코스
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_dualsteam.svg"
                                    alt="듀얼 트루스팀(세탁/건조스팀)" />
                                </div>
                                <p>
                                  듀얼 트루스팀<br class="mo-only">(세탁/건조스팀)
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁부터 건조까지 스팀케어로 살균, 탈취, 구김 완화까지 간편하게 관리
                                    </span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_steam.svg"
                                    alt="트루스팀(건조스팀)" />
                                </div>
                                <p>
                                  트루스팀<br class="mo-only">(건조스팀)
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">건조 단계에 트루스팀으로 살균, 탈취와 구김 완화까지 간편하게 관리
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">조작부를 한 화면에 담은 풀터치 LCD 디스플레이로 한눈에 쉽고 빠르게 조작
                                    </span>
                                  </span>
                                </p>
                              </td>
                ...
                <div id="product-type-2" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_12.jpg"
                      alt="현대적인 욕실 내부에 위치한 밝은 베이지색 LG 세탁기입니다. 세탁기 옆에는 둥근 짚으로 엮은 빨래 바구니가 있고, 창밖으로는 눈 덮인 풍경이 보입니다. 세면대 위에는 수건이 가지런히 놓여 있습니다."
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_08.jpg"
                      alt="현대적인 욕실 내부에 위치한 밝은 베이지색 LG 세탁기입니다. 세탁기 옆에는 둥근 짚으로 엮은 빨래 바구니가 있고, 창밖으로는 눈 덮인 풍경이 보입니다. 세면대 위에는 수건이 가지런히 놓여 있습니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                    ...
                    <p>
                      세탁부터 건조까지 세탁물을 옮길 필요없이 하나의 통안에서 한번에 세탁건조하는 올인원 제품입니다. 세탁기 한대의 공간만 있으면 설치가 가능하여 공간을 효율적으로 활용 할 수
                      있어요.
                      미니워시를 추가 설치하면 건조하는 동안 양말 또는 속옷같은 소량 세탁물도 빠르게 세탁 할 수 있어요.
                    </p>
                  </div>
                  <p class="note">
                    * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary2" style="--col-width: 50%; --table-width: 320px">
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr class="procuct-img-wrap">
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_55 1.png"
                                    alt="워시콤보 LG SIGNATURE 세탁건조기 (FH25LMTH.AKOR) 메인이미지 5" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_56 1.png"
                                    alt="워시콤보 LG SIGNATURE 세탁건조기 (FH25LMTH.AKOR) 줌이미지 7" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_57 1.png"
                                    alt="워시콤보 LG 트롬 오브제컬렉션 워시콤보 (FH25ESE.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_58 1.png"
                                    alt="워시콤보 LG 트롬 오브제컬렉션 워시콤보 (FH25ESE.AKOR) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">대용량 세탁과 건조를 옮길 필요 없이 단 하나의 통안에서 해결</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_deepAI.svg"
                                    alt="딥러닝 AI X 6모션" />
                                </div>
                                <p>
                                  딥러닝 AI X 6모션
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁물의 무게와 재질, 오염도 등을 감지해 최적의 모션으로<br class="mo-only"> 세탁부터
                                      건조까지</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              ...
                              <td class="disabled">
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_5turbo.svg"
                                    alt="5방향 터보샷+" />
                                </div>
                                <p>
                                  5방향 터보샷+
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">다섯 방향의 터보샷이 시간과 물을 절약하며 깨끗하게</span>
                                  </span>
                                </p>
                              </td>
                            </tr>
                            <tr class="procuct-spec">
                              <td class="disabled">
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_miniwash.svg"
                                    alt="미니워시" />
                                </div>
                                <p>
                                  미니워시
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">4kg 용량의 미니 세탁기로 함께 빨기 걱정되는 다양한<br class="mo-only"> 세탁물을 간편하게 분리
                                      세탁</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_autocleaner.svg"
                                    alt="자동세제함" />
                                </div>
                                <p>
                                  자동세제함
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁량과 오염량에 맞춰 세제·유연제를
                                      자동으로 알맞게</span>
                                  </span>
                                </p>
                              </td>
                ...
                <div id="product-type-3" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                      <div class="bubble">
                        <a href="https://wwwstg.lge.co.kr/washing-machines/fx25efe" target="_blank"><span>LG 트롬 AI
                            오브제컬렉션
                            세탁기</span></a>
                        <p>25kg<span></span>1등급</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_09.jpg"
                      alt="아이보리색 LG 세탁기가 밝은 배경 앞에 놓여 있으며, 옆에는 밝은색 선반이 놓여 있습니다." class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_05.jpg"
                      alt="아이보리색 LG 세탁기가 밝은 배경 앞에 놓여 있으며, 옆에는 밝은색 선반이 놓여 있습니다." class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary3" style="--col-width: 25%; --table-width: 608px">
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                            <div>트롬세탁기<span></span><br class="mo-only">트루스팀/자동세제함</div>
                            <div>트롬세탁기<span></span><br class="mo-only">트루스팀</div>
                            <div>트롬세탁기<span></span><br class="mo-only">자동세제함</div>
                            <div>트롬세탁기</div>
                          </div>
                        </div>
                      </div>
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr class="procuct-img-wrap">
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_85.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_86.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_87.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_88.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_89.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_90.png"
                                    alt="세탁기 LG 트롬 오브제컬렉션 세탁기 (FX25WSQ.AKOR2) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_91.png"
                                    alt="세탁기 LG 꼬망스 플러스 (F8VV.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_92.png"
                                    alt="세탁기 LG 꼬망스 플러스 (F8VV.AKOR) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              ...
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">넉넉한 21kg 세탁
                                      용량으로 이불 등 큰 빨래도 여유있게 세탁</span>
                                  </span>
                                </p>
                              </td>
                            </tr>
                            <tr class="procuct-spec">
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁물 투입 후 3초 안에 빠르게 알려주는 코스별 세탁·건조 예상 시간</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_staincare.svg"
                                    alt="찌든때 코스" />
                                </div>
                                <p>
                                  찌든때 코스
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">40℃-60℃의 고온으로 찌든때 걱정 없게</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_6motion.svg"
                                    alt="6모션 X 세탁" />
                                </div>
                                <p>
                                  6모션 X 세탁
                ...
                <div id="product-type-4" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_10.jpg"
                      alt="아이보리색 LG 세탁기가 밝은 배경 앞에 놓여 있으며, 옆에는 밝은색 선반이 놓여 있습니다." class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_42.png"
                      alt="아이보리색 LG 세탁기가 밝은 배경 앞에 놓여 있으며, 옆에는 밝은색 선반이 놓여 있습니다." class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                    <h4>강력한 물살로 세탁물을 넣기 편리한 통돌이</h4>
                    <p>
                      통돌이의 강력한 물살을 그대로 유지하면서, 조작부가 후면에 있어 몸을 덜 숙이고도 세탁물을 쉽게 꺼낼 수 있는 인체공학 설계는 까치발을 들지 않아도 세탁물을 꺼내기가
                      편리합니다.
                    </p>
                  </div>
                  <p class="note">
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary3" style="--col-width: 50%; --table-width: 320px">
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                            <div>통돌이 컴포트<span></span><br class="mo-only">25 ~ 21kg</div>
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr class="procuct-img-wrap">
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_51.png"
                                    alt="LG 통돌이 컴포트 세탁기 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_52.png"
                                    alt="LG 통돌이 컴포트 세탁기 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_53.png"
                                    alt="LG 통돌이 컴포트 세탁기 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_54.png"
                                    alt="LG 통돌이 컴포트 세탁기 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_topload.svg"
                                    alt="오브제 스타일 디자인" />
                                </div>
                                <p>
                                  오브제 스타일 디자인
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">고급스러운 컬러, 직선형의 플랫 디자인으로 전자동 세탁기에서 볼 수 없던 감각적인 외관</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_ergonomic.svg"
                                    alt="인체공학 설계" />
                                </div>
                                <p>
                                  인체공학 설계
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_AIcourse2.svg"
                                    alt="(딥러닝 AI) 인공지능 세탁 코스" />
                                </div>
                                <p>
                                  (딥러닝 AI)<br class="mo-only">인공지능 세탁 코스
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁물의 무게에 따라 자동으로 적정량의 세제를 투입하고, 재질에 맞춰 최적의 모션으로 세탁·탈수</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_06_AIcourse3.svg"
                                    alt="인공지능 세탁 코스" />
                                </div>
                                <p>
                                  인공지능 세탁 코스
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">세탁물에 따라 세탁 시간, 6모션 조합 그리고 헹굼 횟수까지 알아서 맞춤 조절</span>
                                  </span>
                                </p>
                              </td>
                            </tr>
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/washing-machine/ic48_07_deepAI2.svg"
                                    alt="딥러닝 AI DD X 6모션" />
                                </div>
                                <p>
                                  딥러닝 AI DD X 6모션
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">정밀한 움직임이 가능한 DD모터로 6모션을 구현해 깨끗한 세탁</span>
                                  </span>
                                </p>
                              </td>
                              <td>
            ...
            <section id="buying-point" name="buying-guide-content" style="display: none">
              ...
              <h3 class="section-title">
                우리 집 <b>라이프스타일</b>을 한층 더 쾌적하게, <br />스마트한 의류관리를 위한 <br />
                워시타워·워시콤보·트롬 세탁기·통돌이 세탁기의 핵심 기능을 만나보세요.
              </h3>
              <div class="tab-wrap">
                ...
                <div id="buying-point-1" name="buying-point">
                  <div class="subtab-wrap">
                    <div class="subtab-btn">
                      <button name="buying-guide-tab" data-target="#buying-point-1-1" data-group="buying-point-1"
                        class="active">
                        워시타워
                      </button>
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                        ...
                        <div class="content">
                          <h5>워시타워</h5>
                          <p>
                            25kg 용량의 세탁기와 25kg의 용량의 건조기가 수직으로 쌓인 구조를 통해 세탁과 건조를 동시에 진행할 수 있어요. 기본적으로 용량이 넉넉해 이불처럼 부피가 큰
                            빨래를 자주
                            하는 가구나 세탁량이 많은 가구에 추천드려요.
                          </p>
                        ...
                        <div class="content">
                          <h5>워시타워 컴팩트</h5>
                          <p>
                            13kg 용량의 세탁기와 10kg 용량의 건조기가 수직으로 쌓인 구조를 통해 세탁과 건조를 동시에 진행할 수 있는 건 물론, 컴팩트한 사이즈로 설치 공간에 대한
                            걱정은
                            줄였습니다. 합리적인 용량으로 독립한 1인 가구나 신혼 부부, 실버 부부 등 세탁량이 많지 않은 가구에 추천드립니다.
                          </p>
                          <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px">
                            <a class="btn-product"
                      ...
                      <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          <h5>워시콤보</h5>
                          <p>
                            하나의 통 안에서 세탁과 건조를 한 번에 해결할 수 있는 제품입니다. 23/15kg와 25/15kg 종류가 있어서  가정에서 유연하게 용량을 선택할 수 있어요.
                            세탁기 한 대의
                            공간만으로 건조 기능까지 겸비한 제품을 설치할 수 있어 공간 제약이 있는 가구에 추천드립니다.
                          </p>
                          <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                      ...
                      <div class="point-wrap" id="buying-point-1-3" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          <h5>25kg 최대용량</h5>
                          <p>
                            구성원이 많거나 대체적으로 세탁물이 많은 가족이라면 대용량 세탁기로 한 번에 빨래를 끝낼 수 있는 21~25kg의 대용량을 추천합니다. 이불, 커튼, 겨울 점퍼처럼
                            부피가 큰
                            세탁물도 여유 있게 세탁할 수 있으며, 여러 식구의 빨래를 한 번에 처리해 시간과 에너지를 절약할 수 있습니다.
                          </p>
                          <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                            <a class="btn-product"
                  ...
                  <div class="point-tip" id="point-tip1">
                    ...
                    <div class="tip-content">
                      <div class="content">
                        ...
                        <p class="tip-text">
                          워시타워는 넉넉한 용량의 세탁기와 건조기가 직렬로 구성되어, 평소 세탁량이 많거나 이불처럼 부피가 큰 세탁물의 세탁이 잦은 가구에 추천드립니다. 세탁기가 작동하는 동안
                          건조기를
                          동시에 사용할 수 있어, 세탁 효율을 높일 수 있는 점도 장점입니다. 반면, 설치 공간에 대한 고민이 있다면 워시콤보를 추천드립니다. 세탁기 한 대의 컴팩트한 사이즈로
                          설치가
                          가능하면서도, 25kg의 넉넉한 세탁 용량과 15kg의 합리적인 건조 용량을 하나의 통 안에서 구현해 세탁물을 옮길 필요 없이 세탁부터 건조까지 이어서 사용할 수
                          있습니다.
                        </p>
                      </div>
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_39.jpg"
                          ...
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_20.png"
                          alt="모던한 세탁실에 LG 트롬 스타일러 워시타워가 설치되어 있으며, 상단은 어두운 녹색 건조기, 하단은 흰색 세탁기로 구성되어 있습니다. 대리석과 갈색 패널로 마감된 벽면과 흰색 타일 바닥이 조화롭고, 바구니에는 접힌 흰색 수건이 담겨 있습니다."
                          class="mobile-only" />
                      </div>
                    </div>
                  ...
                  <div class="point-tip" id="point-tip2" style="display: none">
                    ...
                    <div class="tip-content">
                      <div class="content">
                        ...
                        <p class="tip-text">
                          세균이 특히 걱정되는 아기 옷이나 반려동물 용품, 속옷처럼 따로 관리하고 싶은 세탁물이 있을 때가 있죠. 이럴 때는 미니워시로 분리 세탁해보세요. 4kg 용량으로 부피가
                          크지 않은
                          빨래를 효율적으로 동시에 세탁이 가능하고, 세탁기 하단에 설치되어 투입구 높이를 높여주어 허리를 덜 숙이고 편리하게 사용할 수 있습니다. 분리 세탁이 크게 필요 없으신
                          경우,
                          내부가 바구니 형태로 설계된 키높이 수납함을 활용해보세요. 세탁 용품을 깔끔하게 정리할 수 있고, 세탁기 투입구 높이도 함께 높여 세탁 동선을 한층 편리하게
                          만들어줍니다.
                        </p>
                      </div>
                      <div class="img">
              ...
              <div id="buying-point-3" name="buying-point" style="display: none">
                <div class="subtab-wrap">
                  <div class="subtab-btn">
                    <button name="buying-guide-tab" data-target="#buying-point-3-1" data-group="buying-point-3"
                      class="active">
                      AI 세탁·건조
                    </button>
                  ...
                  <div class="subtab-content">
                    <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_34_1.webm"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                      ...
                      <div class="content">
                        <h5>AI 맞춤세탁</h5>
                        <p>
                          AI 맞춤 세탁 기능은 세탁물의 무게, 재질, 오염도를 스스로 인식하여 세탁 과정을 자동으로 조정합니다. 바쁜 일상 속에서도 세탁 품질을 유지하고 싶은 분들께 유용하며,
                          코스
                        ...
                        <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                          <a class="btn-product"
                            ...
                            target="_blank">트롬 세탁기 제품 보러 가기</a>
                        </div>
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_27.mp4"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                    ...
                    <div class="point-wrap" id="buying-point-3-2" name="buying-point-3" style="display: none">
                      ...
                      <div class="content">
                        <h5>AI 타임 센싱</h5>
                        <p>
                          세탁물 투입 후 시작 버튼을 누르면, AI 타임 센싱 기능이 세탁물의 무게를 자동으로 감지하여 약 3초 안에 코스별 예상 종료 시간을 안내합니다. 세탁 및 건조 소요
                          시간을 미리
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_29.mp4"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                      ...
                      <div class="content">
                        <h5>AI 세탁 리포트</h5>
                        <p>
                          AI 세탁·건조가 끝나면 꼼꼼 하게 리뷰한 리포트를 제공하는 기능입니다. 세탁 리포트를 통해서 나만의 개인 세탁 패턴을 확인할 수 있어 보다 스마트하고 효율적인 세탁
                          경험을
                          제공합니다.
                        </p>
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_31.mp4"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                      ...
                      <div class="content">
                        <h5>AI My 코스</h5>
                        <p>
                          매번 설정할 필요 없이 AI가 세탁과 건조 패턴을 분석하여 나만의 맞춤 코스를 자동으로 추천해줍니다. 자주 사용하는 코스를 등록해 상황에 따라 간편하게 선택할 수
                          있습니다.
                        </p>
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_32.mp4"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                    ...
                    <div class="point-wrap" id="buying-point-3-3" name="buying-point-3" style="display: none">
                      ...
                      <div class="content">
                        <h5>AI DD X6 모션</h5>
                        <p>
                          AI DD 기술이 세탁물의 무게와 재질, 오염도를 스스로 감지하여 옷감에 꼭 맞는 세탁/건조 모션을 선택합니다. 6가지의 섬세한 모션으로 세탁양과 시간을 자동 조절해
                          옷감 손상은
                          줄이고 세탁/건조 효율은 높입니다.
                        </p>
                        <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px">
                          ...
                          <a class="btn-product"
                            ...
                            target="_blank">세탁기 제품 보러 가기</a>
                        </div>
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_30_1.webm"></video>
                        </div>
                        <p class="des">
                          * 소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br>
                          * 제품별 기능 및 스펙은 차이가 있을 수 있으므로, 자세한 내용은 제품 상세 페이지를 참고해주세요.
                        ...
                        <div class="collapse-content">
                          <p>
                            ...
                            * AI 세탁은 딥러닝 AI 기술을 이용해 의류의 재질을 감지한 후 6모션 중 최적의 모션으로 세탁하며, 빅데이터 기반 환경에 맞춰 큰 진동을 미리 예측해 안정적으로
                            탈수합니다.
                          </p>
                          <p>
                            <b>[AI 건조]</b><br />
                ...
                <div class="point-tip" id="point-tip4">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <p class="tip-text">
                        매일 반복되는 세탁과 건조, 이제는 더 여유롭게 바꿔보세요. AI 기능이 세탁물의 무게와 재질, 오염도까지 감지해 세탁부터 건조까지 알아서 최적의 코스로 진행해줘요. 옷감에
                        맞는
                        코스를 고민할 필요 없이, 손상은 줄이고 세탁의 효율은 높여줘요. 시간이 부족해도 세탁만큼은 완벽하게 마무리할 수 있어요. 일상적인 루틴에 고민할 여유가 부족한 맞벌이
                        부부, 직장인
                        분들께 최고의 선택이에요.
                      </p>
                    </div>
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_35.jpg"
                        alt="세탁기와 건조기가 세로로 설치된 공간에서 두 사람이 세탁물을 정리하는 모습" class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_09.jpg"
                        alt="세탁기와 건조기가 세로로 설치된 공간에서 두 사람이 세탁물을 정리하는 모습" class="mobile-only" />
                    </div>
                  </div>
                </div>
                <div class="point-tip" id="point-tip5" style="display: none">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <p class="tip-text">
                        바쁜 출근 준비 시간도 효율적으로 사용하고 싶은 바쁜 직장인이나 맞벌이 부부처럼 시간 계획이 중요한 분들에게 추천드려요. AI가 나의 세탁량과 세탁 루틴을 분석하여 매번
                        시간을
                        확인하거나 설정을 일일이 조정해야 하는 번거로움을 줄여줘요. 세탁이 끝나는 시점에 맞춰 일정이나 다른 집안일을 병행할 수 있어, 불필요한 대기 시간을 줄이고 하루의 리듬을
                        깔끔하게
                        정돈할 수 있어요.
                      </p>
                    </div>
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_36.jpg"
                        alt="세탁기와 건조기가 세로로 설치된 공간에서 남성이 세탁물을 넣는 모습" class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_10.jpg"
                        alt="세탁기와 건조기가 세로로 설치된 공간에서 남성이 세탁물을 넣는 모습" class="mobile-only" />
                    </div>
                  </div>
                </div>
                <div class="point-tip" id="point-tip6" style="display: none">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <p class="tip-text">
                        매일 입는 일상복, 운동복부터 관리가 어려운 다양한 소재의 의류를 간편하게 관리해보세요. 세탁부터 건조까지 AI로 맞춤 관리가 가능한 워시타워는 옷의 무게와 오염도를 파악해
                        알맞은
                        모션으로 의류 관리를 도와줍니다.
                      </p>
                    </div>
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_40.jpg"
                        alt="집에서 문이 열린 LG 건조기 앞에 선 여성이 라벤더색 레깅스를 넣으려 하고 있습니다. 그녀는 검은색 가방을 메고 있으며 미소를 짓고 있습니다."
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/washing-machine/img_M07_001_11.jpg"
                        alt="집에서 문이 열린 LG 건조기 앞에 선 여성이 라벤더색 레깅스를 넣으려 하고 있습니다. 그녀는 검은색 가방을 메고 있으며 미소를 짓고 있습니다."
                        class="mobile-only" />
                    </div>
                  </div>
              ...
              <div id="buying-point-2" name="buying-point" style="display: none">
                <div class="subtab-wrap">
                  <div class="subtab-btn">
                    <button class="active" name="buying-guide-tab" data-target="#buying-point-2-3"
                  ...
                  <div class="subtab-content">
                    <div class="point-wrap" id="buying-point-2-3" name="buying-point-2">
                      ...
                      <div class="content">
                        <h5>트루스팀</h5>
                        <p>
                          트루스팀 세탁으로 99.99% 살균해 줍니다. 집먼지 진드기와 알러지 유발물질,유해 세균까지 99.99% 살균해 안심하고 세탁할 수 있습니다
                        </p>
                        <p class="mt20">
                          트루스팀 건조로 살균,탈취,구김도 매일 빨기 어려운 세탁물도 간편하게 살균, 탈취 케어하고 생활 속 구김까지 관리해줍니다.
                        </p>
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/washing-machine/vid_P07_001_45.mp4"></video>
                        </div>
                        <p class="des">
                        ...
                        <button class="btn-collapse-toggle">
                          <span>* 바이러스 제거-세탁 / 유해세균 살균-세탁 / 알러지 유발물질 제거-세탁 / 유해세균 살균-건조 / 바이러스 제거-건조 / 알러지 유발물질 제거-건조 /
                            꽃가루 알레르겐 불활성화-건조 / 탈취-건조 / 구김제거-건조</span>
                        </button>
                        <div class="collapse-content">
                          <p>* 물을 끓여 만든 트루스팀과 드럼 내부 온도를 60℃ 이상의 고온으로 건조 하여 유해세균을 살균합니다.</p>
                          <p>
                            <b>[바이러스 제거-세탁]</b><br />
                          ...
                          <p>
                            ...
                            * 시험 결과 : 집먼지 진드기 성충 100% 살충, 고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f 1) 알레르겐 99.99% 제거 
                            <br />
                            * 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                          </p>
                          <p>
                            ...
                            * 시험 코스 : 스팀살균<br />
                            * 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하, UL Solutions 마른상태 4kg/ KATRI 마른상태 4kg, 젖은상태
                            6.5kg<br />
                            * 시험 균 : 유해세균 3종 (황색포도상구균, 녹농균, 폐렴간균)<br />
                            * 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />
                          ...
                          <p>
                            ...
                            <br />* 시험 기관 : Environmental Allergens Info and Care Inc.(일본소재) / 시험 일자 : ‘25년 04월<br />*
                            시험 코스 : 스팀살균<br />* 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 1.5kg, 젖은상태 2.7kg<br />* 시험
                            알레르겐 : 집먼지진드기 성충, 고양이 (Fel d 1), 개(Can f 1), 집먼지진드기 (Der f1)<br />* 시험 방법 : 집먼지 진드기 및 알레르겐이
                            오염된 면직물 부착하여 스팀살균 코스 동작 후 집먼지 진드기 살충 및 알레르겐 제거율 확인<br />* 시험 결과 : 집먼지 진드기 성충 100% 살충,
                            고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f 1) 알레르겐 99.9% 제거<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수
                            있습니다.
                          </p>
                          <p>
                            <b>[꽃가루 알레르겐 불활성화-건조]</b><br />
                            <br />* 시험 기관 : Environmental Allergens Info and Care Inc.(일본소재) / 시험 일자 : ‘25년 04월<br />*
                            시험 코스 : 스팀살균코스<br />* 시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 4.5kg, 젖은상태 7kg<br />* 시험
                            알레르겐 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet v 1), 벼과(Phl p 5)<br />* 시험 방법 : 꽃가루 알레르겐이 오염된
                            면직물 부착하여 스팀살균 코스 동작 후 꽃가루 알레르겐 불활성화율 확인<br />* 시험 결과 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet
                            v 1), 벼과(Phl p 5) 99% 이상 불활성화<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                          </p>
                          <p>
                            <b>[탈취-건조]</b><br />
                            <br />* 시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월<br />* 시험 코스 : 스팀리프레쉬<br />* 시험 부하 : KS
                            C IEC60456 표준셔츠 7벌<br />* 냄새 분자 : 땀냄새, 담배냄새<br />* 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15%
                            R.H.<br />* 시험 방법 : 스팀리프레쉬 코스 동작 후 탈취력 측정<br />* 시험 결과 : 땀냄새, 담배냄새 99% 제거<br />* 시험결과는 사용환경
                            등에 따라 차이가 있을 수 있습니다.
                          </p>
                          <p>
                            <b>[구김제거-건조]</b><br />
                            <br />* 시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월<br />* 시험 코스 : 스팀리프레쉬<br />* 시험 부하 : KS
                            C IEC60456 표준셔츠 2장, 5장<br />* 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />* 시험 방법 : 자사가
                            제시한 시험 기준으로, 셔츠 등판 300mm x 300mm 기준 셔츠에 임의 구김을 부여한 후, 셔츠를 무작위로 선택하여건조기 동작 전, 후 AATCC 시험평가판으로
                            비교<br />* 시험 결과 : 구김정도 시험 전 대비 2배 이상 완화 됨.<br />* 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                          </p>
                          <button class="btn-collapse-close">접기</button>
                        </div>
                      </div>
                    ...
                    <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                      <h4 class="hide">자동세제함 플러스</h4>
                      <div class="content">
                        <h5>자동세제함 플러스</h5>
                        <p>
                          세제와 유연제를 원하는 대로 선택은 물론 세탁물의 무게와 오염도를 감지해 자동으로 적정량을 투입해 줍니다. 세탁 코스에 따라 알맞은 세제를 투입하고 세제 종류에 따라
                          투입량도
                          원하는 대로 설정할 수 있습니다.
                        </p>
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/washing-machine/img_P07_001_23.gif"
              ...
              <div class="point-box">
                ...
                <div class="tab-wrap">
                  <button class="active" name="buying-guide-tab" data-target="#buying-point-4"
                ...
                <div class="tab-content">
                  <div id="buying-point-4" name="buying-point-45" style="--box-height: 450px; --box-m-height: 400px">
                        ...
                        <div>
                          <div class="content-wrap">
                            <div>
                              <h4>콘덴서 자동 세척</h4>
                              <p>
                                콘덴서는 젖은 빨래에서 발생하는 따뜻하고 습한 공기를 건조한 공기로 바꿔주는 핵심 부품입니다. 콘덴서 자동 세척 기능은 필터에서 거르지 못한 먼지가 쌓이는
                                것을 방지해,
                                손이 닿기 어려운 내부까지 간편하게 관리할 수 있습니다.
                              </p>
                            </div>
                            <div>
                              <div class="media-wrap">
                          ...
                          <div class="detail-wrap">
                            ...
                            <div class="collapse-content">
                              <p>
                                * 모든 건조코스에서 콘덴서 자동세척 시스템 동작 , 단 건조 코스가 아닌 침구털기코스, 송풍코스 등은 이후 젖은 옷감으로 건조행정 시 콘덴서 자동세척
                                진행. 
                                <br />
                          ...
                          <div class="detail-wrap">
                            ...
                            <div class="collapse-content">
                              <p>
                                ...
                                * 시험 결과 : 필터 내부, 콘덴서 전면, 열교환기 전면, 드럼 후면, 팬, 드럼 내부, 드럼 리프터, 도어 내부, 열교환기 하단, 필터 하단, 시작점,
                                열풍이동 끝점
                                12포인트 확인결과 평균 99.9% 살균력 <br />
                                * 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                              </p>
                              <button class="btn-collapse-close">접기</button>
                            </div>
            ...
            <section class="useful-tip">
              ...
              <div class="tip-wrap">
                <div class="tip-faq">
                  ...
                  <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                    <a target="_blank" href="https://www.lge.co.kr/story/useful-tip/washing-machines-faq">세탁기 FAQ</a>
                    <a target="_blank" href="https://www.lge.co.kr/story/useful-tip/wash-tower-faq">워시타워 FAQ</a>
                  </div>
                  <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                    <a target="_blank" href="https://www.lge.co.kr/story/faq/wash-combo-faq">워시콤보 FAQ</a>
                  </div>
                </div>
                <div class="tip-subscribe">
                  <h3>
                    <img src="/kr/story/buying-guide/2025/img/ic32_subscribe.png" alt="흰색 캘린더 3D 아이콘." />구독 상품
                  </h3>
                  <p>
                    세탁기·워시타워·워시콤보를 정기적으로 구독하고 싶다면?
                  </p>
                  <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/washing_machines">세탁기 구독
                      상품</a>
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/wash-tower">워시타워 구독 상품</a>
                  </div>
                  <div class="btn-wrap" style="--btn-width: 216px; --btn-m-width: 196px;">
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/wash-combo">워시콤보 구독 상품</a>
                  </div>
                </div>
                <div class="tip-best">
                  <h3>
