          ...
          <div class="slider">
            <div>
              <img
                ...
                alt="깔끔한 주방 공간에 LG 퓨리케어 오브제컬렉션 냉동얼음정수기가 단정하게 놓여 있으며, 옆에는 얼음이 담긴 유리컵이 함께 배치되어 있습니다. 큰 창으로 부드러운 자연광이 들어와 정수기의 미니멀한 디자인과 은은한 톤이 더욱 돋보입니다."
                class="pc-only"
              />
              <img
                  ...
                  <div>
                    <div class="img-wrap">
                        ...
                        <div class="bubble">
                          <a
                            ...
                            target="_blank" rel="noopener"
                             title="새창열림"><span>LG 퓨리케어 오브제컬렉션 냉동얼음정수기</span></a
                          >
                          <p>데스크 정수기</p>
                        </div>
                      </div>
                      <img
                        ...
                        alt="따뜻한 햇빛이 비치는 미니멀한 주방 공간에 화이트 톤의 LG 퓨리케어 오브제컬렉션 냉동얼음정수기가 놓여 있습니다. 옆에는 얼음이 담긴 투명한 유리컵과 작은 화병이 조화를 이루며 고급스럽고 차분한 분위기를 완성합니다."
                        class="pc-only"
                      />
                      <img
                    ...
                    <div class="text-wrap">
                      ...
                      <p>
                        국내 유일 냉동보관 냉동얼음정수기로, 영하 보관을 통해 언제든
                        ...
                        <td>
                          <div class="procuct-img">
                            <img
                              ...
                              alt="정수기 LG 퓨리케어 오브제컬렉션 냉동얼음정수기 (WD722RE.AKOR) 썸네일이미지 2"
                              class="front"
                            />
                          </div>
                        </td>
