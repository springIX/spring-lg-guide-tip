      ...
      <body>
        ...
        <div class="buying-guide" id="content">
          <div class="top-banner">
            ...
            <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_01.jpg"
              alt="흰색 배경에 흰색 로봇 청소기 충전 스테이션과 무선 청소기가 배치되어 있으며, 격자 창문 밖으로는 녹색 식물이 보입니다." class="pc-only" />
            <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_001_01.jpg"
              alt="흰색 배경에 흰색 로봇 청소기 충전 스테이션과 무선 청소기가 배치되어 있으며, 격자 창문 밖으로는 녹색 식물이 보입니다." class="mobile-only" />
            <p class="note">
          ...
          <div class="guide-wrap inner-wrap">
            <section id="line-up" name="buying-guide-content">
              ...
              <div class="tab-wrap sticky" style="--btn-width: 280px; --btn-m-width: 228px">
              ...
              <button class="nav nav-right">></button> -->
                <div class="vertical-scroll-box">
                  <button class="tab-img active" name="buying-guide-tab" data-target="#product-type-1"
                    ...
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_03.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-2"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_02.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-3"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_04.png"
                ...
                <div id="product-type-1" name="product-type">
                  <div class="img-wrap">
                    ...
                    ">
                      ...
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000119&filterProduct=AT0000000140:KY0000001581:01"
                          target="_blank"><span>LG 코드제로 AI 오브제컬렉션 로보킹 올인원 (자동
                            급배수)</span></a>
                        <p>흡입+물걸레</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_05.jpg"
                      alt="회색 하부장이 있는 깔끔한 주방으로, 한 하부장 문이 열려 흰색 청소 로봇과 충전 스테이션이 보입니다." class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_001_02.jpg"
                      alt="회색 하부장이 있는 깔끔한 주방으로, 한 하부장 문이 열려 흰색 청소 로봇과 충전 스테이션이 보입니다." class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                      ...
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                            <!-- <div>로닉 AI</div> -->
                            <div>
                              B95AWBTH<span></span><br class="mobile-only" />로보킹
                            </div>
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_09.png"
                                    alt="청소기 LG 코드제로 AI 오브제컬렉션 로보킹 올인원 (프리스탠딩) (B95AWBH.CKOR1) 메인이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_14.png"
                                    alt="청소기 LG 코드제로 AI 오브제컬렉션 로보킹 올인원 (프리스탠딩) (B95AWBH.CKOR1) 줌이미지 6" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_12.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 R5 (RO585HGH.AKOR) 줌이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_17.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 R5 (RO585HGH.AKOR) 줌이미지 6" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_10.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 R9 (R9300WB.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_15.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 R9 (R9300WB.AKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_11.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 M9 (MO972WA.AKOR) 썸네일이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_16.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 M9 (MO972WA.AKOR) 썸네일이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_autoclean.svg"
                                    alt="물걸레 세척/건조" />
                                </div>
                                <p>
                                  물걸레 세척/건조
                                  <span class="des">
                                    ...
                                    <span class="bubble">올인원타워로 이동 후 물걸레 세척 및 건조를
                                      자동으로 진행</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_autobin.svg"
                                    alt="자동먼지비움" />
                                </div>
                                <p>
                                  자동먼지비움
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">올인원타워로 이동 후 먼지통 안의 먼지를
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_dualclean.svg"
                                    alt="물걸레 흡입 동시 청소" />
                                </div>
                                <p>
                                  물걸레 흡입 동시 청소
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">바닥 물걸레 청소와 먼지 흡입 청소를 동시에
                                      진행</span>
                                  </span>
                                </p>
                              </td>
                              ...
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_suction.svg"
                                    alt="물걸레 흡입 동시 청소" />
                                </div>
                                <p>
                                  흡입 전용
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">물걸레 청소 없이 먼지 흡입 청소</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_mop.svg"
                                    alt="물걸레 전용" />
                                </div>
                                <p>
                                  물걸레 전용
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">먼지 흡입 없이 바닥을 꾹꾹 눌러 손으로
                                      걸레질 한 듯 물걸레 청소</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_smartturbo.svg"
                                    alt="스마트 터보" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_moplift.svg"
                                    alt="물걸레 리프팅" />
                                </div>
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">카펫 위에서는 흡입 세기를 알아서 강하게
                              ...
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">카펫이나 벽면 등 환경에 따라 흡입 세기를 알아서 강하게 높여 청소</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">카펫이나 벽면 등 환경에 따라 흡입 세기를
                                      알아서 강하게 높여 청소</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_LGSDL.svg"
                                    alt="보안 LG SDL" />
                                </div>
                                <p>
                                  보안(LG SDL)
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">LG 표준 보안 개발 프로세스를 적용하여 보안
                                      리스크까지 철저하게 관리</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_thinQ.svg"
                                    alt="보안 ThinQ 앱" />
                                </div>
                                <p>
                                  보안(ThinQ 앱)
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">LG 전자의 ThinQ 앱으로 개인정보 안전하게 보호</span>
                                  </span>
                                </p>
                              </td>
                              <td class="disabled">
                            ...
                            <tr class="product-btn">
                              ...
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000119&filterProduct=AT0000000109:KY0000003021:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000119&filterProduct=AT0000000109:KY0000000629:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000119&filterProduct=AT0000000109:KY0000000616:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000119&filterProduct=AT0000000109:KY0000000628:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                            </tr>
                          </tbody>
                ...
                <div id="product-type-2" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000115&filterProduct=AT0000000140:KY0000002661:01"
                          target="_blank"><span>LG 코드제로 AI 오브제컬렉션 A9</span>
                        </a>
                        <p>흡입+스팀 물걸레</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_06.jpg"
                      alt="밝은 거실 배경에 흰색 무선 청소기가 세워져 있고, 옆에는 베이지색 수납장과 회색 꽃병, 흰색 소파가 배치되어 있습니다." class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_001_03.jpg"
                      alt="밝은 거실 배경에 흰색 무선 청소기가 세워져 있고, 옆에는 베이지색 수납장과 회색 꽃병, 흰색 소파가 배치되어 있습니다." class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                    <h4>
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary2"
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr class="procuct-img-wrap">
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_18.png"
                                    alt="청소기 LG 코드제로 AI 오브제컬렉션 A9 (AI958WA.BKOR) 메인이미지 4" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_21.png"
                                    alt="청소기 LG 코드제로 AI 오브제컬렉션 A9 (AI958WA.BKOR) 줌이미지 6" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_19.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 A7 Core (A727WA.CKOR) 메인이미지 4" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_22.png"
                                    alt="청소기 LG 코드제로 오브제컬렉션 A7 Core (A727WA.CKOR) 줌이미지 6" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_20.png"
                                    alt="청소기 LG 코드제로 A5 (AS527HA.CKOR) 메인이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_23.png"
                                    alt="청소기 LG 코드제로 A5 (AS527HA.CKOR) 줌이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_steamsuction.svg"
                                    alt="스팀 물걸레+흡입" />
                                </div>
                                <p>
                                  스팀 물걸레+흡입
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">60° 스팀 물걸레 청소와 먼지 흡입을 동시
                                      청소</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_wetsuction.svg"
                                    alt="물걸레+흡입" />
                                </div>
                                <p>
                                  물걸레+흡입
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">물걸레 청소와 먼지 흡입을 동시 청소</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_allinone.svg"
                                    alt="올인원타워" />
                                </div>
                                <p>
                                  올인원타워
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">자동 먼지 비움·충전은 물론 다양한 흡입구를
                                      보관</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_AIsmartclean.svg"
                                    alt="AI · 스마트 청소" />
                                </div>
                                <p>
                                  AI · 스마트 청소
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">청소 패턴, 상황, 배터리 잔량을 분석해
                                      흡입력을 스마트하게 조절</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_Wpower.svg"
                                    alt="320W" />
                                </div>
                                <p>
                                  320W
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_5filter.svg"
                                    alt="5단계 미세먼지 차단" />
                                </div>
                                <p>
                                  5단계 미세먼지 차단
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">내부 미세먼지가 다시 배출되지 않도록
                                      5단계로 차단</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="product-btn">
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000115&filterProduct=AT0000000109:KY0000003961:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000115&filterProduct=AT0000000109:KY0000003602:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000115&filterProduct=AT0000000109:KY0000003511:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <p class="des">
                        ...
                        * 25년 3월 한국산업기술시험원(KTL) 시험 결과, 국제 표준 IEC 62885-4:2020/AMD1:2023 5.11절을 기준으로 A9S(모델명 :
                        S9G*******) 본체에 연장관을 결합하고, 흡입구 결합 없이 먼지통이 빈 상태에서, 완전히 충전한 새 배터리를 사용하여 터보 모드 기준 최대 흡입력을
                        산정하였습니다.<br />
                        * 흡입력(Suction Power, 단위 : W)은 공기 데이터 시험 장비(Equipment for air data test)로 관측된 진공도(Vacuum, 단위 :
                        kPa)와 유량(Air Flow, 단위 : ℓ/s)의 곱으로 계산됩니다. <br />
                        * 사용 중 제품의 보호 모드(제품이 이물질로 막히면 ‘우웅~우웅~’ 소리가 나고, 이물 막힘이 지속되면 제품 보호를 위해 전원이 꺼지는 모드)가 작동할 경우에는 흡입력이
                        저하됩니다. <br />
                        * 흡입력은 연장관과 흡입구의 결합 여부, 측정 환경에 따라 차이가 있을 수 있습니다. <br />
                        * 25년 2월 기준, 미국 시장에 출시된 무선 스틱 청소기 제품 중 최대 흡입력 표기치가 320W 이상인 제품의 무게(본체, 배터리, 연장관, 기본 흡입구를 결합한 상태)
                        표기치와 비교함. (독립 시장 조사 기관인 NPD의 2022.1-2025.2 사이 미국 판매 데이터 기준)
                      </p>
                ...
                <div id="product-type-3" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000120&filterProduct=AT0000000140:KY0000001275:01"
                          target="_blank"><span>LG CYKING K8</span></a>
                        <p>흡입 전용</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_07.jpg"
                      alt="헤링본 패턴의 나무 바닥 위에 흰색과 회색의 유선 진공청소기가 놓여 있습니다. 옆에는 나무 받침대 위에 도자기 꽃병과 작은 그릇 장식이 함께 놓여 있고 배경은 흰색 벽과 몰딩으로 장식되어 있습니다."
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_001_04.jpg"
                      alt="헤링본 패턴의 나무 바닥 위에 흰색과 회색의 유선 진공청소기가 놓여 있습니다. 옆에는 나무 받침대 위에 도자기 꽃병과 작은 그릇 장식이 함께 놓여 있고 배경은 흰색 벽과 몰딩으로 장식되어 있습니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary3"
                      style="--col-width: 33.33%; --table-width: 457px">
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr class="procuct-img-wrap">
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_24.png"
                                    alt="청소기 LG CYKING K8 (K83WGY.BKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_27.png"
                                    alt="청소기 LG CYKING K8 (K83WGY.BKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_25.png"
                                    alt="청소기 LG CYKING POWER (C40WGY.BKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_28.png"
                                    alt="청소기 LG CYKING POWER (C40WGY.BKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_26.png"
                                    alt="청소기 LG CYKING 청소기 (C33FNT.BKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_001_29.png"
                                    alt="청소기 LG CYKING 청소기 (C33FNT.BKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_twin.svg"
                                    alt="트윈 싸이클론" />
                                </div>
                                <p>
                                  트윈 싸이클론
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">2중 싸이클론 구조로 먼지를 분리하여 흡입력
                              ...
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_turbocyclone.svg"
                                    alt="터보 싸이클론" />
                                </div>
                                <p>
                                  터보 싸이클론
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">원형 구조의 터보 싸이클론 시스템으로 강력한
                                      흡입력을 오래 유지</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_autocompress.svg"
                                    alt="자동 먼지 압축" />
                                </div>
                                <p>
                                  자동 먼지 압축
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">먼지통 속 날개로 먼지를 압축해 3배 이상
                                      담고, 비우기도 간편</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_exhaustfilter.svg"
                                    alt="배기필터" />
                                </div>
                                <p>
                                  배기필터
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">미세먼지까지 걸러주는 배기필터</span>
                                  </span>
                                </p>
                              </td>
                              <td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/ic48_05_quiet.svg"
                                    alt="저소음구조" />
                                </div>
                                <p>
                                  저소음구조
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">모터를 두번 감싼 구조로 진동과 소음까지
                                      감소</span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="product-btn">
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000120&filterProduct=AT0000001251:KY0000001074:03"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/vacuum-cleaners?subCateId=CT50000120&filterProduct=AT0000000140:KY0000001275:01"
            ...
            <section id="buying-point" name="buying-guide-content" style="display: none">
                ...
                <div id="buying-point-1" name="buying-point">
                      ...
                      <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            ...
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_01.mp4"></video>
                          </div>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_02.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                      ...
                      <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_03.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 자동 급배수 / 케어 서비스 / 자동 먼지 비움</span>
                          </button>
                          <div class="collapse-content">
                            <p>
                              <b>[자동 급배수]</b><br />
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_04.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 관리제 실험 결과</span>
                          </button>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video id="video-dry" autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_05.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                      ...
                      <div class="point-wrap" id="buying-point-1-3" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_06.mp4"></video>
                          </div>
                          ...
                          <div class="collapse-content">
                            <p>
                              * 소비자의 이해를 돕기 위해 연출된 영상으로 실제와 다를 수 있습니다.
                              <br />
                              * 인식 가능한 대표 사물 : 전선, 신발(운동화/슬리퍼), 양말/수건, 선풍기, 체중계, 반려동물 식기, 공, 컵, 병, 블록, 화분, 휴지통, 의자, 스툴,
                              테이블, 냉장고, 탁자, 신발장, 침대, 책, 건조대, 강아지/고양이, 리모컨
                              <br />
                              * 인식 가능한 사물은 소프트웨어 업데이트로 추가 또는 변경될 수 있습니다.
                              <br />
                              * 인식 성능은 사물의 크기·형상·색상·재질 및 조명(어두움/역광), 바닥 패턴/광택, 주변 환경에 따라 달라질 수 있으며, 일부 물체는 오인식 되거나 인식되지
                              않을 수 있습니다.
                              <br />
                              * AI 사물인식을 사용하기 위해서는 LG ThinQ 앱에서 'AI 장애물 회피' 설정이 필요합니다.
                              <br />
                              * 3D 센서는 가로•세로 약 2cm, 높이 약 1cm 수준의 장애물까지 감지 가능하며, 센서와 장애물과의 거리가 약 8cm 이상일 때 감지할 수 있습니다.
                              (좌/우 감지 각도 : 98°, 상/하 감지 각도 : 79°)
                              <br />
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_07.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 라이다 센서</span>
                          </button>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_03.jpg"
                  ...
                  <div class="point-tip" id="point-tip1">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_01.jpg"
                          alt="주방 수납장 아래에 설치된 로봇청소기와 올인원 타워 이미지" class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_101_01.jpg"
                          alt="주방 수납장 아래에 설치된 로봇청소기와 올인원 타워 이미지" class="mobile-only" />
                      </div>
                    </div>
                  </div>
                  <div class="point-tip" id="point-tip2" style="display: none">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_02.jpg"
                          alt="거실 수납장 아래에 설치된 로봇청소기와 올인원 타워 이미지" class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_101_02.jpg"
                          alt="카펫 위에서 물걸레를 장착한 로봇청소기가 청소하는 모습" class="mobile-only" />
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <div class="media-wrap">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_08.mp4"></video>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="buying-point-2" name="buying-point" style="display: none">
                  ...
                  <div class="subtab-content">
                    <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                      ...
                      <div class="content">
                        <h5>320W / 약 2.54kg</h5>
                        <p>
                          A9 AI는 스마트 인버터 모터로 최대 320W의 강력한 흡입력을 발휘하여 먼지를 흡입하고, 약 2.54kg의 동급 최경량 무게를 통해 상대적으로 청소하는 동안 손목의
                          피로도를 줄여 주고 AI 기능으로 청소의 편리함은 높였습니다.
                        </p>
                        <div class="btn-wrap">
                          <a class="btn-product"
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_19.jpg"
                        ...
                        <div class="collapse-content">
                          <p>
                            ...
                            * 흡입력(Suction Power, 단위 : W)은 공기 데이터 시험 장비(Equipment for air data test)로 관측된 진공도(Vacuum, 단위
                            : kPa)와 유량(Air Flow, 단위 : ℓ/s)의 곱으로 계산됩니다.<br />
                            * 사용 중 제품의 보호 모드(제품이 이물질로 막히면 ‘우웅~우웅~’ 소리가 나고, 이물 막힘이 지속되면 제품 보호를 위해 전원이 꺼지는 모드)가 작동할 경우에는
                            흡입력이 저하됩니다.<br />
                            * 흡입력은 연장관과 흡입구의 결합 여부, 측정 환경에 따라 차이가 있을 수 있습니다.<br />
                            * 25년 2월 기준, 미국 시장에 출시된 무선 스틱 청소기 제품 중 최대 흡입력 표기치가 320W 이상인 제품의 무게(본체, 배터리, 연장관, 기본 흡입구를 결합한
                            상태) 표기치와 비교함. (독립 시장 조사 기관인 NPD의 2022.1-2025.2 사이 미국 판매 데이터 기준)<br />
                            * 제품 본체 무게 약 1.55 kg은 청소기 본체, 배터리를 결합한 무게이며, 제품 총 무게 약 2.54 kg은 청소기 본체, 배터리, 연장관, 와이드
                            LED+(LED 플러스) 마루 흡입구를 결합한 무게입니다.<br />
                      ...
                      <div class="content">
                        <h5>280W / 약 2.49kg</h5>
                        <p>
                          A9S는 2중 터보 싸이클론이 흡입된 공기와 먼지를 약 99.7%까지 분리해 제품 내부에 쌓이는 먼지를 최소화하여 효율적인 공기 흐름을 유지하고, 오래도록 강력한
                          흡입력이 발휘될 수 있도록 합니다. 그리고 2.49kg의 동급 최경량 무게는 청소 중 손목의 피로도를 덜 수 있도록 도와줍니다.
                        </p>
                        <div class="btn-wrap">
                          <a class="btn-product"
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_21.jpg"
                        ...
                        <div class="collapse-content">
                          <p>
                            <b>[최대 280W 흡입력]</b><br />
                            * 24년 3월 한국산업기술시험원(KTL) 시험 결과, 국제 표준 IEC 62885-4:2020/AMD1:2023 5.11절을 기준으로 A9S(모델명 :
                            S9B*******) 본체에 연장관을 결합하고, 흡입구 결합 없이 먼지통이 빈 상태에서, 완전히 충전한 새 배터리를 사용하여 터보 모드 기준 최대 흡입력을
                            산정하였습니다.<br />
                            * 흡입력(Suction Power, 단위 : W)은 공기 데이터 시험 장비(Equipment for air data test)로 관측된 진공도(Vacuum, 단위
                            : kPa)와 유량(Air Flow, 단위 : ℓ/s)의 곱으로 계산됩니다.<br />
                            * 사용 중 제품의 보호 모드(제품이 이물질로 막히면 ‘우웅~우웅~’ 소리가 나고, 이물 막힘이 지속되면 제품 보호를 위해 전원이 꺼지는 모드)가 작동할 경우에는
                          ...
                          <p>
                            <b>[2중 터보 싸이클론]</b><br />
                            * 23년 6월 자사 시험 결과를 3자 시험 기관인 인터텍(Intertek)이 검증한 결과, 자사가 제시한 기준으로 IEC TS 62885-1 5.1절에서 명시하는
                            시험 먼지를 A9S(모델명 : S9B*******) 제품의 먼지통이 가득찰 때까지 약 50g 흡입 후, 필터부로 넘어간 먼지량을 측정하여, 흡입한 먼지량 대비
                            필터부로 넘어가지 않은 먼지량의 비율이 약 99.7% 임을 확인하였습니다.<br />
                            * 먼지 분리 성능은 사용 환경에 따라 차이가 있을 수 있습니다.
                          </p>
                          <p>
                            <b>[동급 최경량]</b><br />
                            * 24년 2월 기준, 글로벌 시장에 출시된 프리미엄 무선 청소기 제품 중 최대 흡입력 표기치가 280W인 제품의 무게(본체, 배터리, 연장관, 기본 흡입구를 결합한
                            상태) 표기치와 비교함. (독립 시장 조사 기관인 NPD의 2022.1-2023.11 사이 미국 판매 데이터 및 LG전자 내부의 2023.12-2024.2 사이
                            글로벌 시장 판매 제품 리서치 데이터 기준)<br />
                            * 제품 본체 무게 약 1.53kg은 청소기 본체, 배터리를 결합한 무게이며, 제품 총 무게 약 2.49kg은 청소기 본체, 배터리, 연장관, 와이드 LED 마루
                            흡입구를 결합한 무게입니다.<br />
                            * 자사 측정 결과, 실제 제품 무게는 제품 제조 과정 및 측정 환경에 따라 차이가 있을 수 있습니다.
                          </p>
                          <button class="btn-collapse-close">접기</button>
                      ...
                      <div class="content">
                        <h5>220W / 약 2.47kg</h5>
                        <p>
                          A7 Core는 스마트 인버터 모터의 강력한 흡입력을 위해 2단계로 적용된 싸이클론으로 강력한 회오리를 형성하여 흡입된 공기와 먼지를 분리하고 분리된 먼지가 필터를 막아
                          흡입력의 성능을 저하시키지 않도록 먼지통에 먼지를 모아줍니다. 그리고 2.47kg의 가벼운 무게로 청소할 수 있습니다.
                        </p>
                        <div class="btn-wrap">
                          <a class="btn-product"
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_22.jpg"
                        ...
                        <div class="collapse-content">
                          <p>
                            * 25년 3월 한국산업기술시험원(KTL) 시험 결과, 국제 표준 IEC 62885-4:2020/AMD1:2023 5.11절을 기준으로 A7 Core(모델명 :
                            S6C*******) 본체에 연장관을 결합하고, 흡입구 결합 없이 먼지통이 빈 상태에서, 완전히 충전한 새 배터리를 사용하여 터보 모드 기준 최대 흡입력을
                            산정하였습니다.<br />
                            * 흡입력(Suction Power, 단위 : W)은 공기 데이터 시험 장비(Equipment for air data test)로 관측된 진공도(Vacuum, 단위
                            : kPa)와 유량(Air Flow, 단위 : ℓ/s)의 곱으로 계산됩니다.<br />
                            * 사용 중 제품의 보호 모드(제품이 이물질로 막히면 ‘우웅~우웅~’ 소리가 나고, 이물 막힘이 지속되면 제품 보호를 위해 전원이 꺼지는 모드)가 작동할 경우에는
                      ...
                      <div class="content">
                        <h5>150W / 약 1.97kg</h5>
                        <p>
                          A5를 통해 150W의 흡입력을 약 1.97kg의 가벼운 무게로 경험해보세요. 바닥은 물론 평소 무게로 인해 청소하기 어려웠던 높은 틈새도 가볍게 들어올려 청소할 수
                          있습니다.
                        </p>
                        <div class="btn-wrap">
                          <a class="btn-product"
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_20.jpg"
                        ...
                        <div class="collapse-content">
                          <p>
                            * 23년 11월 한국산업기술시험원(KTL) 시험 결과, 국제표준 IEC 62885-4:2020+AMD1:2023 CSV 5.11절을 기준으로 본체에 연장관을
                            결합하고, 흡입구 결합 없이 먼지통이 빈 상태에서, 완전히 충전한 새 배터리를 사용하여 터보 모드 기준 최대 흡입력을 산정하였습니다.<br />
                            * 흡입력(Suction Power, 단위 : W)은 공기 데이터 시험 장비(Equipment for air data test)로 관측된 진공도(Vacuum, 단위
                            : kPa)와 유량(Air Flow, 단위 : ℓ/s)의 곱으로 계산됩니다.<br />
                            * 사용 중 제품의 보호모드(제품이 이물질로 막히면 ‘우웅~ 우웅~’ 소리가 나고, 이물 막힘이 지속되면 제품 보호를 위해 전원이 꺼지는 모드)가 작동할 경우에는
                            흡입력이 저하됩니다.<br />
                            * 흡입력은 측정 환경에 따라 차이가 있을 수 있습니다.<br />
                            * 제품 본체 무게 약 1.1 kg은 청소기 본체, 배터리를 결합한 무게이며, 제품 총 무게 약 1.97 kg은 청소기 본체, 배터리, 연장관, 슬림 마루 흡입구를
                            결합한 무게입니다.<br />
                    ...
                    <div class="point-wrap" id="buying-point-2-2" name="buying-point-2" style="display: none">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_09.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span>* 안심 스팀 모드 / 찌든 때 제거 / 물걸레 온도</span>
                        </button>
                        <div class="collapse-content">
                          <p>
                            <b>[안심 스팀 모드]</b><br />
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_10.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span>* 자동 물 공급</span>
                        </button>
                    ...
                    <div class="point-wrap" id="buying-point-2-3" name="buying-point-2" style="display: none">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_11.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span>* 올인원타워</span>
                        </button>
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_05.jpg"
                    ...
                    <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_12.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_13.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_14.mp4"></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span>* 오토 스탑앤고</span>
                        </button>
                ...
                <div class="point-tip" id="point-tip4">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <p class="tip-text">
                        손목 통증이나 허리 불편이 있는 분들, 퇴근 후 짧은 시간에 빠르게 청소를 끝내고 싶은 분들께 추천해요. 강력한 흡입력과 동급 최경량 바디로 손목과 허리에 가는 부담을
                        줄여주어, 높은 틈새와 모서리까지 한 손으로 가볍게 들어 올려 청소할 수 있어요. 매일 쌓이는 생활 먼지부터 구석구석 모서리까지, 가볍고 빠르게 관리해보세요.
                      </p>
                    </div>
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_18.jpg"
                        alt="거실에 세워진 LG 무선청소기 제품 이미지" class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_101_18.jpg"
                        alt="거실에 세워진 LG 무선청소기 제품 이미지" class="mobile-only" />
                    </div>
                  </div>
                </div>
                <div class="point-tip" id="point-tip5" style="display: none">
                  ...
                  <div class="tip-content">
                    ...
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_04.jpg"
                        alt="미니멀한 거실 공간에 화이트 컬러의 무선청소기가 스탠드형 충전 거치대에 깔끔하게 보관되어 있어 정돈된 인테리어와 조화를 이루고 있습니다."
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_101_03.jpg"
                        alt="미니멀한 거실 공간에 화이트 컬러의 무선청소기가 스탠드형 충전 거치대에 깔끔하게 보관되어 있어 정돈된 인테리어와 조화를 이루고 있습니다."
                        class="mobile-only" />
                    </div>
                  </div>
                ...
                <div class="point-tip" id="point-tip6" style="display: none">
                  ...
                  <div class="tip-content">
                    ...
                    <div class="img">
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_06.jpg"
                        alt="아이보리색 벽을 배경으로, 흰색과 검은색의 LG 무선 청소기와 로봇 청소기가 충전 거치대와 함께 놓여 있습니다. 충전 거치대 옆에는 나무 장식품이 올려진 크림색과 나무색의 낮은 서랍장이 부분적으로 보입니다."
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_M05_101_04.jpg"
                        alt="아이보리색 벽을 배경으로, 흰색과 검은색의 LG 무선 청소기와 로봇 청소기가 충전 거치대와 함께 놓여 있습니다. 충전 거치대 옆에는 나무 장식품이 올려진 크림색과 나무색의 낮은 서랍장이 부분적으로 보입니다."
                        class="mobile-only" />
                    </div>
                  </div>
                ...
                <div class="point-tip" id="point-tip7" style="display: none">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <p class="tip-text">
                        배터리 방전으로 청소가 중단될 걱정은 줄이고, 청소 패턴과 배터리 잔량 등을 분석해 흡입력을 알아서 조절하는 편의 기능으로 스마트한 청소 라이프를 시작해보세요. 그리고
                        본체의 배터리 자가 진단을 통해 배터리 이상 현상과 배터리의 충/방전 사이클을 기준으로 배터리 수명까지 4단계로 알려주고, LG ThinQ 앱의 스마트 진단을 통해 제품
                        이상 여부까지 진단해주니까 관리도 간편해요.
                      </p>
                    </div>
                    <div class="img">
                      <div class="media-wrap">
                        <button class="btn-pause">일시멈춤</button>
                        <video autoplay playsinline loop muted
                          src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_15.mp4"></video>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="point-box">
                ...
                <div class="tab-content">
                  <div id="buying-point-4" name="buying-point-45" style="--box-height: 557px; --box-m-height: 423px">
                        ...
                        <div>
                          <div class="content-wrap">
                            <div>
                              <h4>보안</h4>
                              <p>
                                LG 표준 보안 개발 프로세스(LG-SDL)를 기반으로 민감 정보 보호와 안전한 데이터 관리를 수행해 리스크를 철저히 관리하며, LG ThinQ를 통해 새로운
                                기능과 개선 사항이 자동으로 적용되어 최신의 소프트웨어를 제공합니다.
                              </p>
                            </div>
                            <div>
                              <div class="media-wrap">
                                <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_07.jpg"
                      ...
                      <div class="col">
                        <div>
                          <div class="content-wrap">
                            ...
                            <div>
                              <div class="media-wrap">
                                <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_08.jpg"
                            ...
                            <div>
                              <div class="media-wrap">
                                <div class="autoplay-slider-wrap">
                                  <div class="slider">
                                    <div>
                                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_09.jpg"
                                        alt="두 개의 뚜껑이 열린 상태의 기기 내부에서 스팀이 올라오고 있으며, 왼쪽 구역에서 뜨거운 증기가 피어오르는 모습이 강조된 클로즈업 이미지입니다." />
                                    </div>
                                    <div>
                                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_11.jpg"
                                        alt="로봇청소기의 상단 센서부가 클로즈업된 이미지로, 먼지나 이물질을 깔끔하게 제거해 청소 성능을 오래 유지하도록 하는 기능을 상징적으로 표현한 이미지입니다." />
                                    </div>
                                    <div>
                                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_13.jpg"
                                        alt="로봇청소기가 충전·관리 스테이션에 도킹되어 있고, 옆에는 세정제를 상징하는 병과 반짝임 그래픽이 배치되어 있어 물걸레 세척이나 관리 기능을 표현한 이미지입니다." />
                                    </div>
                                    <div>
                                      <img src="/kr/story/buying-guide/2025/img/vacuum-cleane/img_P05_101_15.jpg"
                ...
                <div id="buying-point-5" name="buying-point-45" style="
                  display: none;
                  --box-height: 620px;
                  --box-m-height: 446px;
                ">
                        ...
                        <div class="content-wrap">
                          ...
                          <div>
                            <div class="media-wrap">
                              <button class="btn-pause">일시멈춤</button>
                              <video autoplay playsinline loop muted
                                src="/kr/story/buying-guide/2025/video/vacuum-cleane/vid_P05_101_16.mp4"></video>
                            </div>
                          </div>
                        </div>
                        <div class="detail-wrap">
            ...
            <section class="useful-tip">
              ...
              <div class="tip-wrap">
                <div class="tip-faq">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/story/faq/cordless-vacuum-cleaners-faq">무선청소기 FAQ</a>
                    <a target="_blank" href="https://www.lge.co.kr/story/faq/robotic-vacuum-cleaner-faq">청소 로봇 FAQ</a>
                  </div>
                </div>
                <div class="tip-subscribe">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/vacuum-cleaners">구독 상품</a>
                  </div>
                </div>
                <div class="tip-best">
                  <h3>
                  ...
                  <div class="btn-wrap">
                    <a target="_blank"
                      href="https://www.lge.co.kr/best-ranking/todays?superCategoryId=CT50000100&categoryId=CT50000111&categoryName=%EC%B2%AD%EC%86%8C%EA%B8%B0">베스트
                      랭킹</a>
                  </div>
                </div>
              </div>
