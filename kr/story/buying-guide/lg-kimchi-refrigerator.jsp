      ...
      <body>
        ...
        <div class="buying-guide" id="content">
          <div class="top-banner autoplay-slider-wrap">
            ...
            <div class="slider">
              <div>
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_01.jpg"
                  ...
                  class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_01.jpg"
                  alt="밝은 배경에 김치냉장고가 놓여 있고, 그 오른쪽에는 작은 화분이 있는 연한 원목 싱크대가 배치되어 있습니다. 싱크대 위에는 스테인리스 수전이 있으며, 그 위 벽면에는 오픈 선반이 설치되어 흰색 식기류와 유리컵이 정리되어 있습니다."
                  class="mobile-only" />
              </div>
              <div>
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_02.jpg"
                  alt="빌트인 구조의 매트 화이트 김치냉장고가 설치되어 있습니다. 그 오른쪽에는 흰색 하부장과 연한 원목 상부장이 조화를 이루고 있으며, 조리대 위에는 와인 병, 컵, 그릇, 나무 도마 등이 깔끔하게 배치되어 있습니다."
                  class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_02.jpg"
                  alt="빌트인 구조의 매트 화이트 김치냉장고가 설치되어 있습니다. 그 오른쪽에는 흰색 하부장과 연한 원목 상부장이 조화를 이루고 있으며, 조리대 위에는 와인 병, 컵, 그릇, 나무 도마 등이 깔끔하게 배치되어 있습니다."
                  class="mobile-only" />
              </div>
              <div>
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_03.jpg"
                  ...
                  class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_03.jpg"
                  alt="부드러운 베이지 톤과 화이트가 조화를 이루는 미니멀한 주방 공간으로, 왼쪽에는 매트 화이트 도어와 메탈릭 베이지 서랍이 조합된 빌트인 김치냉장고가 설치되어 있습니다. 오른쪽에는 동일한 톤의 하부장과 상부장이 일체감 있게 구성되어 있으며, 조리대 위에는 화이트 그릇이 간결하게 배치되어 있습니다."
                  class="mobile-only" />
              </div>
              <div>
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_04.jpg"
                  ...
                  class="pc-only" />
                <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_04.jpg"
                  alt="밝고 심플한 공간에 연출된 미니멀 인테리어로, 왼쪽에는 상부 개폐형 화이트 김치냉장고가 배치되어 있습니다. 오른쪽에는 사선 무늬가 돋보이는 원목 수납장이 놓여 있으며, 그 위에는 초록 식물 화분과 컵, 책이 정돈되어 있습니다."
                  class="mobile-only" />
              </div>
            </div>
          ...
          <div class="guide-wrap inner-wrap">
            <section id="line-up" name="buying-guide-content">
              ...
              <div class="tab-wrap" style="--btn-width: 229px; --btn-m-width: 182px">
              ...
              <button class="nav nav-right">></button> -->
                <div class="vertical-scroll-box">
                  <button class="tab-img active" name="buying-guide-tab" data-target="#product-type-1"
                    ...
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_05.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-2"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_06.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-3"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_07.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-4"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_08.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-5"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_09.png"
              ...
              <div class="tab-content">
                <div id="product-type-1" name="product-type">
                  <div class="img-wrap">
                    ...
                    ">
                      ...
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/kimchi-refrigerators?subCateId=CT50000073"
                          target="_blank"><span>LG 디오스 오브제컬렉션 김치톡톡 </span></a>
                        <p>4도어<span></span>1등급</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_10.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_05.jpg"
                      alt="중앙에는 도어가 활짝 열린 매트 화이트 프렌치도어 김치냉장고가 설치되어 있습니다. 냉장고 내부에는 각종 음료와 유제품이 정돈되어 있으며, 투명한 선반 구조로 내용물이 한눈에 잘 보이도록 구성되어 있습니다. 오른쪽에는 초록 식물과 함께 자연 풍경이 보이는 대형 창이 있어 공간 전체에 밝고 탁 트인 분위기를 더합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                ...
                <div id="product-type-2" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      ...
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/kimchi-refrigerators?subCateId=CT50000073"
                          target="_blank"><span>LG 디오스 오브제컬렉션 김치톡톡 Fit & Max</span>
                        </a>
                        <p>4도어<span></span>1등급</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_11.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_06.jpg"
                      alt="베이지 톤의 주방 공간으로, 중앙에는 도어가 열린 매트 화이트 프렌치도어 김치냉장고가 설치되어 있습니다. 냉장고 내부에는 음료와 유제품이 카테고리별로 정돈되어 있으며, 투명한 선반과 서랍 구조로 내용물이 깔끔하게 진열되어 있습니다. 왼쪽에는 대형 화분이 놓여 자연의 요소를 더하고, 오른쪽에는 간결한 조리대와 수납장이 일체감 있게 구성되어 모던하고 미니멀한 분위기를 연출합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                ...
                <div id="product-type-3" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_12.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_07.jpg"
                      alt="우드 톤과 화이트가 조화를 이루는 미니멀한 주방 공간으로, 왼쪽에는 매트 화이트 하단 서랍형 김치냉장고가 설치되어 있습니다. 오른쪽에는 오픈 선반과 수납장이 이어지며, 선반 위에는 식기와 소품이 정갈하게 정리되어 있습니다. 조리대에는 나무 도마, 허브 화분, 과일 등이 배치되어 있고, 밝은 톤의 벽과 바닥이 어우러져 전체적으로 따뜻하고 차분한 분위기를 자아냅니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                ...
                <div id="product-type-4" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      ...
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/kimchi-refrigerators?subCateId=CT50000073"
                          target="_blank"><span>LG 컨버터블 패키지 오브제컬렉션 Fit & Max
                            (김치전용고)</span></a>
                        <p>컨버터블<span></span>1등급</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_13.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_08.jpg"
                      alt="부드러운 베이지 톤과 화이트가 조화를 이루는 미니멀한 주방 공간으로, 중앙에는 매트 화이트와 메탈릭 베이지 컬러가 어우러진 빌트인 김치냉장고가 설치되어 있습니다. 왼쪽에는 대형 창과 초록 식물 화분이 자연 채광과 생기를 더하며, 오른쪽에는 베이지 수납장과 스테인리스 싱크대, 간결한 그릇들이 정돈되어 있어 전체적으로 세련되고 조화로운 분위기를 연출합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                ...
                <div id="product-type-5" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/kimchi-refrigerators?subCateId=CT50000074"
                          target="_blank"><span>LG 디오스 오브제컬렉션 김치톡톡</span></a>
                        <p>뚜껑형<span></span>2등급</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_14.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_001_09.jpg"
                      alt="밝고 깔끔한 미니멀 인테리어 공간으로, 중앙에는 상부 개폐형 매트 크림 화이트 김치냉장고가 배치되어 있습니다. 왼쪽에는 화이트 하부장 위에 식물 화분과 나무 도마가 정돈되어 있으며, 오른쪽의 전면 유리 통창을 통해 햇빛과 정원이 어우러져 자연스러운 분위기를 연출합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="procuct-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_15.png"
                                alt="김치냉장고 LG 디오스 AI 오브제컬렉션 김치톡톡 (Z495GBB271.AKOR) 메인이미지 3" class="front" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_20.png"
                                alt="김치냉장고 LG 디오스 AI 오브제컬렉션 김치톡톡 (Z495GBB271.AKOR) 줌이미지 6" class="side" />
                          ...
                          <td>
                            <div class="procuct-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_16.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 Fit & Max (Z484GBB172.AKOR) 메인이미지 4" class="front" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_21.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 Fit & Max (Z484GBB172.AKOR) 줌이미지 7" class="side" />
                              <button class="btn-angle" name="btn-angle">
                                다른 각도 보기
                              </button>
                            </div>
                          ...
                          <td>
                            <div class="procuct-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_17.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 Fit & Max (Z334GBB171.AKOR) 메인이미지 3" class="front" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_22.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 Fit & Max (Z334GBB171.AKOR) 줌이미지 6" class="side" />
                              <button class="btn-angle" name="btn-angle">
                                다른 각도 보기
                              </button>
                            </div>
                          ...
                          <td>
                            <div class="procuct-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_18.png"
                                alt="냉장고 LG 컨버터블 패키지 오브제컬렉션 Fit & Max (김치전용고) (Z324GB7.AKOR) 메인이미지 3" class="front" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_23.png"
                                alt="냉장고 LG 컨버터블 패키지 오브제컬렉션 Fit & Max (김치전용고) (Z324GB7.AKOR) 줌이미지 11" class="side" />
                              <button class="btn-angle" name="btn-angle">
                                다른 각도 보기
                              </button>
                            </div>
                          ...
                          <td>
                            <div class="procuct-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_19.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 (Z225MEE151.AKOR) 메인이미지 3" class="front" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_001_24.png"
                                alt="김치냉장고 LG 디오스 오브제컬렉션 김치톡톡 (Z225MEE151.AKOR) 줌이미지 6" class="side" />
                              <button class="btn-angle" name="btn-angle">
                                다른 각도 보기
                              </button>
                            </div>
                        ...
                        <tr class="procuct-spec">
                          <td>
                            ...
                            <p>
                              ...
                              <span class="des">
                                ...
                                <span class="bubble">단독으로 설치 가능해 배치를 자유롭게</span>
                              </span>
                            </p>
                          </td>
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_fixandmax_4door.svg"
                                alt="Fit & Max" />
                              <img
                                src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_freestanding_4door.svg"
                                alt="프리스탠딩" />
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">설치와 이동은 프리스탠딩처럼 편리하며, 주방가구와 밀착설치로 깔끔하게</span>
                              </span>
                            </p>
                          </td>
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_fixandmax_3door.svg"
                                alt="Fit & Max" />
                              <img
                          ...
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_fixandmax_1door.svg"
                                alt="Fit & Max" />
                              <img
                        ...
                        <tr class="procuct-spec">
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_dividerwall.svg"
                                alt="다용도 분리벽" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_multiboard.svg"
                                alt="다목적 보관모드" />
                            </div>
                            <p>
                              다용도 분리벽 &<br />다목적 보관모드
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">상칸을 좌우로 나눠주는 분리벽으로 공간을 알차고 자유롭게, LG ThinQ 앱으로 제공되는 식품 리스트로 편리하게
                                  보관</span>
                              </span>
                            </p>
                          </td>
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_topopen.svg"
                                alt="오픈형 상칸" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_multiboard.svg"
                                alt="다목적 보관모드" />
                            </div>
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">분리벽 없이 넓은 상칸으로 부피가 큰 식재료를 통째로! 보관하는 식재료에 따라 ThinQ 앱으로 편리하게 맞춤 온도로
                                  보관</span>
                              </span>
                            </p>
                          </td>
                          <td>
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">ThinQ 앱을 통해서 칸칸마다 따로 식재료에 맞게 맞춤 보관</span>
                              </span>
                            </p>
                          </td>
                          <td class="disabled">
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_gourmet.svg"
                                alt="미식 전문 보관" />
                            </div>
                            <p>
                              미식 전문 보관
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">보관하는 식재료의 특성에 맞춰 최적의 상태로
                                  신선하게</span>
                              </span>
                            </p>
                          </td>
                          <td class="disabled">
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_multifridge.svg"
                                alt="미식 전문 보관" />
                            </div>
                            <p>
                              다용도 냉장고
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">김치/냉동/야채/육류 등 원하는 용도로
                                  알차게</span>
                              </span>
                            </p>
                          </td>
                        ...
                        <tr class="procuct-spec">
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_kimchi.svg"
                                alt="유산균 김치+" />
                            </div>
                            <p>
                              유산균 김치+
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">맛있는 유산균을 최대 57배 더 증식시켜주는 맞춤 보관 기술</span>
                              </span>
                            </p>
                          </td>
                          <td>
                          ...
                          <td class="disabled">
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_kimchistorage.svg"
                                alt="김치 보관/익힘기" />
                            </div>
                            <p>
                              김치 보관/익힘기
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">주변 온도에 맞는 익힘 알고리즘과 염도에 따라
                                  적절하게</span>
                              </span>
                            </p>
                          </td>
                        ...
                        <tr class="procuct-spec">
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_AIstorage.svg"
                                alt="AI 맞춤보관" />
                            </div>
                            <p>
                              AI 맞춤보관
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">포장김치를 ThinQ 앱에 등록하면 사용자 패턴에 따라 온도를 관리해 신선하게 보관</span>
                              </span>
                            </p>
                          </td>
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_AIcare.svg"
                                alt="인공지능 맞춤보관" />
                            </div>
                            <p>
                              인공지능 맞춤보관
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">포장김치를 ThinQ 앱에 등록하면 김치에 맞춰서 기능을 맞춤 설정</span>
                              </span>
                            </p>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">포장김치를 ThinQ 앱에 등록하면 맞춰서 보관</span>
                              </span>
                            </p>
                          </td>
                          <td class="disabled">
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">포장김치의 제조사와 제조일자에 맞춰 더욱
                                  맛있게</span>
                              </span>
                            </p>
                          </td>
                        ...
                        <tr class="procuct-spec">
                          <td>
                            <div class="spec-img">
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_caresystem.svg"
                                alt="냉기케어 시스템" />
                              <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/ic48_08_freshtemp.svg"
                                alt="신선정온" />
                            </div>
                            <p>
                              냉기케어 시스템 <br />& 신선정온
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">구석구석 빈틈없이 일정한 냉기로 맛과 신선함을 오래오래</span>
                              </span>
                            </p>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">±0.3℃ 온도편차로 정온을 유지해 식재료와 김치를 신선하게 보관</span>
                              </span>
                            </p>
                          </td>
                          <td class="disabled">
                            ...
                            <p>
                              ...
                              <span class="des">
                                <button class="info pc-only"></button>
                                <span class="bubble">±0.3℃의 온도 편차로 식재료 본연의 맛을
                                  온전하게</span>
                              </span>
                            </p>
                          </td>
                ...
                <div id="buying-point-1" name="buying-point">
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_01.jpg"
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_02.jpg"
                        ...
                        <div class="content">
                          <h5>컨버터블</h5>
                          <p>
                            전형적인 냉장고 형태에서 벗어나 주방 인테리어와 자연스럽게 어울리도록 디자인되어 있습니다. 특히, 설치공간에 따라 도어 방향을 변경할 수 있어 공간 변화에도 편리하게
                            사용할 수 있습니다.
                          </p>
                          <div class="btn-wrap">
                            <a class="btn-product"
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_03.jpg"
                      ...
                      <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            ...
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_01.mp4"></video>
                          </div>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_04.jpg"
                  ...
                  <div class="point-tip" id="point-tip1">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_11.jpg"
                          ...
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_101_01.jpg"
                          alt="미니멀한 디자인의 주방 공간으로, 왼쪽에는 매트 화이트 컬러의 하단 서랍형 김치냉장고가 배치되어 있습니다. 오른쪽에는 연한 우드 톤의 오픈 선반과 하부장이 구성되어 있으며, 선반 위에는 식기류와 소품이 정돈되어 있고 나무 도마와 화분이 따뜻한 분위기를 더합니다."
                          class="mobile-only" />
                      </div>
                    </div>
                  ...
                  <div class="point-tip" id="point-tip2" style="display: none">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_12.jpg"
                          ...
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_101_02.jpg"
                          alt="깔끔한 올화이트 인테리어 공간 중앙에는 빌트인 3도어 김치냉장고가 설치되어 있으며, 좌측부터 화이트, 크림, 베이지 톤의 패널이 세련된 색상 조화를 이룹니다. 오른쪽에는 간결한 싱크대와 화병이 놓인 조리 공간이, 왼쪽에는 작은 원형 테이블과 화병이 포인트로 배치되어 전체적으로 모던하고 정돈된 분위기를 자아냅니다."
                          class="mobile-only" />
                      </div>
                    </div>
                ...
                <div id="buying-point-2" name="buying-point" style="display: none">
                      ...
                      <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_11.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 유산균 김치+</span>
                          </button>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_06.mp4"></video>
                          </div>
                        </div>
                        <div class="content">
                          <h5>AI 맞춤보관</h5>
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_02.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* AI 맞춤보관 / 포장김치 ThinQ 앱 사용 / 제휴
                              브랜드 제품</span>
                          </button>
                          <div class="collapse-content">
                            <p>
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_03.mp4"></video>
                          </div>
                        </div>
                        <div class="content">
                          <h5>±0.3℃ 신선정온</h5>
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_12.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* ±0.3℃ 신선정온</span>
                          </button>
                      ...
                      <div class="point-wrap" id="buying-point-2-2" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_13.mp4"></video>
                          </div>
                        </div>
                        <div class="content">
                          <h5>청정탈취 필터</h5>
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_09.jpg"
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_04.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 균 번식 억제 성능 / 탈취 성능 / 탈취 용량</span>
                          </button>
                          <div class="collapse-content">
                            <p>
                              <b>[균 번식 억제 성능]</b><br />
                  ...
                  <div class="point-tip" id="point-tip3">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_13.jpg"
                          alt="김치냉장고 용기 안에 총각김치, 백김치, 배추김치가 각각 정갈하게 담겨 있으며, 선명한 색감과 재료의 신선함이 유지되고 있습니다."
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_101_03.jpg"
                          alt="김치냉장고 용기 안에 총각김치, 백김치, 배추김치가 각각 정갈하게 담겨 있으며, 선명한 색감과 재료의 신선함이 유지되고 있습니다."
                          class="mobile-only" />
                      </div>
                    </div>
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <div class="media-wrap">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_10.mp4"></video>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div id="buying-point-3" name="buying-point" style="display: none">
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_05.mp4"></video>
                          </div>
                        </div>
                        <!-- <div class="content">
                        <h5>미식 전문 보관</h5>
                      ...
                      <div class="point-wrap" id="buying-point-3-2" name="buying-point-3" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_10.gif"
                  ...
                  <div class="point-tip" id="point-tip5">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_15.jpg"
                          alt="다양한 신선 식재료가 나뉜 프레임 안에 배열된 이미지로 고구마, 막걸리, 오이, 가지, 자두 등이 각각의 칸에 담겨 있습니다."
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_101_05.jpg"
                          alt="다양한 신선 식재료가 나뉜 프레임 안에 배열된 이미지로 고구마, 막걸리, 오이, 가지, 자두 등이 각각의 칸에 담겨 있습니다."
                          class="mobile-only" />
                      </div>
                    </div>
                  ...
                  <div class="point-tip" id="point-tip6" style="display: none">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_16.jpg"
                          ...
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_M08_101_06.jpg"
                          alt="프렌치도어 스타일의 김치냉장고가 정면으로 열린 모습으로, 상단에는 유제품, 음료, 가공식품, 채소 등이 카테고리별로 정리되어 있습니다. 중간 서랍에는 사과, 오렌지, 망고 등 과일류가, 하단 서랍에는 당근, 오이, 고추, 파프리카 등 신선한 채소들이 가득 담겨 있습니다."
                          class="mobile-only" />
                      </div>
                    </div>
                ...
                <div class="point-box">
                  ...
                  <div class="tab-content">
                    <div id="buying-point-4" name="buying-point-45">
                      <div class="slideWrap colWrap" style="--box-height: 413px; --box-m-height: 295px">
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <button class="btn-pause">일시멈춤</button>
                                  <video autoplay playsinline loop muted
                                    src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_07.mp4"></video>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <button class="btn-pause">일시멈춤</button>
                                  <video autoplay playsinline loop muted
                                    src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_08.mp4"></video>
                                </div>
                              </div>
                            </div>
                            <div class="detail-wrap">
                            ...
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <button class="btn-pause">일시멈춤</button>
                                  <video autoplay playsinline loop muted
                                    src="/kr/story/buying-guide/2025/video/kimchi-refrigerator/vid_P08_101_09.mp4"></video>
                                </div>
                              </div>
                            </div>
                            <div class="detail-wrap">
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_17.jpg"
                    ...
                    <div id="buying-point-5" name="buying-point-45" style="display: none">
                      <div class="slideWrap colWrap" style="--box-height: 442px; --box-m-height: 315px">
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              <div>
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_18.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_19.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_20.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/kimchi-refrigerator/img_P08_101_21.jpg"
            ...
            <section class="useful-tip">
              ...
              <div class="tip-wrap">
                <div class="tip-faq">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/story/useful-tip/kimchi-refrigerators-faq">FAQ</a>
                  </div>
                </div>
                <div class="tip-subscribe">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/kimchi-refrigerators">구독
                      상품</a>
                  </div>
                </div>
                <div class="tip-best">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank"
                      href="https://www.lge.co.kr/best-ranking/todays?superCategoryId=CT50000064&categoryId=CT50000072&categoryName=%EA%B9%80%EC%B9%98%EB%83%89%EC%9E%A5%EA%B3%A0">베스트
                      랭킹</a>
                  </div>
                </div>
              </div>
