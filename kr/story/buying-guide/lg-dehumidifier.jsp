          ...
          <section id="line-up" name="buying-guide-content">
            ...
            <div class="tab-content">
                        ...
                        <tbody>
                          ...
                          <tr class="procuct-spec">
                            <td>
                              <div class="spec-img">
                                <img
                                  src="/kr/story/buying-guide/2025/img/dehumidifier/ic48_02_airkit.svg"
                                  alt="공기청정 키트"
                                />
                              </div>
                              <p>
                                ...
                                <span class="des">
                                  <span class="info pc-only"></span>
                                  <span class="bubble"
                                    >흡입된 미세먼지를 제거해 제품 내부를 위생적으로</span
                                  >
                                </span>
                              </p>
                            </td>
              ...
              >
                ...
                <div class="text-wrap">
                  <h4>
                    실내 습도 조절부터 빨래 건조까지 라이프스타일에 맞게
                    다용도로
                  </h4>
                  <p>
                    거실이나 원룸 등 어디서나 다용도로 사용할 수 있는 적당한
                    제습 용량으로 실내 습도를 조절해 공간은 쾌적하게 젖은 빨래를
                    말릴 때는 습한 건조대 주변에 두면 빨래 건조가 훨씬 쉬워져요.
                  </p>
                </div>
                <p class="note">
                  * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및
              ...
              >
                ...
                <div class="text-wrap">
                  <h4>욕실부터 드레스룸까지 구석구석 뽀송하게</h4>
                  <p>
                    습한 욕실이나 옷 장 속 숨은 습기까지 다양한 제습 모드로
                    상황에 따라 맞춤 제습을 할 수 있습니다. 옷과 가구를
                    습기로부터 보호하고 이동이 편리해 제습이 필요한 생활 공간
                    곳곳을 쾌적하게 유지할 수 있어요.
                  </p>
                </div>
                <p class="note">
                            ...
                            <td>
                              ...
                              <p>
                                ...
                                <span class="des"
                                  ><span class="info pc-only"></span>
                                  <span class="bubble"
                                    >흡입된 미세먼지를 제거해 <br class="mo-only"/>제품 내부를 위생적으로</span
                                  ></span
                                >
                              </p>
                            </td>
                ...
                <div class="subtab-wrap">
                  ...
                  <div class="subtab-content">
                    <div
                      ...
                      name="buying-point-1"
                    >
                      <h4 class="hide">강력 제습</h4>
                      <div class="content">
                        <h5>강력 제습</h5>
                        <p>
                          듀얼 인버터 기술이 적용되어 대용량 제습에도 소음을
                          최소화하고 원하는 습도에 빠르게 도달해 쾌적한 실내
                          공간을 유지해줍니다. 에너지 소비효율 1등급으로 전기료
                          부담까지 줄여 알뜰한 제습을 할 수 있어요.
                        </p>
                        <div class="img">
                          <img
                        ...
                        <div class="collapse-content">
                          ...
                          <p>
                            <b>[전기료]</b><br />
                            * 하루 5.7시간 사용 기준* 쾌속의류 제습모드 사용 시,
                            하루 전기료 327원, 저소음 제습모드 사용 시, 하루
                            전기료 145원으로 쾌속 제습모드 대비 44.4% 전기료
                            절감 효과<br />
                            * 전기료는 25년 4월 주택용 전력(저압) 1구간의
                            전력량요금(120원/kWh)를 기준으로 계산함<br />
                            * 해당 전기료는 전력량요금(사용요금)으로 기본요금,
                            기후환경요금, 연료비조정요금, 부가가치세,
                            전력산업기반기금 등은 제외하고 계산한 결과이며, 최종
                            청구되는 전기료는 누진세 구간과 사용환경에 따라
                            차이가 있을 수 있습니다.<br />
                            * 실제 발생하는 전기요금은 사용 환경에 따라 다를 수
                            있습니다.
                          </p>
                    ...
                    >
                      ...
                      <div class="content">
                        <h5>빠른 제습</h5>
                        <p>
                          참을 수 없는 장마철의 꿉꿉함, 높은 습도 90%에서도
                          상쾌한 습도 40%까지 약 30분만에 빠르게 뽀송하고 쾌적한
                          공간으로 만들어줍니다.
                        </p>
                        <div class="img">
                          <img
                        ...
                        <div class="collapse-content">
                          <p>
                            * 시험일시 : 2024년 6월 20일<br />
                            * 시험기관 : TÜV Rheinland<br />
                            * 시험대상 : DQ134MWGA<br />
                            * 시험 조건 : 온도 (27.0±1.0)℃ / 상대습도
                            (90.0±2.0)%R.H<br />
                            * 시험 장소 : LG전자 제습기 시험실<br />
                            * 시험 방법 :<br />
                            온도/상대습도 실험환경치 도달 후 챔버 전원 OFF 후
                            제품 ON (제품 최대 풍량)하여 상대습도 90%에서 목표
                            습도인 40%까지 시간별 상대습도 변화 기록<br />
                            * 평가 방법 : 상대습도 90%에서 목표 습도인 40%까지
                            도달하는 데 소요된 시간 측정<br />
                            * 시험 결과 : 습도 90%에서 40% 도달까지 89분 54초
                            소요<br />
                            * 시험 환경 기준의 수치이며, 실제 목표습도에
                            도달되는 시간은 실사용 환경에서 다를 수 있습니다.
                          </p>
                          <button class="btn-collapse-close">접기</button>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div class="content">
                        <h5>맞춤 제습</h5>
                        <p>
                          거실처럼 넓은 공간에서는 설정 습도와 현재 습도 차이를
                          감지해 풍량 조절을 해주고 천장 결로나 높이 걸린 세탁물
                          건조 할 때는 토출구 각도를 조절해 빠르게 건조해줍니다.
                          스마트+, 저소음, 쾌속의류 제습 등 다양한 모드를 선택해
                          공간과 용도에 맞게 활용할 수 있습니다.
                        </p>
                        <div class="img">
                        ...
                        <div class="collapse-content">
                          <p>
                            <b>[쾌속의류 제습모드]</b><br />
                            * 빨래 건조에 적합하도록 목표 습도를 설정하지 않고,
                            주변 습도와 상관 없이 컴프레서와 풍량을 강하게
                            운전하며 토출구가 연속 스윙합니다.<br />
                          </p>
                          <p>
                            <b>[집중건조 제습모드]</b><br />
                            * 집중건조 키트를 제습기 후면에 연결할 때 사용하는
                            모드로, 젖은 신발, 옷장 등을 집중적으로 건조할 수
                            있습니다.<br />
                            * 집중건조 키트는 별매입니다. <br />
                          </p>
                          <p>
                            ...
                            * 시험기관 : 한국전자기술연구원<br />
                            * 시험대상 : DQ154MWGA<br />
                            * 시험조건 : 건구온도 27±2℃/상대습도 60±10%
                            (SPS-KACA0020-6631:2016 준용)<br />
                            * 시험 장소 : 광주지역본부 연구동 무향실<br />
                            * 시험 방법 : 챔버 내 온도/상대습도가 실험 환경치에
                            도달할 경우, 항온항습 유지, 제품 외곽 표면에서 1m
                            떨어진 전면, 우측면, 좌측면, 후면, 상면 5점 측정하여
                            평균 소음값 표기 (SPS-KACA0020-6631:2016 준용)<br />
                            * 시험모드 : 저소음 제습모드(풍량 : 약)<br />
                            * 시험결과 : 5점 평균 소음 31.9 dB(A)<br />
                            * 속삭이는 소리의 소음 : 30dB / 도서관 수준의 소음 :
                            40 dB (국가 소음정보시스템 기준 :
                            https://www.noiseinfo.or.kr/inform/noise.do)<br />
                            * 시험 환경 기준의 수치이며, 실사용 환경에서는 다를
                            수 있습니다.<br />
                            * 저소음 제습모드(풍량 : 약) 사용 시 다른 제습모드
                            대비, 제습에 소요되는 시간이 길어질 수 있습니다.<br />
                            * DQ154MWGA(15L)와 DQ134MWEC(13L)의 구조가 동일하여,
                            DQ154MWGA의 시험 결과를 준용하였습니다.<br />
                          </p>
                          <p>
                            <b>[맞춤 바람방향]</b><br />
                        ...
                        <div class="collapse-content">
                          <p>
                            ...
                            * 저소음 제습모드(풍량 : 약) 사용 시 다른 제습모드
                            대비, 제습에 소요되는 시간이 길어질 수 있습니다.<br />
                            * DQ154MWGA(15L)와 DQ134MWEC(13L)의 구조가 동일하여,
                            DQ154MWGA의 시험 결과를 준용하였습니다.
                          </p>
                          <p>
                            <b>[전기료]</b><br />
                            * 하루 5.7시간 사용 기준<br />
                            * 쾌속의류 제습모드 사용 시, 하루 전기료 273원,
                            저소음 제습모드 사용 시, 하루 전기료 146원으로 쾌속
                            제습모드 대비 53.5% 전기료 절감 효과<br />
                            * 전기료는 24년 7월 주택용 전력(저압) 1구간의
                            전력량요금(120원/kWh)를 기준으로 계산함<br />
                            * 해당 전기료는 전력량요금(사용요금)으로 기본요금,
                            기후환경요금, 연료비조정요금, 부가가치세,
                            전력산업기반기금 등은 제외하고 계산한 결과이며, 최종
                ...
                <div class="point-tip">
                  ...
                  <div class="tip-content">
                    <div class="content">
                      ...
                      <h6 class="tip-title">
                        우리 집에 딱 맞는 제습으로 사계절 내내 뽀송하게
                      </h6>
                      <p class="tip-text">
                        실내에서 잘 마르지 않는 빨래가 걱정될 때도, 밖에서
                        사용해 더 세심한 관리가 필요한 캠핑 용품을 정리할 때도,
                        옷에 남은 습기가 불쾌하게 느껴지는 옷방을 살필 때도,
                        겨울철 온도 차로 찾아오는 결로나 곰팡이가 신경 쓰이는
                        순간까지. 이 모든 상황에 꼭 맞춘 제습으로 사계절 내내
                        공간을 뽀송하게 유지해 줍니다. 다양한 공간과
                        라이프스타일에 자연스럽게 스며드는 제습 기능으로 집안
                        곳곳을 더 쾌적하게 관리해보세요.
                      </p>
                    </div>
                    <div class="img">
                          ...
                          <div class="collapse-content">
                            ...
                            <p>
                              ...
                              *‘듀얼 인버터 컴프레서’는 실린더가 1개인 기존
                              컴프레서와 달리 냉매를 압축하는 실린더가
                              2개입니다.<br />
                              두 개의 실린더가 동시에 냉매를 압축해 효율은
                              늘리고, 소음은 줄입니다.
                            </p>
                            <p>
                              <b>[전기료]</b><br />
                              * 하루 5.7시간 사용 기준<br />
                              * 쾌속의류 제습모드 사용 시, 하루 전기료 327원,
                              저소음 제습모드 사용 시, 하루 전기료 145원으로
                              쾌속 제습모드 대비 44.4% 전기료 절감 효과<br />
                              * 전기료는 25년 4월 주택용 전력(저압) 1구간의
                              전력량요금(120원/kWh)를 기준으로 계산함<br />
                              * 해당 전기료는 전력량요금(사용요금)으로 기본요금,
                              기후환경요금, 연료비조정요금, 부가가치세,
                              전력산업기반기금 등은 제외하고 계산한 결과이며,
                              최종 청구되는 전기료는 누진세 구간과 사용환경에
                              따라 차이가 있을 수 있습니다.
                            </p>
                            <button class="btn-collapse-close">접기</button>
                          </div>
                          ...
                          <div class="collapse-content">
                            <p>
                              * 연속 배수 호스를 연속 배수구에 삽입하여
                              연결해주세요.<br />
                              * 연속 배수를 위한 호스는 제품 구매 시 제공하지
                              않으며, 일반적인 호스를 별도 구매하여 사용할 수
                              있습니다 (안쪽 지름 16mm)<br />
                              * 연출된 이미지이며 실제 제품과는 차이가 있을 수
                              있습니다.
                            </p>
                            <button class="btn-collapse-close">접기</button>
                          </div>
