                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr class="procuct-spec">
                            <td>
                              <div class="spec-img">
                                <img src="/kr/story/buying-guide/2025/img/drying-machine/ic48_06_AItime.svg"
                                  alt="AI 건조" />
                              </div>
                              <p>
                                AI 타임센싱
                          ...
                          <tr class="procuct-spec">
                            <td>
                              <div class="spec-img">
                                <img src="/kr/story/buying-guide/2025/img/drying-machine/ic48_06_AInotify.svg"
                                  alt="AI 건조" />
                              </div>
                              <p>
                                AI 시간안내
                                <span class="des">
                                  <button class="info pc-only"></button>
                                  <span class="bubble">건조기를 사용할수록
                                    더욱 정확도가 높아지는 건조 예상 시간</span>
                                </span>
                              </p>
                            </td>
                            <td class="disabled">
                          ...
                          <tr class="procuct-spec">
                            <td>
                              <div class="spec-img">
                                <img src="/kr/story/buying-guide/2025/img/drying-machine/ic48_06_steam.svg"
                                  alt="트루스팀" />
                              </div>
                              <p>
                                트루스팀
                          ...
                          <tr class="procuct-spec">
                            <td>
                              <div class="spec-img">
                                <img src="/kr/story/buying-guide/2025/img/drying-machine/ic48_06_carecourse_plus.svg"
                                  alt="수축완화코스+" />
                              </div>
                              <p>
                                수축완화코스+
                          ...
                          <tr class="procuct-spec">
                            ...
                            <td>
                              <div class="spec-img">
                                <img src="/kr/story/buying-guide/2025/img/drying-machine/ic48_06_LCD-2.svg"
                                  alt="다이얼 + LED 디스플레이" />
                              </div>
                              <p>
                                다이얼 + LED 디스플레이
                          ...
                          <tr class="product-btn">
                            <td>
                              <a href="https://www.lge.co.kr/dryers/rd25ese?sKwd=RD25ESE&sTab=unit_product_list&sRank=1&share=Y"
                                target="_blank" class="btn-product">제품 보러 가기</a>
                            </td>
                            <td>
                              <a href="https://www.lge.co.kr/dryers/rd22gs?sKwd=rd22gs&sTab=unit_product_list&sRank=1&share=Y"
                                target="_blank" class="btn-product">제품 보러 가기</a>
                            </td>
                            <td>
                    ...
                    <div class="subtab-content">
                      ...
                      <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          <h5>병렬설치</h5>
                          <p>
                            상단부 공간을 활용하고 싶고 공간이 넉넉한 경우에는 세탁기와 나란히 설치하는 병렬 설치 방식이 있습니다. 병렬 설치는 건조기 좌,우 공간을 각각 50mm씩 확보하고
                            후면 공간을
                      ...
                      <div class="point-wrap" id="buying-point-1-3" name="buying-point-1" style="display: none">
                        ...
                        <div class="content">
                          <h5>단독설치</h5>
                          <p>
                            설치 공간만 확보된다면, 건조기도 세탁기처럼 단독으로 설치가 가능합니다. 배수 환경에 따라 물통을 사용하는 형태로도 설치가 가능해 환경에 맞추어 유연하게 사용할 수
                            있어요.
                  ...
                  <div class="point-tip" id="point-tip1">
                    ...
                    <div class="tip-content">
                      <div class="content">
                        ...
                        <p class="tip-text">
                          보통의 세탁 공간을 생각하면, 세탁기와 건조기를 나란히 설치해 사용하기는 쉽지 않아요. 이런 경우 보유하고 있는 세탁기 위에 건조기를 올려 효율적인 공간 활용이 가능한
                          방법을
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                        ...
                        <div class="content">
                          <h5>AI 건조</h5>
                          <p>
                            세탁물을 투입하면 AI 타임 센싱이 3초만에 코스별 예상 시간을 안내하고 건조 중 남은 건조 완료 예상 시간을 정확도게 높게 알려주어 남은 건조시간을 정확도 높게 
                            예측 할 수
                            있습니다.
                            AI가 의류의 재질을 감지하여 최적의 온도와 시간으로 섬세하게 건조합니다.
                          </p>
                          ...
                          <div class="collapse-content">
                            ...
                            <p>
                              <b>[AI 시간 안내]</b><br />
                              * 자사시험결과 제품 표시 시간과 실제 건조 동작 시간에 대한 시간 정확도가 개선 되었으며 (AI 시간 안내 기능 미적용 모델 RD22**** 대비), 시간
                              정확도는 설치
                      ...
                      <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <p>
                            AI가 세탁물의 무게와 습도를 스스로 감지하여 옷감에 꼭 맞는 건조 모션을 선택합니다. DD모터를 통해 6가지의 섬세한 모션을 구현해 옷감에 맞는 최적의 모션을
                            구현해
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <div class="media-wrap">
                          <button class="btn-pause">일시멈춤</button>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/drying-machine/vid_P07_001_05.mp4"
                            class="pc-only"></video>
                          <video autoplay playsinline loop muted
                            src="/kr/story/buying-guide/2025/video/drying-machine/vid_M07_001_01.mp4"
                            class="mo-only"></video>
                        </div>
                      </div>
                    </div>
                ...
                <div id="buying-point-3" name="buying-point" style="display: none">
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                        ...
                        <div class="content">
                          ...
                          <p>
                            바이러스는 걱정되지만, 매일 빨기 어려운 옷이나 이불은 스팀 살균 코스로 간편하게 케어해보세요. 집먼지 진드기, 알러지 유발 물질, 유해 세균까지 99.99% 살균해
                            걱정을
                          ...
                          <div class="collapse-content">
                            ...
                            <p>
                              ...
                              * 시험 결과 : 집먼지 진드기 성충 100% 살충, 고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f 1) 알레르겐 99.9%
                              제거<br />
                              * 시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.
                            </p>
                            <p>
                            ...
                            <p>
                              ...
                              * 시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.<br />
                              * 시험 방법 : 자사가 제시한 시험 기준으로, 셔츠 등판 300mm x 300mm 기준 셔츠에 임의 구김을 부여한 후, 셔츠를 무작위로 선택하여건조기 동작 전,
                              후
                              AATCC 시험평가판으로 비교<br />
                  ...
                  <div class="point-tip" id="point-tip4">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/drying-machine/img_P07_001_16.jpg" alt=""
                          class="pc-only" />
                          ...
                          <div>
                            <div class="content-wrap">
                              <div>
                                ...
                                <p>
                                  복잡한 화면을 일일이 누를 필요 없이, 다이얼 하나로 코스 선택부터 시간 설정, 알림 확인까지 손쉽게 조작할 수 있습니다. 누구나 직관적으로 사용하고
                                  확인할 수
                                  있어, 건조가 더욱 편리해집니다.
                                </p>
                              </div>
                          ...
                          <div>
                            <div class="content-wrap">
                              <div>
                                ...
                                <p>
                                  세탁물을 바로 꺼낼수 없을때 일정한 간격으로 드럼을 회전 시켜 세탁물의 뭉침을 완화하고, 구김과 냄새를 방지합니다. ThinQ 앱에서 한 번만 설정해두면,
                                  세탁이
                            ...
                            <div class="detail-wrap">
                              ...
                              <div class="collapse-content">
                                <p>
                                  ...
                                  * 일정 시간 간격으로 드럼을 회전시켜 세탁물의 뭉침을 완화하여, 세탁 종료 후 세탁물을 그대로 두는 경우에 비해 옷감의 구김이 덜 생기는 효과가
                                  있습니다. 해당
                                  효과는 내부 시험 결과로 사용 환경 등에 따라 차이가 있을 수 있습니다.<br />
                                  * 30분 단위로 설정 할 수 있으며 세탁기는 최대 4시간, 건조기는 2시간 동안 작동합니다. 설정 시간이 경과하면 작동을 종료 하며, 기기는 원격 제어
                                  유지상태로
                                  전환됩니다.<br />
                                  * "종료 후 세탁물케어 자동설정"을 선택하면, 코스가 종료 될 때 마다 별도의 설정 없이 자동으로 세탁물 케어가 실행됩니다. ThinQ 앱에서 '추가
                                  세탁하기'
                                  또는 '추가 건조하기'를 선택하여 추가 세탁이나 건조가 가능합니다.<br />
                                  * ‘종료 3분 전 알림’을 설정하면 ‘종료 후 세탁물 케어'를 미리 설정하지 않았을 때, 해당 기능을 사용 할 수 있도록 알림을 받을 수 있습니다. 단,
                                  '종료
