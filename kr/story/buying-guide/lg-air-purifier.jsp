        ...
        <div class="wrap subRenewWrap subRenewWrap--share subRenewWrap--story">
          ...
          <div class="buying-guide" id="content">
            <div class="top-banner autoplay-slider-wrap">
              ...
              <div class="slider">
                <div>
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_01.jpg"
                    alt="탁 트인 창가 공간에 원형 디스플레이를 갖춘 공기청정기가 세워져 있으며, 주변의 심플한 가구와 어우러져 세련되고 조용한 실내 환경을 연출하는 모습입니다."
                    class="pc-only" />
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_01.jpg"
                ...
                <div>
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_02.jpg"
                    alt="밝은 거실 공간에 놓인 LG 퓨리케어 AI 360˚ 공기청정기 플러스의 모습입니다. 공기청정기는 검은색 원형 상단부와 흰색 원통형 몸체 두 개로 구성되어 있으며, 현대적이고 세련된 디자인을 강조합니다."
                    class="pc-only" />
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_02.jpg"
                    alt="밝은 거실 공간에 놓인 LG 퓨리케어 AI 360˚ 공기청정기 플러스의 모습입니다. 공기청정기는 검은색 원형 상단부와 흰색 원통형 몸체 두 개로 구성되어 있으며, 현대적이고 세련된 디자인을 강조합니다."
                    class="mobile-only" />
                </div>
                <div>
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_03.jpg"
                    ...
                    class="pc-only" />
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_03.jpg"
                    alt="흰색 벽면을 배경으로, 우측에는 LG 퓨리케어 오브제컬렉션 에어로타워 Hit 모델의 공기청정기가 배치되어 있고, 좌측 벽에는 추상적인 녹색 그림과 검은색 세로 줄무늬의 직사각형 장식물이 걸려 있습니다. 공기청정기 옆에는 크림색 의자가 있고, 밝은 갈색 나무 바닥에는 크림색 러그가 깔려 있습니다."
                    class="mobile-only" />
                </div>
                <div>
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_04.jpg"
                    ...
                    class="pc-only" />
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_04.jpg"
                    alt="하얀 배경의 거실 환경에 LG 퓨리케어 AI 오브제컬렉션 에어로퍼니처 제품이 배치되어 있습니다. 공기청정기 원통형 본체는 수직으로 배열된 얇은 회색 선으로 디자인이 되어 있으며, 상단에는 흰색 원형 테이블이 결합되어 있습니다. 바닥에는 흰색과 파란색이 조합된 디자인의 러그가 있습니다."
                    class="mobile-only" />
                </div>
                <div>
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_05.jpg"
                    ...
                    class="pc-only" />
                  <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_05.jpg"
                    alt="밝고 현대적인 거실에서 LG 퓨리케어 오브제컬렉션 에어로부스터가 중앙에 위치하며, 세련된 원통형 디자인과 상단의 기울어진 원반형 디스플레이가 특징입니다. 옆에는 화분으로 장식되어 있고, 뒤로는 창문이 햇빛을 받아 밝은 분위기를 조성합니다. 전체적으로 미니멀하고 깨끗한 공간을 연출합니다."
                    class="mobile-only" />
                </div>
              </div>
                    ...
                    &lt;</button>
                      ...
                      <div class="vertical-scroll-box">
                        <button class="tab-img active" name="buying-guide-tab" data-target="#product-type-1"
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_06.png"
                            alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기 (AS356NSMA)" />
                          <span><b>AI 360°</b>#AI공기청정 #UV공기살균</span>
                        </button>
                        <button class="tab-img" name="buying-guide-tab" data-target="#product-type-2"
                          data-group="product-type">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_07.png"
                        ...
                        <button class="tab-img" name="buying-guide-tab" data-target="#product-type-3"
                          data-group="product-type">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_08.png"
                        ...
                        <button class="tab-img" name="buying-guide-tab" data-target="#product-type-4"
                          data-group="product-type">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_09.png"
                        ...
                        <button class="tab-img" name="buying-guide-tab" data-target="#product-type-5"
                          data-group="product-type">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_10.png"
                        ...
                        <button class="tab-img" name="buying-guide-tab" data-target="#product-type-6"
                          data-group="product-type">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_11.png"
                ...
                <div class="tab-content">
                  <div id="product-type-1" name="product-type">
                    ...
                    ">
                      ...
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_12.jpg"
                        alt="모던한 거실 공간에 공기청정기가 놓여 있습니다. 원형 디스플레이와 세로 결 무늬가 돋보이는 본체 디자인이 세련된 분위기를 더하며, 옆에는 회색 소파와 원형 테이블이 어우러져 편안한 공간감을 연출합니다. 전면 유리창 너머로는 탁 트인 뷰가 펼쳐져 조화로운 인테리어를 완성합니다."
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_06.jpg"
                        alt="모던한 거실 공간에 공기청정기가 놓여 있습니다. 원형 디스플레이와 세로 결 무늬가 돋보이는 본체 디자인이 세련된 분위기를 더하며, 옆에는 회색 소파와 원형 테이블이 어우러져 편안한 공간감을 연출합니다. 전면 유리창 너머로는 탁 트인 뷰가 펼쳐져 조화로운 인테리어를 완성합니다."
                        class="mobile-only" />
                    </div>
                    <div class="text-wrap">
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary vertical-scroll-box" id="procuct-summary"
                        style="--col-width: 20%; --table-width: 604px">
                        <div class="sticky-product-no include-tab">
                          <div class="inner">
                            <div class="inner2">
                              <div>114㎡<span></span>AS356NSMA</div>
                              <div>114㎡<span></span>AS356NSLL</div>
                              <div>114㎡<span></span>AS356NSHH</div>
                              <div>109㎡<span></span>AS336NSLC</div>
                              <div>66㎡ <span></span>AS206NSHA</div>
                            </div>
                          </div>
                        </div>
                        <div class="summary-table">
                          <table class="no-btn">
                            <caption class="blind">
                              LG 공기청정기 AI 360 대표 모델 비교표 - 우리 집 오염도에 맞춰 청정하는 AI 360 라인업의 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              ...
                              <tr class="procuct-no">
                                <th scope="col">114㎡<span></span>AS356NSMA</th>
                                <th scope="col">114㎡<span></span>AS356NSLL</th>
                                <th scope="col">114㎡<span></span>AS356NSHH</th>
                                <th scope="col">109㎡<span></span>AS336NSLC</th>
                                <th scope="col">66㎡ <span></span>AS206NSHA</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_22.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSMA)의 디스플레이가 올라온 상태"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_38.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSMA)의 디스플레이가 내려간 상태" class="side" />
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_23.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSLL)의 디스플레이가 올라온 상태"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_39.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSLL)의 디스플레이가 내려간 상태" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_24.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSHH)의 디스플레이가 올라온 상태"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_40.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS356NSHH)의 디스플레이가 내려간 상태" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_25.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS336NSLC)의 디스플레이가 올라온 상태"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_41.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS336NSLC)의 디스플레이가 내려간 상태" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_54.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS206NSHA)의 디스플레이가 올라온 상태"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_55.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기(AS206NSHA)의 디스플레이가 내려간 상태" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_2step.svg"
                                      alt="2단 / 듀얼, 싱글청정" />
                                  </div>
                                  <p>
                                    2단 / 듀얼, 싱글청정
                                ...
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_1step.svg"
                                      alt="1단 / 싱글청정" />
                                  </div>
                                  <p>
                                    1단 / 싱글청정
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_AIsensor.svg"
                                      alt="AI 공기질 센서" />
                                  </div>
                                  <p>
                                    AI 공기질 센서
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_AIcontrol.svg"
                                      alt="AI 맞춤운전" />
                                  </div>
                                  <p>
                                    AI 맞춤운전
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_UVair.svg"
                                      alt="UV 공기살균" />
                                  </div>
                                  <p>
                                    UV 공기살균
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_M7.svg" alt="M7 필터" />
                                  </div>
                                  <p>
                                    M7 필터
                                    <span class="des">
                                ...
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_M5.svg" alt="M5 필터" />
                                  </div>
                                  <p>
                                    M5 필터
                                    <span class="des">
                              ...
                              <tr class="procuct-spec last gray">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ico48_04_light.svg"
                                      alt="중앙청정표시등" />
                                  </div>
                                  <p>
                                    중앙청정표시등
                  ...
                  <div id="product-type-2" name="product-type" style="display: none">
                    ...
                    ">
                      ...
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_13.jpg"
                        ...
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_07.jpg"
                        alt="따뜻한 톤의 거실 공간에 공기청정기가 배치되어 있습니다. 화이트 컬러와 미세한 패턴이 조화를 이루는 본체 디자인이 모던한 분위기를 연출하며, 옆에는 베이지 톤의 소파와 라운드 테이블, 러그가 어우러져 아늑하고 편안한 공간감을 자아냅니다."
                        class="mobile-only" />
                    </div>
                    <div class="text-wrap">
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary" id="procuct-summary2" style="--col-width: 25%; --table-width: 604px">
                        <div class="sticky-product-no include-tab">
                          <div class="inner">
                            <div class="inner2">
                        ...
                        <div class="summary-table">
                          <table class="no-btn">
                            <caption class="blind">
                              LG 공기청정기 360 플러스 대표 모델 비교표 - 넓은 공간을 360도로 청정하는 360 플러스 라인업의 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              <tr class="procuct-name">
                              ...
                              <tr class="procuct-no">
                                <th scope="col">100㎡<span></span>AS305DWWL</th>
                                <th scope="col">97㎡<span></span>AS285DWWD</th>
                                <th scope="col">61.2㎡<span></span>AS195DWWA</th>
                                <th scope="col">59.4㎡<span></span>AS185DWWD</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_26.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS305DWWL.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_42.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS305DWWL.AKOR) 메인이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_27.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS285DWWD.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_43.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS285DWWD.AKOR) 메인이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_28.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS195DWWA.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_44.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS195DWWA.AKOR) 메인이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_29.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS185DWWD.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_45.png"
                                      alt="공기청정기 LG 퓨리케어 AI 360˚ 공기청정기 플러스 (AS185DWWD.AKOR) 메인이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_booster.svg"
                                      alt="클린부스터" />
                                  </div>
                                  <p>
                                    클린부스터
                              ...
                              <tr class="procuct-spec last gray">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_V.svg" alt="V 필터" />
                                  </div>
                                  <p>
                                    V 필터
                                    <span class="des">
                  ...
                  <div id="product-type-3" name="product-type" style="display: none">
                    ...
                    ">
                      ...
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_14.jpg"
                        ...
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_08.jpg"
                        alt="깔끔하고 따뜻한 분위기의 실내 공간에 화이트 컬러의 원형 공기청정기가 놓여 있습니다. 미니멀한 디자인이 인테리어에 자연스럽게 어우러지며, 옆의 메탈 프레임 수납장과 조화를 이루어 모던한 감성을 더합니다. 창문을 통해 들어오는 자연광이 공간을 부드럽게 밝혀 쾌적하고 정돈된 분위기를 연출합니다."
                        class="mobile-only" />
                    </div>
                    <div class="text-wrap">
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary" id="procuct-summary3"
                        ...
                        <div class="summary-table">
                          <table class="no-btn">
                            <caption class="blind">
                              LG 공기청정기 360 Hit 대표 모델 비교표 - 슬림한 디자인의 360 Hit 라인업 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              <tr class="procuct-name">
                                <th scope="colgroup" colspan="4">
                              ...
                              <tr class="procuct-no">
                                <th scope="col">62㎡<span></span>AS183HWFS</th>
                                <th scope="col">50㎡<span></span>as153hwwc</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_30.png"
                                      alt="공기청정기 LG 퓨리케어 360˚ 공기청정기 Hit  (AS183HWFS.AKOR1) 썸네일이미지 4" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_46.png"
                                      alt="공기청정기 LG 퓨리케어 360˚ 공기청정기 Hit (AS183HWWA.AKOR1) 줌이미지 5" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_31.png"
                                      alt="공기청정기 LG 퓨리케어 360˚ 공기청정기 Hit (AS153HWWC.AKOR1) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_47.png"
                                      alt="공기청정기 LG 퓨리케어 360˚ 공기청정기 Hit (AS153HWWC.AKOR1) 줌이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_360clean.svg"
                                      alt="360° 청정" />
                                  </div>
                                  <p>
                                    360° 청정
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_slim.svg" alt="슬림 디자인" />
                                  </div>
                                  <p>
                                    슬림 디자인
                                    <span class="des">
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_display.svg"
                                      alt="공기청정 디스플레이" />
                                  </div>
                                  <p>
                                    공기청정 디스플레이
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_PM1.0.svg"
                                      alt="PM 1.0 센서" />
                                  </div>
                                  <p>
                                    PM 1.0 센서
                  ...
                  <div id="product-type-4" name="product-type" style="display: none">
                    ...
                    ">
                      ...
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_15.jpg"
                        ...
                        class="pc-only" />
                      <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_09.jpg"
                        alt="실내 거실 공간에 원형 러그 위에 LG 퓨리케어 오브제컬렉션 에어로타워 Hit 제품이 배치되어 있습니다.공기청정기는 하단은 회색 세로 줄무늬, 상단은 아이보리색의 긴 타워형이며, 옆에 놓인 1인용 소파는 아이보리색의 둥근 형태입니다. 배경에는 나무 캐비닛과 화병이 있고, 창문을 통해 녹색 외부 풍경이 보입니다."
                        class="mobile-only" />
                    </div>
                    <div class="text-wrap">
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary" id="procuct-summary4"
                        style="--col-width: 50%; --max-table-width: 920px">
                        <div class="sticky-product-no include-tab">
                          <div class="inner">
                            <div class="inner2">
                        ...
                        <div class="summary-table">
                          <table class="no-btn">
                            <caption class="blind">
                              LG 에어로타워 대표 모델 비교표 - 사계절 맞춤 온도의 청정 바람을 제공하는 에어로타워 라인업 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              <tr class="procuct-name">
                              ...
                              <tr class="procuct-no">
                                <th scope="col">18.4㎡<span></span>fs065pska</th>
                                <th scope="col">18.4㎡<span></span>fs065psjc</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_32.png"
                                      alt="공기청정기 LG 퓨리케어 오브제컬렉션 에어로타워 Hit (온풍 겸용) (FS065PSKA.AKOR) 줌이미지 3"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_48.png"
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_33.png"
                                      alt="공기청정기 LG 퓨리케어 오브제컬렉션 에어로타워 Hit (온풍 겸용) (FS065PSJC.AKOR) 줌이미지 3"
                                      class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_49.png"
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_warm.svg" alt="따뜻한 온풍" />
                                  </div>
                                  <p>
                                    따뜻한 온풍
                                    <span class="des">
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_focus.svg"
                                      alt="따뜻한 온풍" />
                                  </div>
                                  <p>
                                    집중청정 선풍
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_UVfan.svg"
                                      alt="UV 팬살균" />
                                  </div>
                                  <p>
                                    UV 팬살균
                              ...
                              <tr class="procuct-spec last">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_02_quiet.svg" alt="저소음" />
                                  </div>
                                  <p>
                                    저소음
                                    <span class="des">
                  ...
                  <div id="product-type-5" name="product-type" style="display: none">
                    <div class="product-slider autoplay-slider-wrap">
                      <div class="slider">
                        ...
                        ">
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_16.jpg"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_10.jpg"
                            alt="밝은 색상의 거실 배경에 흰색 1인 쇼파와 LG 퓨리케어 AI 오브제컬렉션 에어로퍼니처 제품이 배치되어 있습니다. 공기청정기는 테이블 형태의 흰색 디자인이며 바닥에 놓여져 있습니다. 뒤쪽에는 흰색 캐비닛이 위치해 있습니다."
                            class="mobile-only" />
                        </div>
                        <div class="img-wrap">
                        ...
                        ">
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_17.jpg"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_11.jpg"
                            alt="넓은 창으로 햇살이 들어오는 밝은 거실에 캣타워형 공기청정기가 놓여 있으며, 상단 쿠션 베드에는 고양이가 편안하게 누워 있습니다. 곁에는 고양이 점프용 스텝이 함께 배치되어 있어 반려동물의 휴식과 이동을 돕습니다. 전체적으로 따뜻하고 아늑한 분위기가 느껴지는 공간입니다."
                            class="mobile-only" />
                        </div>
                        <!-- <div class="img-wrap">
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary" id="procuct-summary5"
                        style="--col-width: 50%; --max-table-width: 920px">
                        <div class="sticky-product-no include-tab">
                          <div class="inner">
                            <div class="inner2">
                        ...
                        <div class="summary-table">
                          <table class="no-btn">
                            <caption class="blind">
                              LG 에어로시리즈 대표 모델 비교표 - 라이프스타일에 맞춰 사용할 수 있는 에어로시리즈 라인업 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              <tr class="procuct-name">
                                <th scope="colgroup" colspan="2">
                              ...
                              <tr class="procuct-no">
                                <th scope="col">19.8㎡<span></span>에어로퍼니처</th>
                                <th scope="col">19.8㎡<span></span>에어로캣타워</th>
                                <!-- <th scope="col">19.8㎡<span></span>에어로스피커</th> -->
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_34.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 에어로퍼니처 (AS065PWHA.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_50.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 에어로퍼니처 (AS065PWHA.AKOR) 줌이미지 4" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                                ...
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_35.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 에어로캣타워 (AS065CWHA.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_51.png"
                                      alt="공기청정기 LG 퓨리케어 AI 오브제컬렉션 에어로캣타워 (AS065CWHA.AKOR) 줌이미지 5" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_table.svg" alt="테이블형" />
                                  </div>
                                  <p>
                                    테이블형
                                    <span class="des">
                                ...
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_cattree.svg"
                                      alt="캣타워형" />
                                  </div>
                                  <p>
                                    캣타워형
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_convenience.svg"
                                      alt="편의 기능" />
                                  </div>
                                  <p>
                                    편의 기능
                              ...
                              <tr class="procuct-spec last">
                                ...
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_Vpet.svg" alt="V 펫필터" />
                                  </div>
                                  <p>
                                    V 펫필터
                                    <span class="des">
                  ...
                  <div id="product-type-6" name="product-type" style="display: none">
                    <div class="product-slider autoplay-slider-wrap">
                      <div class="slider">
                        ...
                        ">
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_19.jpg"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_13.jpg"
                            alt="침실 환경에서 원통형 디자인의 LG 퓨리케어 오브제컬렉션 에어로부스터가 보입니다. 상단에는 원반형 디스플레이가 있고, 하단은 회색 세로 줄무늬가 있는 디자인입니다. 옆에는 흰색 침대가 놓여 있으며 뒤쪽 배경에는 질감 있는 흰색 벽면이 보입니다."
                            class="mobile-only" />
                        </div>
                        <div class="img-wrap">
                        ...
                        ">
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_20.jpg"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_14.jpg"
                            alt="어린이 방에 LG 퓨리케어 오브제컬렉션 에어로부스터가 놓여있습니다. 방 안에는 나무 프레임으로 된 침대, 나무 흔들 목마, 라탄 바구니, 별 모양 쿠션 등이 놓여져 있습니다. 공기청정기는 흰색과 회색으로 이루어져 있으며, 윗부분 원형 디스플레이에 파란색 빛이 들어와 있습니다. 바닥에는 옅은 분홍색 러그가 깔려 있습니다."
                            class="mobile-only" />
                        </div>
                        <div class="img-wrap">
                        ...
                        ">
                          ...
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_21.jpg"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_001_15.jpg"
                            alt="채광이 좋은 실내에 LG 퓨리케어 오브제컬렉션 에어로부스터가 놓여있습니다. 옆에는 식탁, 의자가 배치되어 있습니다. 공기 청정기는 원통형 몸체와 파란색 링 조명이 있는 원형 디스플레이로 구성되어 있으며, 식탁은 원형 상판과 기둥 모양 다리를 가지고 있고, 의자는 패브릭 소재의 등받이와 나무 다리를 가지고 있습니다."
                            class="mobile-only" />
                        </div>
                      </div>
                    ...
                    <div class="compare-wrap">
                      ...
                      <div class="procuct-summary" id="procuct-summary6" style="--max-table-width: 620px">
                        <div class="sticky-product-no include-tab">
                          <div class="inner">
                            <div class="inner2">
                        ...
                        <div class="summary-table">
                          <table class="no-btn single">
                            <caption class="blind">
                              LG 에어로부스터 대표 모델 비교표 - 상하단 청정바람과 슬림 디자인을 갖춘 에어로부스터의 주요 특징을 확인할 수 있습니다.
                            </caption>
                            <thead>
                              <tr class="procuct-name">
                                <th scope="col">
                              ...
                              <tr class="procuct-no">
                                <th scope="col">48.2㎡<span></span>AS155GWDL</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="procuct-img-wrap">
                                <td>
                                  <div class="procuct-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_37.png"
                                      alt="공기청정기 LG 퓨리케어 오브제컬렉션 에어로부스터 (AS155GWDL.AKOR) 줌이미지 3" class="front" />
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_001_53.png"
                                      alt="공기청정기 LG 퓨리케어 오브제컬렉션 에어로부스터 (AS155GWDL.AKOR) 줌이미지 6" class="side" />
                                    <button class="btn-angle" name="btn-angle">
                                      다른 각도 보기
                                    </button>
                                  </div>
                              ...
                              <tr class="procuct-spec">
                                <td>
                                  <div class="spec-img">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/ic48_04_dual.svg"
                                      alt="상하단 멀티 청정" />
                                  </div>
                                  <p>
                                    상하단 멀티 청정
              ...
              <section id="buying-point" name="buying-guide-content" style="display: none">
                ...
                <div class="tab-content">
                  <div id="buying-point-1" name="buying-point">
                      ...
                      <div class="subtab-content">
                        ...
                        <div class="point-wrap" id="buying-point-1-2" name="buying-point-1" style="display: none">
                          ...
                          <div class="content">
                            <h5>51㎡~82㎡</h5>
                            <p>
                              거실이나 주방처럼 가족이 자주 머무는 공간을 쾌적하게 관리하고 싶다면 AI 360° 타입 1단과 360° Hit 타입을 추천합니다. 방보다 넓은 공간에서도
                              효율적으로 공기를 청정해 쾌적하게 유지하고 거실 중심의 라이프스타일에도 한 대로 간편하게 공기질을 관리해 깨끗하고 편안한 공간을 누릴 수 있습니다.
                            </p>
                            <div class="btn-wrap">
                              <a class="btn-product"
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <div class="point-slider2 autoplay-slider-wrap">
                                <div class="slider">
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_03.jpg"
                                  ...
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_03a.jpg"
                                      alt="따뜻한 자연광이 드는 거실에 LG 퓨리케어 오브제컬렉션 에어로타워가 세워져 있으며, 소파와 테이블, 식물 등이 조화롭게 배치된 공간 속에서 부드러운 바람 흐름이 시각적으로 표현되어 쾌적한 실내 분위기를 보여줍니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_03b.jpg"
                        ...
                        <div class="point-wrap" id="buying-point-1-4" name="buying-point-1" style="display: none">
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_04.jpg"
                    ...
                    <div class="point-tip">
                      ...
                      <div class="tip-content">
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_05.gif"
                            ...
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_05.gif"
                            alt="청정 면적이 넓은 거실과 청정 면적이 좁은 방에 맞는 공기청정기 추천을 보여주는 이미지. 66~95㎡ 크기의 거실에는 360° 1단 제품을, 99~129㎡ 크기의 거실에는 360° 2단 제품을 추천하는 내용을 포함하며 9.8㎡ 크기의 방에서는 '에어로시리즈' 제품이 적합하다는 내용이 포함."
                            class="mobile-only" />
                        </div>
                      </div>
                  ...
                  <div id="buying-point-2" name="buying-point" style="display: none">
                      ...
                      <div class="subtab-content">
                        <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_06.jpg"
                                alt="LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기의 디스플레이가 확대되어 있는 모습입니다. 미세먼지 매우 나쁨, 가스 보통, 냄새 약함, 공기살균 켜짐 등의 상태가 표시되어 있으며, 주변에는 운전모드, 청정세기, 부스터제어, 설정 아이콘 등이 보입니다." />
                            </div>
                            <button class="btn-collapse-toggle">
                              <span>* AI 공기질 센서 / AI+ 인증 / AI 공기질 센서 /
                                ThinQ 앱</span>
                            </button>
                            <div class="collapse-content">
                              <p>
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <div class="point-slider2 autoplay-slider-wrap">
                                <div class="slider">
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_07.jpg"
                                      alt="실내 공간에 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기가 놓여 있으며, 화분과 소파가 보입니다. 박스 안에 좋음이라는 큰 글자와 함께 공기청정기의 작동 상태를 설명하는 그래픽과 텍스트가 있습니다. 좋음 상태에서는 상/하단 클린부스터 바람을 '약'으로 운전합니다.라는 설명이 포함되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_07a.jpg"
                                      alt="거실에 공기청정기가 놓여 있으며, 소파와 두 마리의 고양이가 캣타워에 앉아 있는 모습이 보입니다. 박스 안에 보통이라는 큰 글자와 함께 공기청정기의 작동 상태를 설명하는 그래픽과 텍스트가 있습니다. 보통 상태에서는 상/하단 클린부스터 바람을 '중'으로 운전합니다.라는 설명이 포함되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_07b.jpg"
                                      alt="창밖으로 도시의 전경이 보이는 거실 공간에 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기가 놓여 있으며, 소파, 쿠션, 테이블이 보입니다. 박스 안에 나쁨이라는 큰 글자와 함께 공기청정기의 작동 상태를 설명하는 그래픽과 텍스트가 있습니다. 나쁨 상태에서는 상단 클린부스터가 일어나고 바람을 '중'으로 운전합니다.라는 설명이 포함되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_07c.jpg"
                                      alt="주방 공간에 공기청정기가 놓여 있으며, 인덕션 위에 연기가 나고 있는 팬이 보입니다. 박스 안에 매우 나쁨이라는 큰 글자와 함께 공기청정기의 작동 상태를 설명하는 그래픽과 텍스트가 있습니다. 매우 나쁨 상태에서는 상단 클린부스터가 일어나고 상/하단 클린부스터 모두 회전하며 바람을 '강'으로 운전합니다.라는 설명이 포함되어 있습니다." />
                                  </div>
                                </div>
                                <div class="slider-controls">
                                  <button class="btn-play" data-state="playing">
                        ...
                        <div class="point-wrap" id="buying-point-2-3" name="buying-point-2" style="display: none">
                          ...
                          <div class="content">
                            ...
                            <button class="btn-collapse-toggle">
                              <span>* UV 공기살균 / 부유세균 99.9% 제거 / PA 인증
                                UV살균 공기청정기</span>
                            </button>
                            <div class="collapse-content">
                              <p>
                                ...
                                <div class="slider">
                                  <div>
                                    <video playsinline loop muted
                                      src="/kr/story/buying-guide/2025/video/purifier/vid_P04_001_02.mp4"></video>
                                  </div>
                                  <div>
                                    <video playsinline loop muted
                                      src="/kr/story/buying-guide/2025/video/purifier/vid_P04_001_03.mp4"></video>
                                  </div>
                                </div>
                                <div class="slider-controls">
                                  <button class="btn-play" data-state="playing">
                    ...
                    <div class="point-tip">
                      ...
                      <div class="tip-content">
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_10.jpg"
                            alt="거실 공간에 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기가 놓여 있습니다. 양쪽에 베이지색 소파가 있으며, 쿠션과 담요가 놓여 있습니다. 유리 상판의 원형 테이블이 있고 그림과 검은색 스탠드 조명이 보입니다."
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_02.jpg"
                            alt="거실 공간에 LG 퓨리케어 AI 오브제컬렉션 360˚ 공기청정기가 놓여 있습니다. 양쪽에 베이지색 소파가 있으며, 쿠션과 담요가 놓여 있습니다. 유리 상판의 원형 테이블이 있고 그림과 검은색 스탠드 조명이 보입니다."
                            class="mobile-only" />
                        </div>
                      </div>
                      ...
                      <div class="subtab-content">
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_11.jpg"
                                alt="25년 노벨화학상 핵심물질 MOF 적용이라는 텍스트가 원형 확대창 안에 표시되어 있는 녹색 필터의 모습입니다." />
                            </div>
                            <button class="btn-collapse-toggle">
                              <span>* 0.01 ㎛ 극초미세먼지 99.999% 제거 / 유해가스 제거
                                / M 필터 탈취 성능 강화</span>
                            </button>
                            <div class="collapse-content">
                              <p>
                        ...
                        <div class="point-wrap" id="buying-point-3-2" name="buying-point-3" style="display: none">
                          ...
                          <div class="content">
                            ...
                            <button class="btn-collapse-toggle">
                              <span>* 0.01 ㎛ 극초미세먼지 99.999% 제거 / G 필터
                            ...
                            <div class="collapse-content">
                              ...
                              <p>
                                <b>[G 필터 유해가스 누적 제거량 시험 2.5배 증가]</b><br />
                                * 시험일시 : '22.10 ~ '22.11<br />
                                * 시험기관 : 글로벌 시험인증기관 TUV 라인란드<br />
                      ...
                      <div class="tip-content">
                        ...
                        <div class="img">
                          <div class="point-slider autoplay-slider-wrap">
                            <div class="slider">
                              <div>
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_14.jpg"
                                  ...
                                  class="pc-only" />
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_03.jpg"
                                  alt='고양이와 함께 ‘펫 특화필터’를 강조한 장면으로, 반려동물을 키우는 환경에서도 쾌적한 실내 공기를 유지할 수 있도록 설계된 공기청정기의 기능을 보여줍니다. 상단에는 펫 전용 필터 이미지와 함께 "펫 특화필터"라는 문구가 삽입되어 있어, 털, 냄새, 알레르기 유발 물질 등을 효과적으로 제거하는 기능에 중점을 두고 있음을 시각적으로 전달합니다.'
                                  class="mobile-only" />
                              </div>
                              <div>
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_14a.jpg"
                                  ...
                                  class="pc-only" />
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_03a.jpg"
                                  alt='‘새집 특화필터’를 강조한 장면으로, 입주 초기 발생할 수 있는 새집 증후군 유발 물질을 효과적으로 제거하는 공기청정기의 기능을 부각하고 있습니다. 상단에는 필터 이미지와 함께 "새집 특화필터"라는 문구가 삽입되어 있고, 배경에는 이사 온 듯한 박스와 소품들이 배치되어 있어 새집 환경에서의 사용 상황을 직관적으로 표현하고 있습니다.'
                                  class="mobile-only" />
                              </div>
                              <div>
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_14b.jpg"
                                  ...
                                  class="pc-only" />
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_03b.jpg"
                                  alt='‘매연 특화필터’를 강조한 장면으로, 대도시의 빽빽한 건물들과 뿌연 스모그가 낀 하늘을 배경으로 하여 교통량이 많은 도심에서 발생하는 유해 배기가스 및 미세먼지를 효과적으로 차단하는 필터의 성능을 시각적으로 표현하고 있습니다. 상단에는 필터 이미지와 함께 "매연 특화필터"라는 문구가 삽입되어 있어, 도심 환경에 적합한 공기청정기 필터임을 강조합니다.'
                                  class="mobile-only" />
                              </div>
                              <div>
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_14c.jpg"
                                  ...
                                  class="pc-only" />
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_03c.jpg"
                                  alt='‘유증기 특화필터’를 강조한 장면으로, 고급스러운 주방 공간에서 요리 중인 프라이팬과 함께 아침 식사 테이블이 연출되어 있습니다. 이는 조리 시 발생하는 기름 연기나 음식 냄새 등 유증기를 효과적으로 제거하는 필터의 기능을 시각적으로 표현한 것으로, 쾌적한 주방 환경을 유지할 수 있음을 강조합니다. 상단에는 필터 이미지와 함께 "유증기 특화필터"라는 문구가 삽입되어 있어, 요리를 자주 하는 사용자에게 적합한 공기청정기 솔루션임을 전달합니다.'
                                  class="mobile-only" />
                              </div>
                              <div>
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_14d.jpg"
                                  ...
                                  class="pc-only" />
                                <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_03d.jpg"
                                  alt='‘알레르겐 특화필터’를 강조한 장면으로, 날리는 민들레 씨앗이 클로즈업된 배경을 통해 꽃가루와 같은 알레르기 유발 물질을 시각적으로 표현하고 있습니다. 상단에는 필터 이미지와 함께 "알레르겐 특화필터"라는 문구가 삽입되어 있어, 알레르기 유발 물질에 민감한 사용자에게 적합한 제품임을 전달합니다.'
                                  class="mobile-only" />
                              </div>
                            </div>
                  ...
                  <div id="buying-point-4" name="buying-point" style="display: none">
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <div class="point-slider2 autoplay-slider-wrap">
                                <div class="slider">
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_16.jpg"
                                      alt="공기청정기 내부의 팬을 분리하는 장면을 보여주며, 유지 보수나 청소 과정의 용이함을 시각적으로 전달하고 있습니다. 상단 커버를 연 뒤 내부 팬을 손쉽게 탈착할 수 있는 구조를 강조하여 사용자 편의성을 부각합니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_16a.jpg"
                    ...
                    <div class="point-tip">
                      ...
                      <div class="tip-content">
                        ...
                        <div class="img">
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_17.jpg"
                            alt="공기청정기 케어 서비스로 전문가가 직접 방문해 제품을 분해하고, 내부 팬부터 필터까지 세척 및 점검해주며 세심하게 관리해주는 모습입니다."
                            class="pc-only" />
                          <img src="/kr/story/buying-guide/2025/img/purifier/img_M04_101_04.jpg"
                            alt="공기청정기 케어 서비스로 전문가가 직접 방문해 제품을 분해하고, 내부 팬부터 필터까지 세척 및 점검해주며 세심하게 관리해주는 모습입니다."
                            class="mobile-only" />
                        </div>
                      </div>
                  ...
                  <div class="point-box">
                    ...
                    <div class="tab-wrap">
                      <button class="active" name="buying-guide-tab" data-target="#buying-point-5"
                        data-group="buying-point-56">
                        CA/BAF 인증
                      </button>
                      <button name="buying-guide-tab" data-target="#buying-point-6" data-group="buying-point-56">
                        편의 기능
                      </button>
                    </div>
                    <div class="tab-content">
                              ...
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_18.jpg"
                      ...
                      <div id="buying-point-6" name="buying-point-56" style="display: none">
                        <div class="slideWrap colWrap" style="--box-height: 556px; --box-m-height: 408px">
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                <div>
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_19.jpg"
                                ...
                                <div>
                                  <div class="media-wrap">
                                    ...
                                    <video autoplay playsinline loop muted
                                      src="/kr/story/buying-guide/2025/video/purifier/vid_P04_001_01.mp4"></video>
                                  </div>
                                </div>
                              </div>
                              <div class="detail-wrap">
                          ...
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_20.jpg"
                          ...
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_21.jpg"
                          ...
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_22.jpg"
                          ...
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_23.jpg"
                          ...
                          <div class="col">
                            <div>
                              <div class="content-wrap">
                                ...
                                <div>
                                  <div class="media-wrap">
                                    <img src="/kr/story/buying-guide/2025/img/purifier/img_P04_101_24.gif" alt='흰색 배경에 공기 청정기가 음성으로 현재
                ...
                <div class="unit-box">
                  <ul class="bullet-list">
                    <span style="color: #333333">* 제품 이미지 및 특장점 등에는 광고적 표현이 포함되어 실제
                      ...
                      위해 사전 예고 없이 변경될 수 있습니다.</span><br /><span style="color: #333333">* 모든 제품 이미지는 촬영 컷으로 실제 제품과 차이가 있을
                      수
                      있으며, 제품 색상은 모니터 해상도, 밝기 설정 및 컴퓨터 사양에
                      따라 차이가 있을 수 있습니다.</span><br /><span style="color: #333333">* 해당 제품의 성능은 사용 환경에 따라 일부 상이할 수 있으며,
                      매장 별로 취급여부가 다를 수 있습니다.</span><br /><span style="color: #333333">* 상세 제품 이미지는 이해를 돕기 위한 이미지로 실제품
                      컬러와
