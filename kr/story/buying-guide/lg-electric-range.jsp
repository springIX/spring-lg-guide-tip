      ...
      <body>
        ...
        <div class="buying-guide" id="content">
          <div class="top-banner autoplay-slider-wrap">
            ...
            <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_01.jpg"
              alt="밝은 대리석 무늬의 조리대 위에 화이트 색상의 인덕션이 매립형으로 깔끔하게 설치되어 있습니다. 주변에는 싱크대와 골드 톤의 수전, 작은 그릇과 조미료 용기가 놓여 있어 밝고 모던한 주방 분위기를 완성합니다."
              class="pc-only" />
            <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_001_01.jpg"
              alt="밝은 대리석 무늬의 조리대 위에 화이트 색상의 인덕션이 매립형으로 깔끔하게 설치되어 있습니다. 주변에는 싱크대와 골드 톤의 수전, 작은 그릇과 조미료 용기가 놓여 있어 밝고 모던한 주방 분위기를 완성합니다."
              class="mobile-only" />
            <p class="note">
          ...
          <div class="guide-wrap inner-wrap">
            <section id="line-up" name="buying-guide-content">
              ...
              <div class="tab-wrap sticky" style="--btn-width: 275px; --btn-m-width: 224px">
              ...
              <button class="nav nav-right">></button> -->
                <div class="vertical-scroll-box">
                  <button class="tab-img active" name="buying-guide-tab" data-target="#product-type-1"
                    ...
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_02.png"
                  ...
                  <button class="tab-img" name="buying-guide-tab" data-target="#product-type-2"
                    data-group="product-type">
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_03.png"
                ...
                <div id="product-type-1" name="product-type">
                  <div class="img-wrap">
                    ...
                    ">
                      ...
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000077" target="_blank">LG
                          디오스 인덕션</a>
                        <p>미라듀어 글라스</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_04.jpg"
                      alt="밝은 돌 질감의 조리대 위에 블랙 글라스 상판의 인덕션이 매립형으로 설치되어 있습니다. 주변에는 우드 바닥과 투명 볼에 담긴 달걀 등이 함께 보여 전체적으로 모던하고 따뜻한 주방 분위기를 연출합니다."
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_001_02.jpg"
                      alt="밝은 돌 질감의 조리대 위에 블랙 글라스 상판의 인덕션이 매립형으로 설치되어 있습니다. 주변에는 우드 바닥과 투명 볼에 담긴 달걀 등이 함께 보여 전체적으로 모던하고 따뜻한 주방 분위기를 연출합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                  ...
                  <div class="compare-wrap">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_06.png"
                                    alt="전기레인지 LG 디오스 인덕션 (BEF3AMB4E.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_10.png"
                                    alt="전기레인지 LG 디오스 인덕션 (BEF3AMB4E.AKOR) 메인이미지 3" class="side" />
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_07.png"
                                    alt="전기레인지 LG 디오스 오브제컬렉션 인덕션 (BEI3ANHLE.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_11.png"
                                    alt="전기레인지 LG 디오스 오브제컬렉션 인덕션 (BEI3ANHLE.AKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                              ...
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_08.png"
                                    alt="전기레인지 LG 디오스 포터블 인덕션 (HEI1V9E.CKOR) 메인이미지 3" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_12.png"
                                    alt="전기레인지 LG 디오스 포터블 인덕션 (HEI1V9E.CKOR) 메인이미지 5" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_miradur.svg"
                                    alt="미라듀어 글라스" />
                                </div>
                                <p>
                                  미라듀어 글라스
                                  <span class="des">
                                    ...
                                    <span class="bubble">긁힘에 강해 스크래치가 적어 깨끗하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_objetwhite.svg"
                                    alt="오브제 화이트" />
                                </div>
                                <p>
                                  오브제 화이트
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">600℃ 내열성으로 강화유리보다 강하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_ceramic.svg"
                                    alt="세라믹 글라스" />
                                </div>
                                <p>
                                  세라믹 글라스
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_quadinverter.png"
                                    alt="쿼드 인버터" />
                                </div>
                                <p>
                                  쿼드 인버터
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">4개의 인버터가 화력을 세밀하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                              ...
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_dualinverter.png"
                                    alt="듀얼 인버터" />
                                </div>
                                <p>
                                  듀얼 인버터
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">열 손실은 줄이고 에너지는 효율적이게
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_autopot.svg"
                                    alt="자동용기감지" />
                                </div>
                                <p>
                                  자동용기감지
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">화구 선택 필요 없이 자동으로 감지해
                                      편리하게
                                    </span>
                                  </span>
                                </p>
                              ...
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_powerindicator.svg"
                                    alt="화력 인디케이터" />
                                </div>
                                <p>
                                  화력 인디케이터
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">인디케이터 램프 길이로 화력 상태를 한눈에
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_boilalert.svg"
                                    alt="끓음 알림" />
                                </div>
                                <p>
                                  끓음 알림
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">AI가 화력을 스스로 조절해 편리하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_wide.svg"
                                    alt="미라듀어 글라스" />
                                </div>
                                <p>
                                  와이드존
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">넓은 공간으로 다양한 요리를 동시에 완성하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_customfit.svg"
                                    alt="맞춤설치" />
                                </div>
                                <p>
                                  맞춤설치
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">주방 환경에 맞게 설치 타입을 선택하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                              ...
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_slim.svg"
                                    alt="맞춤설치" />
                                </div>
                                <p>
                                  초슬림 디자인
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">4cm의 높이로 보관이 용이하게
                                    </span>
                                  </span>
                                </p>
                              </td>
                            ...
                            <tr class="product-btn">
                              <td>
                                <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000077&filterProduct=AT0000000164:KY0000004222:01"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000077&filterProduct=AT0000000164:KY0000001050:01"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                              <td>
                                <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000077&filterProduct=AT0000000164:KY0000001045:01"
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <div class="product-table">
                      ...
                      <div class="table-wrap include-tab vertical-scroll-box">
                        <table>
                          <caption class="blind">
                            LG 전기레인지 모델 라인업 스펙 비교표 - 미라듀어, 매트라인, 모노라인 글라스, 오브제 화이트, 블랙 세라믹 라인업의 화구, 조작, 편의 기능과 제품 링크 정보를
                            비교합니다.
                          </caption>
                          <colgroup>
                            <col class="col1" />
                          ...
                          <thead>
                            ...
                            <tr>
                              <td colspan="2">
                                <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_14.png"
                                  alt="전기레인지 LG 디오스 인덕션 (BEF3AMB4E.AKOR) 메인이미지 2" />
                              </td>
                              <td colspan="2">
                                <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_15.png"
                                  alt="전기레인지 LG 디오스 인덕션  (BEF3ASMLE.AKOR) 메인이미지 2" />
                              </td>
                              <td colspan="2">
                                <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_20.png"
                                  alt="전기레인지 LG 디오스 인덕션 (BEI3ABWLE.AKOR) 메인이미지" />
                              </td>
                              <td colspan="2">
                                <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_16.png"
                                  alt="전기레인지 LG 디오스 오브제컬렉션 인덕션 (BEI3ANHLE.AKOR) 메인이미지 2" />
                              </td>
                              <td colspan="2">
                                <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_17.png"
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td colspan="2">BE*3*<span class="red">N</span>**** / BE*3*<span class="red">K</span>****
                              </td>
                              <td colspan="2">
                                BE*3<span class="red">SB</span>*** / BE*3*<span class="red">EB</span>*** / BE*3*<span
                                  class="red">RB</span>**
                              </td>
                            </tr>
                            <tr>
                ...
                <div id="product-type-2" name="product-type" style="display: none">
                  <div class="img-wrap">
                    ...
                    ">
                      <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                      <div class="bubble">
                        <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000078" target="_blank">LG
                          디오스 하이브리드</a>
                        <p>미라듀어 글라스</p>
                      </div>
                    </div>
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_05.jpg"
                      ...
                      class="pc-only" />
                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_001_03.jpg"
                      alt="짙은 회색 조리대 위에 블랙 색상의 인덕션이 매립형으로 설치되어 있으며, 상판에는 원형·십자 형태의 조리 구역과 전원, 화력 조절, 타이머 등의 터치 아이콘이 붉은 색상으로 선명하게 표시되어 있습니다. 배경은 흐릿하게 보이는 밝은 외부 풍경으로 전체적으로 깔끔하고 모던한 주방 분위기를 연출합니다."
                      class="mobile-only" />
                  </div>
                  <div class="text-wrap">
                  ...
                  <div class="compare-wrap">
                    ...
                    <div class="procuct-summary" id="procuct-summary2" style="--max-table-width: 620px">
                      <div class="sticky-product-no include-tab">
                        <div class="inner">
                          <div class="inner2">
                            <div>BEY3MSE</div>
                        ...
                        <table class="single">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="procuct-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_09.png"
                                    alt="전기레인지 LG 디오스 하이브리드 (BEY3MSE.AKOR) 메인이미지 2" class="front" />
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_001_13.png"
                                    alt="전기레인지 LG 디오스 하이브리드 (BEY3MSE.AKOR) 메인이미지 3" class="side" />
                                  <button class="btn-angle" name="btn-angle">
                                    다른 각도 보기
                                  </button>
                                </div>
                            ...
                            <tr class="procuct-spec">
                              <td>
                                ...
                                <p>
                                  ...
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">긁힘에 강해 스크래치가 적어
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_3booster.svg"
                                    alt="3중 고화력 부스터" />
                                </div>
                                <p>
                                  3중 고화력 부스터
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_diamond.svg"
                                    alt="다이아몬드 커팅 글라스" />
                                </div>
                                <p>
                                  다이아몬드 커팅 글라스
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">청소가 쉬운 다이아몬드 커팅 글라스로
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_safety16.svg"
                                    alt="16종 안전장치" />
                                </div>
                                <p>
                                  16종 안전장치
                                  <span class="des">
                                    <button class="info pc-only"></button>
                                    <span class="bubble">16종 안전장치 시스템으로
                            ...
                            <tr class="procuct-spec">
                              <td>
                                <div class="spec-img">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/ic48_09_onetouch.svg"
                                    alt="원터치 다이렉트 컨트롤" />
                                </div>
                                <p>
                                  원터치 다이렉트 컨트롤
                            ...
                            <tr class="product-btn">
                              <td>
                                <a href="https://www.lge.co.kr/category/electric-ranges?subCateId=CT50000078                                "
                                  target="_blank" class="btn-product">제품 보러 가기</a>
                              </td>
                            </tr>
                          </tbody>
                ...
                <div id="buying-point-1" name="buying-point">
                      ...
                      <div id="buying-point-1-1" name="buying-point-1">
                        <div class="point-wrap">
                          ...
                          <div class="content">
                            <h5>인덕션</h5>
                            <p>
                              인덕션은 자기장을 이용해 냄비나 프라이팬을 직접 가열하는 방식입니다.
                              조리 용기만 뜨거워지기 때문에 화상 위험이 적고 조리시간이 짧으며 청소가 용이합니다.
                              정교한 온도 조절이 가능해 섬세한 요리를 만들 때 유리하고, 주방 상판과 일체감 있는 세련된 디자인으로 쾌적한 조리 환경을 쉽게 유지할 수 있습니다.
                              인덕션은 가열 방식의 특성상 철, 스테인리스처럼 자성이 있는 용기만 사용할 수 있습니다.
                            </p>
                            <div class="btn-wrap">
                              <a class="btn-product"
                            ...
                            <div class="img">
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_01.jpg"
                          ...
                          <div class="content">
                            <h5>하이브리드</h5>
                            <p>
                              하이브리드는 인덕션과 하이라이트가 하나로 합쳐진 제품입니다. 빠른 가열과 높은 에너지 효율을 제공하는 인덕션과 다양한 용기를 사용할 수 있는 하이라이트의 장점을
                              모두 누릴 수 있습니다. 하이라이트는 상판을 직접 가열해 열을 전달하는 방식으로 은근한 열조리가 필요한 요리에 적합합니다.
                            </p>
                            <div class="btn-wrap">
                              <a class="btn-product"
                            ...
                            <div class="img">
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_02.jpg"
                                alt="주방에 설치된 전기레인지가 보이며, 옆에는 두 개의 장식용 화병이 놓여 있습니다." />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div id="buying-point-1-2" name="buying-point-1" style="display: none">
                        <div class="point-wrap">
                          ...
                          <div class="content">
                            ...
                            <div class="img">
                              <div class="point-slider1 autoplay-slider-wrap">
                                <div class="slider">
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_04.jpg"
                                      alt="검은색 상판의 인덕션이 밝은 주방 조리대 위에 깔끔하게 설치되어 있습니다. 상판에는 원형·십자 형태의 조리 구역 표시와 함께 전원, 화력 조절, 타이머 등의 터치 아이콘이 얇고 정교하게 배치되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_04a.jpg"
                                      alt="검은색 상판의 인덕션이 밝은 주방 조리대 위에 깔끔하게 설치되어 있습니다. 상판에는 원형·십자 형태의 조리 구역 표시와 함께 전원, 화력 조절, 타이머 등의 터치 아이콘이 얇고 정교하게 배치되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_04b.jpg"
                                      alt="검은색 상판의 인덕션이 밝은 주방 조리대 위에 깔끔하게 설치되어 있습니다. 상판에는 원형·십자 형태의 조리 구역 표시와 함께 전원, 화력 조절, 타이머 등의 터치 아이콘이 얇고 정교하게 배치되어 있습니다." />
                                  </div>
                                </div>
                          ...
                          <div class="content">
                            ...
                            <div class="btn-wrap">
                              <a class="btn-product" href="https://www.lge.co.kr/category/electric-ranges"
                                target="_blank">제품 보러 가기</a>
                            </div>
                            <div class="img">
                              <div class="point-slider2 autoplay-slider-wrap">
                                <div class="slider">
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_05.jpg"
                                      alt="은색 프레임으로 마감된 인덕션이 주방 조리대 위에 안정적으로 놓여 있으며, 상판은 검은색 글라스 소재로 원형·십자 형태의 조리 구역과 화력, 타이머, 잠금 등의 터치 아이콘이 선명하게 표시되어 있습니다." />
                                  </div>
                                  <div>
                                    <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_05a.jpg"
                                      alt="은색 프레임으로 마감된 인덕션이 주방 조리대 위에 안정적으로 놓여 있으며, 상판은 검은색 글라스 소재로 원형·십자 형태의 조리 구역과 화력, 타이머, 잠금 등의 터치 아이콘이 선명하게 표시되어 있습니다." />
                                  </div>
                                </div>
                                <div class="slider-controls">
                  ...
                  <div class="point-tip" id="point-tip1">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_03.jpg"
                          alt="넓고 평평한 인덕션 조리대 위에 스테인리스 소재의 큰 냄비가 올려져 있으며, 냄비 안의 물이 끓어 거품과 잔물결이 생긴 모습입니다."
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_01.jpg"
                          alt="넓고 평평한 인덕션 조리대 위에 스테인리스 소재의 큰 냄비가 올려져 있으며, 냄비 안의 물이 끓어 거품과 잔물결이 생긴 모습입니다."
                          class="mobile-only" />
                      </div>
                    </div>
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <div class="point-slider autoplay-slider-wrap">
                          <div class="slider">
                            <div>
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_06.jpg"
                                alt="주방에 설치된 전기레인지가 보이며, 옆에는 두 개의 장식용 화병이 놓여 있습니다." class="pc-only" />
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_02.jpg"
                                alt="주방에 설치된 전기레인지가 보이며, 옆에는 두 개의 장식용 화병이 놓여 있습니다." class="mobile-only" />
                            </div>
                            <div>
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_06a.jpg"
                                alt="주방에 설치된 전기레인지가 보이며, 옆에는 두 개의 장식용 화병이 놓여 있습니다." class="pc-only" />
                              <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_02a.jpg"
                                alt="주방에 설치된 전기레인지가 보이며, 옆에는 두 개의 장식용 화병이 놓여 있습니다." class="mobile-only" />
                            </div>
                          </div>
                          <div class="slider-controls">
                ...
                <div id="buying-point-2" name="buying-point" style="display: none">
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                        ...
                        <div class="content">
                          <h5>끓음 알림</h5>
                          <p>
                            조리 과정을 딥러닝한 온도예측 알고리즘의 AI기능과 음성안내로 다양한 국물요리를 편리하게 조리할 수 있습니다. 물부터 국, 찌개까지 설정한 용량에 맞춰 화력을
                            조절하고, 음성안내와 함께 조리 상태를 확인할 수 있습니다.
                          </p>
                          <div class="btn-wrap">
                            <a class="btn-product"
                          ...
                          <div class="img">
                            ...
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_03.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 끓음 알림 기능은 다음의 조건에서 최적으로
                              작동합니다. / 다음의 조건에서는 사용을 권장하지
                              않습니다.</span>
                          </button>
                          <div class="collapse-content">
                            <p>
                              <b>[끓음 알림 기능은 다음의 조건에서 최적으로
                                작동합니다.]</b><br />
                            ...
                            <p>
                              <b>[다음의 조건에서는 사용을 권장하지 않습니다.]</b><br />
                      ...
                      <div class="point-wrap" id="buying-point-2-2" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_04.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 대화구 터보 모드</span>
                          </button>
                          <div class="collapse-content">
                            ...
                            <p>
                              * 터보 모드는 1개 화구에서만 사용 가능하며, 터보 모드 투입 중 다른 화구 동작 시 기 설정된 터보 모드가 해제됨<br />
                              * 특정 화구에서 일반 모드(출력 레벨:1~9단) 사용 시, 나머지 화구는 터보 모드로 설정할 수 없음<br />
                              * 터보 모드는 7분 후 터보 모드 출력 레벨 9단으로 변경됨<br />
                              * 각 화구별 터보 모드 출력은 우측 대화구 3,400 W / 중, 소화구 2,200W임<br />
                              * 전체 화구는 터보 이외 1~9단 출력으로 동시 화구 사용 시 합산 3,400W 이내 출력 제어가 되며, 상세한 내용은 사용자매뉴얼 참고해 주세요
                            </p>
                            <button class="btn-collapse-close">접기</button>
                          </div>
                        </div>
                      ...
                      <div class="point-wrap" id="buying-point-2-3" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          ...
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_10.jpg"
                              alt="털이 풍성한 고양이가 주방 조리대 위를 걷고 있습니다. 조리대에는 인덕션이 설치되어 있으며, 배경에는 나무 재질의 벽장과 조명이 있습니다. 벽면에는 두 개의 나무 도마가 걸려 있습니다." />
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 출력제어 / 상판 과열감지 / 시간 제어 / 21종
                              안전장치 / 16종 안전장치
                            </span>
                          </button>
                          <div class="collapse-content">
                            <p>
                              <b>[출력제어 / 상판 과열감지 / 시간 제어 / 21종
                                안전장치]</b><br />
                      ...
                      <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          <h5>자동용기감지</h5>
                          <p>
                            용기의 위치를 자동으로 감지하여 화구를 선택할 필요 없이 바로 요리할 수 있습니다.
                          </p>
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_05.mp4"></video>
                          </div>
                        </div>
                      </div>
                      <div class="point-wrap" id="buying-point-2-5" name="buying-point-2" style="display: none">
                        ...
                        <div class="content">
                          <h5>용기 가열 지수</h5>
                          <p>
                            LG 인덕션에 최적화된 용기인지 궁금할 땐 간편하게 확인해 볼 수 있습니다.
                            용기 가열 지수는 제조사 자체 내부 기준에 따라 표시되는 지수로 인덕션에서 얼마나 잘 가열 되는지를 0 부터 10 까지의 수치로 나타낸 것입니다. 숫자가 10 에
                            가까울수록 빠르게 가열된다는 뜻이며, 가열 지수가 9 이상인 용기를 사용하는 것이 좋습니다.
                          </p>
                          <div class="img">
                            <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_12.jpg" alt="검은색 배경의 전자 기기 패널이 보이며, 빨간색 숫자 10이 표시되어 있습니다. 패널에는 강물 양념, 자동 감지, 타이머, 임시 보증, Wi-Fi, ThinQ 등의 텍스트가 있으며, 다양한 설정 버튼이 있습니다.
                            " />
                          </div>
                          <button class="btn-collapse-toggle">
                  ...
                  <div class="point-tip" id="point-tip3">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_09.jpg"
                          alt="밝은 톤의 조리대 위에 블랙 컬러의 인덕션이 매립형으로 설치되어 있습니다. 배경에는 넓은 창으로 자연 풍경이 들어오고, 간결한 수납장과 소품이 함께 보여 모던한 주방 분위기를 연출하는 이미지입니다."
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_03.jpg"
                          alt="밝은 톤의 조리대 위에 블랙 컬러의 인덕션이 매립형으로 설치되어 있습니다. 배경에는 넓은 창으로 자연 풍경이 들어오고, 간결한 수납장과 소품이 함께 보여 모던한 주방 분위기를 연출하는 이미지입니다."
                          class="mobile-only" />
                      </div>
                    </div>
                  ...
                  <div class="point-tip" id="point-tip4" style="display: none">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_13.jpg"
                          alt="주방 조리대 위에 주황색과 흰색 줄무늬 고양이가 전기레인지 근처를 살펴보고 있습니다. 배경에는 주방의 일부가 보입니다." class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_04.jpg"
                ...
                <div id="buying-point-3" name="buying-point" style="display: none">
                    ...
                    <div class="subtab-content">
                      <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                        ...
                        <div class="content">
                          <h5>쿼드인버터</h5>
                          <p>
                            2개가 아닌 4개의 인버터로 용기가열 효율을 높여 기존 인덕션 대비 2.3배 빠른 조리가 가능합니다. 저효율 인덕션 용기도 답답함 없이 사용할 수 있습니다.
                          </p>
                          <div class="btn-wrap">
                            <a class="btn-product"
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_01.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                      ...
                      <div class="point-wrap" id="buying-point-3-2" name="buying-point-3" style="display: none">
                        ...
                        <div class="content">
                          <h5>듀얼인버터</h5>
                          <p>
                            3,400W 최고화력으로 가스레인지보다 2.6배 빨라진 요리가 가능합니다.
                          </p>
                          <div class="btn-wrap">
                            <a class="btn-product"
                          ...
                          <div class="img">
                            <button class="btn-pause">일시멈춤</button>
                            <video autoplay playsinline loop muted
                              src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_02.mp4"></video>
                          </div>
                          <button class="btn-collapse-toggle">
                            <span>* 3,400W 초고화력</span>
                          </button>
                          <div class="collapse-content">
                            <p>
                              * 자사가 제시한 시험 방법으로 자사 전기레인지 (우측대화구, 3,400W) / 가스레인지 (3,400W) 대상, 물 최초 온도(25℃)로부터 70℃ 상승한
                              95℃ 도달까지의 소요시간 측정<br />
                              * 실험 조건 : 물 1L, 21cm 냄비 (바닥부), 3,400W 최대 점화 / 터보 기준<br />
                              * 실험 모델 : BEI3MQT (인덕션), HB622AB (가스레인지)<br />
                              * BEF3AMB4E와 BEI3MQT는 상판 디자인 외 내부 기능 / 성능이 동일함<br />
                              * 자사 시험결과를 3자 시험기관인 UL코리아가 검증한 결과(2021.12)로 가스레인지 대비 최대 2.6배 빠른 것으로 확인함<br />
                              * 실험결과는 실제 사용환경에 따라 다를 수 있음<br />
                              * 인덕션 3,400W 우측 대화구 터보 기준 (단독 동작 시)<br />
                              * 3구 동시 사용 가능하며, 2개 이상 화구 동시 동작 시 제품 최대 출력 범위 (3,400W) 내에서 화구별 출력을 자동으로 조정합니다.<br />
                              (터보 모드 사용 시 다른 화구 사용 불가함)<br />
                              * 3,400W 초고화력 : 한국 에너지관리공단 홈페이지 기재된 동급 인덕션 제품의 단일화구 최대 출력 기준 (22년 1월)<br />
                              (동급 인덕션 : 해당 자료 내 1) 국산 제조, 2) 인덕션 3구 이상의 화구 구성 플러그인 제품에 한함. 단일화구 최대 화력 : 각 제조사 홈페이지 및
                              사용설명서에 기재된 출력에 근거)
                            </p>
                            <button class="btn-collapse-close">접기</button>
                          </div>
                  ...
                  <div class="point-tip" id="point-tip5">
                    ...
                    <div class="tip-content">
                      ...
                      <div class="img">
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_14.jpg"
                          ...
                          class="pc-only" />
                        <img src="/kr/story/buying-guide/2025/img/electric-range/img_M09_101_05.jpg"
                          alt="주방 조리대 위에 인덕션이 설치되어 있으며, 인덕션 위에는 다양한 채소와 고기가 들어 있는 냄비가 놓여 있습니다. 냄비 옆에는 요리책이 펼쳐져 있고, 작은 그릇과 반으로 잘린 레몬이 보입니다. 인덕션 표면에는 조작 패널과 함께 DIOS, ThinQ, Inverter 등의 텍스트가 있습니다. 배경은 대리석 느낌의 주방 상판입니다."
                          class="mobile-only" />
                      </div>
                    </div>
                ...
                <div class="point-box">
                  ...
                  <div class="tab-content">
                    <div id="buying-point-4" name="buying-point-45">
                      <div class="slideWrap colWrap" style="--box-height: 558px; --box-m-height: 345px">
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              <div>
                                <h4>미라듀어</h4>
                                <p>
                                  독일 쇼트(SCHOTT)사의 프리미엄 글라스 소재인 미라듀어 글라스는 표면이 단단하고 긁힘에 강해 조리 중
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_15.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_16.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_17.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              <div>
                                <h4>블랙 세라믹</h4>
                                <p>가장 기본적인 글라스로 실용적이고 깔끔한 디자인으로 어느 주방에나 잘 어울립니다.</p>
                              </div>
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_18.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              <div>
                                <h4>클리어트랜스</h4>
                                <p>고급스러운 색상으로 주방에 자연스럽게 스며들어 인테리어의 품격을 높여줍니다. </p>
                              </div>
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_19.jpg"
                        ...
                        <div class="col">
                          <div>
                            <div class="content-wrap">
                              ...
                              <div>
                                <div class="media-wrap">
                                  <img src="/kr/story/buying-guide/2025/img/electric-range/img_P09_101_20.jpg"
            ...
            <section class="useful-tip">
              ...
              <div class="tip-wrap">
                <div class="tip-faq">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/story/faq/electric-ranges-faq">FAQ</a>
                  </div>
                </div>
                <div class="tip-subscribe">
                  ...
                  <div class="btn-wrap">
                    <a target="_blank" href="https://www.lge.co.kr/category/care-solutions/electric-stoves">구독 상품</a>
                  </div>
                </div>
                <div class="tip-best">
                  <h3>
                  ...
                  <div class="btn-wrap">
                    <a target="_blank"
                      href="https://www.lge.co.kr/best-ranking/todays?superCategoryId=CT50000064&categoryId=CT50000076&categoryName=%EC%A0%84%EA%B8%B0%EB%A0%88%EC%9D%B8%EC%A7%80">베스트
                      랭킹</a>
                  </div>
                </div>
              </div>
