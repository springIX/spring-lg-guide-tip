                    ...
                    <div id="buying-point-1-1" name="buying-point-1">
                      <div class="point-wrap">
                        ...
                        <div class="content">
                          <h5>하이브리드</h5>
                          <p>
                            하이브리드는 인덕션과 하이라이트가 하나로 합쳐진 제품입니다. 빠른 가열과 높은 에너지 효율을 제공하는 인덕션과 다양한 용기를 사용할 수 있는 하이라이트의 장점을 모두 누릴 수 있습니다. 하이라이트는 상판을 직접 가열해 열을 전달하는 방식으로 은근한 열조리가 필요한 요리에 적합합니다.
                          </p>
                          <div class="btn-wrap">
                            <a
                              class="btn-product"
                  ...
                  <div class="subtab-content">
                    ...
                    >
                      ...
                      <div class="content">
                        <h5>끓음 알림</h5>
                        <p>
                          조리 과정을 딥러닝한 온도예측 알고리즘의 AI기능과 음성안내로 다양한 국물요리를 편리하게 조리할 수 있습니다. 물부터 국, 찌개까지 설정한 용량에 맞춰 화력을 조절하고, 음성안내와 함께 조리 상태를 확인할 수 있습니다.
                        </p>
                        <div class="btn-wrap">
                          <a
                            class="btn-product"
                        ...
                        <div class="img">
                          ...
                          <video
                            ...
                            loop
                            muted
                            src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_03.mp4"
                          ></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          ...
                          <video
                            ...
                            loop
                            muted
                            src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_04.mp4"
                          ></video>
                        </div>
                        <button class="btn-collapse-toggle">
                          <span>* 대화구 터보 모드</span>
                      ...
                      <div class="content">
                        ...
                        <div class="img">
                          ...
                          <video
                            ...
                            loop
                            muted
                            src="/kr/story/buying-guide/2025/video/electric-range/vid_P09_101_05.mp4"
                          ></video>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div class="content">
                        ...
                        <p>
                          ...
                          용기 가열 지수는 제조사 자체 내부 기준에 따라 표시되는 지수로 인덕션에서 얼마나 잘 가열 되는지를 0 부터 10 까지의 수치로 나타낸 것입니다. 숫자가 10 에 가까울수록 빠르게 가열된다는 뜻이며, 가열 지수가 9 이상인 용기를 사용하는 것이 좋습니다.
                        </p>
                        <div class="img">
                          <img
                  ...
                  <div class="subtab-content">
                    ...
                    >
                      ...
                      <div class="content">
                        ...
                        <div class="collapse-content">
                          <p>
                            * 자사가 제시한 시험 방법으로 자사 전기레인지 (우측대화구, 3,400W) / 가스레인지 (3,400W) 대상, 물 최초 온도(25℃)로부터 70℃ 상승한 95℃ 도달까지의 소요시간 측정<br />
                            ...
                            * 3,400W 초고화력 : 한국 에너지관리공단 홈페이지 기재된 동급 인덕션 제품의 단일화구 최대 출력 기준 (22년 1월)<br />
                            (동급 인덕션 : 해당 자료 내 1) 국산 제조, 2) 인덕션 3구 이상의 화구 구성 플러그인 제품에 한함. 단일화구 최대 화력 : 각 제조사 홈페이지 및 사용설명서에 기재된 출력에 근거)
                          </p>
                          <button class="btn-collapse-close">접기</button>
                        </div>
                      </div>
