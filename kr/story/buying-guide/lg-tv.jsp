                    ...
                    <div id="product-type-1" name="product-type">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                ...
                                <div class="bubble">
                                    <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001001" target="_blank"
                        ...
                        <div class="text-wrap">
                            ...
                            <p>
                               백라이트 없이 스스로 빛을 내는 올레드 기술로 밝은 곳에서도 완벽한 블랙과 생생한 색감을 구현해 차원이 다른 몰입도의 시청 경험을 제공합니다.
AI 프로세서가 830만개의 픽셀을 정교하게 분석해 화질을 업스케일링하고 사운드를 콘텐츠에 맞게 최적화해 영화, 스포츠 등 다양한 장르에서 풍부한 감동을 전달합니다.
                            </p>
                        </div>
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/icon_microRGB.svg"
                                                            alt="모니터 안에 Micro RGB 아이콘" /> </div>
                                                    <p> Micro RGB 초정밀 컬러<br>(트리플 100% 컬러) <span class="des"> <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> webOS 26 <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button> <span
                                                                class="bubble">영상부터 음악, 게임, 앱까지 빠르고 원활하게 접근할 수 있는 플랫폼
                                                                제공</span> </span> </p>
                                                </td>
                                            </tr>
                                            <tr class="procuct-spec last">
                                                <td>
                                                    ...
                                                    <p> 게이밍 주사율 120Hz <br>(VRR 최대 165Hz) <span class="des"> <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">165Hz 가변 주사율(VRR)로 끊김 없이 즐기는 게임
                                                                환경</span> </span> </p>
                                                </td>
                                            ...
                                            <div id="product-type-3" name="product-type" style="display: none">
                                                <div class="img-wrap">
                                                    <div class="bubble-wrap left"
                                                        ...
                                                        <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                                        <div class="bubble">
                                                            <a href="https://www.lge.co.kr/category/tvs?subCateId=CT50368001" target="_blank" rel="noopener"
                                                                title="새창열림"><span>LG
                                                ...
                                                <div class="text-wrap">
                                                    ...
                                                    <div class="text-wrap-content">
                                                        <p>
                                                            ...
                                                            영역을 표현합니다. 더블 컬러 100% 인증을 받아 보다 풍부하고 생생한 색감으로 콘텐츠를 한층 더 몰입감 있게 즐길 수 있습니다.
                                                        </p>
                                                        <p class="text-wrap-note">* 레드 칩을 대신한 레드 부스터와 그린. 블루 칩이 동시 발광하는 구조로 RGB 정밀 컬러 구현</p>
                                                    </div>
                                                </div>
                                                <div class="guide-disclaimer guide-disclaimer--pc-right">
                                                    <p class="guide-disclaimer__item">소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.</p>
                                                    <p class="guide-disclaimer__item">LG Mini RGB evo AI는 LG Micro RGB evo AI와 다르게 그린, 블루 칩과 레드 부스터가 동시에 발광하는 기술이 적용되어
                                                        있습니다.
                                                    </p>
                                                </div>
                                                <div class="compare-wrap">
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_4k.svg"
                                                            alt="4K 해상도" /> </div>
                                                    <p> 4K 해상도 <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">탁월한 컬러와 밝기로 4K 영상을 생생하게</span> </span>
                                                    </p>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/icon_miniRGB.svg"
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_alpha11.svg"
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_webOS.svg"
                                                            alt="webOS" /> </div>
                                                    <p> webOS 26 <span class="des"> <button class="info pc-only"
                                            ...
                                            <tr class="procuct-spec last">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_144HZ.svg"
                    ...
                    <div id="product-type-4" name="product-type" style="display: none">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                ...
                                <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                <div class="bubble"> <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001003"
                                        target="_blank" rel="noopener" title="새창열림"><span>LG QNED evo AI</span> </a>
                                    <p>스탠드/벽걸이형<span></span>4K</p>
                                </div>
...
AI 프로세서가 화질과 사운드를 자동으로 분석하고 최적화해 선명한 4K 시청 경험을 제공합니다. </p>
                        ...
                        <div class="compare-wrap">
                            ...
                            <div class="btn-wrap">
                                <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001003" target="_blank"
                                    rel="noopener" class="btn-product" title="새창열림">제품 보러 가기</a>
                            </div>
                        </div>
                        <div class="product-table">
                    ...
                    <div id="product-type-5" name="product-type" style="display: none">
                        <div class="img-wrap">
                            <div class="bubble-wrap left" style="
                                ...
                                <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                <div class="bubble">
                                    <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001004" target="_blank"
                                        rel="noopener" title="새창열림"><span>LG
                                            나노셀 AI</span></a>
                                    <p>스탠드/벽걸이형<span></span>4K</p>
                                </div>
                        ...
                        <div class="text-wrap">
                            ...
                            <div>
                                <p>
                                    1나노미터 크기의 미세 입자로 불필요한 색을 줄이고 색의 순도를 높여 자연스럽고 정확한 컬러를 구현하는 나노셀 기술이 적용되었습니다.
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_HDR10.svg"
                                                            alt="모니터 안에HDR10 PRO가 적힌 아이콘 " /> </div>
                                                    <p> HDR10 PRO <span class="des"> <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button> <span
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_alpha7.svg"
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_4kup.svg"
                                                            alt="4K 업스케일링" /> </div>
                                                    <p> 4K 업스케일링 <span class="des"> <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button> <span
                                            ...
                                            <tr class="procuct-spec last gray">
                                                <td>
                                                    <div class="spec-img"> <img src="/kr/story/buying-guide/2025/img/tv/icon_60Hz.svg"
                                                            alt="게이밍 주사율 60Hz" /> </div>
                                                    <p> 게이밍 주사율 60Hz <span class="des"> <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button> <span
                    ...
                    <div id="product-type-7" name="product-type" style="display: none">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                ...
                                <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                <div class="bubble"> <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001006"
                                        target="_blank" rel="noopener" title="새창열림"><span>LG 울트라 HD TV AI</span></a>
                                    <p>스탠드/벽걸이형<span></span>4K</p>
                                </div>
...
AI로 TV 설정을 간편하게 변경해 편리하게 시청할 수 있습니다.
                        ...
                        <div class="compare-wrap">
                            ...
                            <div class="btn-wrap">
                                <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001006" target="_blank"
                                    rel="noopener" class="btn-product" title="새창열림">제품 보러 가기</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                                    ...
                                    <div class="content">
                                        <h5>LCD와 올레드의 차이</h5>
                                        <p>
                                            TV는 백라이트 없이 스스로 빛을 내는 올레드 TV와 백라이트의 빛을 LCD를 이용해 조절하는 LCD TV (LED TV, 미니LED
                                            TV 등) 로 나뉘어요. 올레드
                                            TV는 픽셀 단위로 빛과 색을 직접 조절해 정확한 블랙과 무한대 명암비를 구현하고, 백라이트 없이 스스로 빛을 냅니다. 반면 LCD
                                            TV는 백라이트를 통해 화면을
                                            표현하고, 빛 번짐과 블랙 표현에 한계가 있지만, 미니 LED와 고색재현 기술 등 정교한 백라이트 제어 기술을 적용해 생생하고 균일한
                                            화질을 제공합니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-1-2" name="buying-point-1"
                                    ...
                                    <div class="content">
                                        <h5>퍼펙트 블랙</h5>
                                        <p>
                                            픽셀 하나하나 딱 필요한 부분에 필요한 만큼의 빛을 켜기 때문에 완벽한 블랙을 표현할 수 있습니다. 덕분에 까만 우주의 작은 별
                                            하나까지도 정확하게 보여주는 무한대
                                            명암비가 가능합니다.
                                        </p>
                                        <div class="img">
                                        ...
                                        <div class="collapse-content">
                                            <p class="asterisk-note-list">
                                                ...
                                                <span class="asterisk-note-list__item no-bullet">
                                                    ④ 인증 내용 (인증 번호) : 최대 500lux 환경에서 블랙휘도 0.24nit 이하 (V183632)
                                                </span>
                                                <span class="asterisk-note-list__item">
                                    ...
                                    <div class="content">
                                        <h5>퍼펙트 컬러</h5>
                                        <p>
                                            100% 컬러 볼륨과 100% 색 정확도로 실물 그대로의 색감을 담아냅니다. 퍼펙트 컬러 인증을 받아 밝은 공간에서도 변함없이 선명한
                                            화질을 즐길 수 있습니다.
                                        </p>
                                        <div class="img">
                                    ...
                                    <div class="content">
                                        <h5>업계 최다 라인업</h5>
                                        <p>
                                            세계 최대 245cm 부터 105cm의 화면사이즈까지 업계 최다 라인업으로 올레드만의 뛰어난 화질을 용도와 상황에 따라 선택해서 즐길 수
                                            있습니다.
                                        </p>
                                        <div class="img">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="des asterisk-note-list">
                                            ...
                                            <span class="asterisk-note-list__item no-bullet">
                                                ※ 2024년 CES 혁신상 수상: Digital Imaging / Photography, Audio/Video Components & Accessories, Video Displays
                                                부문(88OLEDZ3), Digital Imaging / Photography 부문(118” 4K Micro LED), Embedded Technologies, Audio/Video Components
                                                & Accessories 부문 (OLED M4), Gaming & eSports 부문(83OLEDM4), Audio/Video Components & Accessories 부문 (83OLEDC4),
                                                Mobile Devices, Accessories & Apps, Content & Entertainment 부문(StanbyME Go LX5), Video Display, Embedded
                                                Technologies, Digital Imaging / Photography 부문(4K Transparent OLED T), Content & Entertainment 부문(Voice ID 기반
                                                콘텐츠 추천), Digital Health 부문 (Intelligent Fit), Content & Entertainment 부문(Transparent Screen UX), Artificial
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            “현대적이고 완벽하며 정교하다”라는 평가를 받은 LG 올레드 에보 TV. 일반 올레드 TV 대비 최대 70% 밝고, 업계 유일의 올레드
                                            전용 프로세서를 탑재해 화질을
                                            강화하였습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-1-3" name="buying-point-1"
                                    ...
                                    <div class="content">
                                        <h5>초정밀 컬러와 디테일 완성 Micro RGB evo
                                        </h5>
                                        <p>
                                            Micro RGB Technology는 LG만의 독자적인 기술로 트리플 100% 컬러 인증을 획득한 차세대 디스플레이 백라이트
                                            기술입니다.
                                            고색순도 RGB 스펙트럼 디스플레이가 적용되어 색을 보다 정확하고 선명하게 표현하며, 기존 Mini LED 백라이트 대비 더욱 풍부한
                                            컬러와 명암비를 제공합니다.
                                        </p>
                                        <div class="btn-wrap">
                                            <a class="btn-product"
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            QNED의 상위 라인업인 QNED evo는 QNED TV의 정교한 색감에 더해 빛을 더 섬세하게 제어하는 미니 LED를 적용했습니다.
                                            작은 디테일까지 더 선명하게,
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            1나노미터(nm)의 미세 입자를 적용해 불순한 색의 파장을 제거하고 색의 순도를 높여 실제 눈으로 보는 듯 생생하게 표현해줍니다. 넓은
                                            시야각으로 어떤 각도에서
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            나노 디테일 향상 기술로 화면 속 미세한 명암과 질감, 윤곽선을 정밀하게 분석해 작은 디테일까지 또렷하게 표현해주고, 머리카락 한 올의
                        ...
                        <div class="point-tip">
                            ...
                            <div class="tip-content">
                                <div class="content">
                                    ...
                                    <p class="tip-text">
                                        콘텐츠 애호가라면, 디테일의 차이가 주는 감동을 잘 아실 거예요. 집에서도 조명을 낮추고 영화관에 온 것처럼 장면 하나의 색감도 놓치지 않고
                                        몰입하고 싶다면, 명암을
                                        확실하게 구분해주는 올레드 TV를 추천드려요. 가족과 함께 거실에 모여서 뉴스, 예능, OTT 등 다양하고 일상적인 콘텐츠를 함께 즐길 수 있는
                                        합리적인 가격의 TV를
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                                    ...
                                    <div class="content">
                                        <h5>190cm 이상</h5>
                                        <p>
                                            거실은 물론 별도 공간에서도 영화관처럼 홈시어터를 꾸릴 수 있을 만큼 초대형 화면과 8K 고화질로 생동감 넘치는 영상을 즐길 수
                                            있습니다.
                                        </p>
                                        <div class="btn-wrap">
                                            <a class="btn-product"
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                                    ...
                                    <div class="content">
                                        <h5>알파11 AI 프로세서</h5>
                                        <p>
                                            내가 보는 영상과 사운드를 알아서 분석해 최적의 화질과 사운드를 바꿔주는 올레드의 13년 기술이 담긴 똑똑한 프로세서에요. 5.6배
                                            향상된 AI 성능과 50%
                                ...
                                <div class="point-wrap" id="buying-point-3-2" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 화질 프로</h5>
                                        <p>
                                            장면을 세밀하게 분석하고 픽셀 단위로 업스케일해 더 부드럽고 선명한 4K 화질로 감상할 수 있고 밝기, 선명도, 대비까지 섬세하게
                                            조절해줍니다.
                                        </p>
                                        <div class="img">
                                            <button class="btn-pause">일시멈춤</button>
                                ...
                                <div class="point-wrap" id="buying-point-3-6" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 매직 리모컨</h5>
                                        <p>
                                            가장 자주 사용하는 기능만 담아 컴팩트하게 완성한 <br class="mo-onl">AI 매직 리모컨입니다. <br>
                                            홈 버튼으로 webOS에 바로 접속하고, AI 버튼으로<br class="mo-onl"> 궁금한 점을 물어보거나 도움을 요청할 수 있으며,<br class="mo-onl">
                        ...
                        <div class="point-tip">
                            ...
                            <div class="tip-content">
                                <div class="content">
                                    ...
                                    <p class="tip-text">
                                        하루 종일 선택과 고민이 이어지는 일상, 집에 돌아온 순간만큼은 아무 생각 없이 쉬고 싶죠. 그런데 막상 소파에 앉으면 볼 콘텐츠를 고르느라
                                        시간을 보내곤 합니다. LG
                                        AI TV와 함께라면 그런 고민은 끝! 볼 만한 콘텐츠를 추천해주고, 날씨ㆍ뉴스 같은 실시간 정보 확인부터 해외여행 일정 계획까지 AI가 쉽고
                                        빠르게 도와줍니다.
                                    </p>
                                </div>
                                <div class="img">
                            ...
                            <div class="subtab-content">
                                ...
                                <div class="point-wrap" id="buying-point-4-2" name="buying-point-4"
                                    ...
                                    <div class="content">
                                        <h5>아트 오브제 디자인</h5>
                                        <p>
                                            LG 올레드 오브제컬렉션 Pose (포제) TV는 벽에 걸거나 스탠드에 놓는다는 고정관념을 깨고, 예술작품처럼 인테리어의 일부가 되도록
                                            디자인되었습니다. TV를
                                ...
                                <div class="point-wrap" id="buying-point-4-4" name="buying-point-4"
                                    ...
                                    <div class="content">
                                        <h5>갤러리 디자인</h5>
                                        <p>
                                            LG 올레드 evo 벽걸이형 (벽밀착)은 벽면에 간격 없이 밀착되어 액자처럼 연출할 수 있고 외부 입력 단자를 본체에 모두 내장해 마치
                                            벽과 하나 된 듯 깔끔하게
                                            설치할 수 있습니다.
                                        </p>
                                        <div class="img">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-5-1" name="buying-point-5">
                                    ...
                                    <div class="content">
                                        <h5>버추얼 서라운드</h5>
                                        <p>
                                            공간 곳곳에 스피커가 펼쳐진 듯한 입체적인 음향을 만들어줍니다. 소리가 상하좌우로 자연스럽게 퍼져, 영상 속에 들어간 듯 한층 깊은
                                            몰입감을 느낄 수 있습니다.
                                        </p>
                                        <div class="img">
                            ...
                            <div class="tip-content">
                                <div class="content">
                                    ...
                                    <p class="tip-text">
                                        ...
                                        집에서도 게임이나 스포츠를 몰입감 있게 즐기고, 공간을 가득 채우는 입체적인 사운드는 일상을 작은 영화관처럼 만들어줘요. 여기에 TV에 어울리는
                                        LG 사운드바를
                                        ...
                                        <div>
                                            <div class="content-wrap">
                                                <div>
                                                    <h4>webOS 25</h4>
                                                    <p>
                                                        보이스 ID를 등록하면 별도의 조작 없이 자동으로 로그인되어, 개인 취향에 맞는 콘텐츠와 서비스를 바로 이용할 수
                                                        있습니다. 간단한 선택만으로 화면과
                                                        사운드를 각각 최적의 설정값으로 맞춰, 나에게 가장 편안한 감상 환경을 제공합니다. 또한 최대 5년간 webOS
                ...
                <div class="tip-wrap">
                    <div class="tip-faq">
                        ...
                        <div class="btn-wrap">
                            ...
                            <a target="_blank" rel="noopener" href="https://www.lge.co.kr/story/useful-tip/oled-tv-faq"
                                title="새창열림">올레드 TV FAQ
                            </a>
                        </div>
                    </div>
                    <div class="tip-subscribe">
                        ...
                        <div class="btn-wrap">
                            <a target="_blank" rel="noopener" href="https://www.lge.co.kr/category/care-solutions/tvs"
                                title="새창열림">구독 상품</a>
                        </div>
                    </div>
                    <div class="tip-best">
                ...
                <div class="unit-box">
                    <ul class="bullet-list">
                        <span style="color: #333333">* 제품 이미지 및 특장점 등에는 광고적 표현이 포함되어 실제
                            ...
                            위해 사전 예고 없이 변경될 수 있습니다.</span><br /><span style="color: #333333">* 모든 제품 이미지는 촬영 컷으로 실제 제품과
                            차이가 있을 수
                            있으며, 제품 색상은 모니터 해상도, 밝기 설정 및 컴퓨터 사양에
                            따라 차이가 있을 수 있습니다.</span><br /><span style="color: #333333">* 해당 제품의 성능은 사용 환경에 따라 일부 상이할 수
                            있으며,
