                ...
                <div class="tab-content">
                    <div id="product-type-1" name="product-type">
                        ...
                        <div class="text-wrap">
                            ...
                            <p>
                                자체발광 디스플레이가 구현하는 퍼펙트 블랙과 무한대 명암비, 정확한 컬러로 영화, 다큐, 게임 속 장면 하나하나를 사실적으로 표현해, 마치 화면 속에 들어간
                                듯한 몰입감을 느낄
                                수 있어요.
                            </p>
                        </div>
                        ...
                        <div class="compare-wrap">
                                    ...
                                    <table class="no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="procuct-spec">
                                                ...
                                                <td>
                                                    <div class="spec-img">
                                                        <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_alpha9.svg"
                                                            alt="알파9 AI 프로세서" />
                                                    </div>
                                                    <p>
                                                        알파9 AI 프로세서
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="des">
                                                            <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">NVIDIA G-Sync 호환, 0.1ms의 응답속도의 게임
                                                                환경</span>
                                                        </span>
                                                    </p>
                                                </td>
                            ...
                            <p class="des">
                                * 2013~2024년 올레드 TV 세계 판매 1위 (출하량, Omdia기준) <br>
                                * 25년 출시 제품을 기준으로 작성된 표로, 제품별 스펙은 다를 수 있으니 정확한 내용은 각 제품별 상세 스펙을 확인해주세요.
                            </p>
                            <div class="btn-wrap">
                                <a href="https://www.lge.co.kr/category/tvs?subCateId=CT50000028" target="_blank"
                    ...
                    <div id="product-type-2" name="product-type" style="display: none">
                        ...
                        <div class="text-wrap">
                            ...
                            <p>
                                LG의 고색재현 기술을 적용해 색 표현을 극대화하고, 전 모델 컬러볼륨 100% 인증을 받은 프리미엄 LCD TV예요. 압도적 기술로 한층 더 깊고 생동감
                                있는 화면을 경험할
                                수 있어요.
                            </p>
                        </div>
                                    ...
                                    <table class="no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="procuct-spec">
                                                ...
                                                <td class="disabled">
                                                    <div class="spec-img">
                                                        <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_localdimming.svg"
                                                            alt="로컬 디밍" />
                                                    </div>
                                                    <p>
                                                        알파7 AI 프로세서 없음
                    ...
                    <div id="product-type-3" name="product-type" style="display: none">
                        ...
                        <div class="text-wrap">
                            ...
                            <div>
                                <p>
                                    1나노미터의 미세 입자로 불순한 색의 파장을 제거해 색의 순도를 높이는 나노셀 기술로 컬러를 한층 더 선명하게 표현하고 깔끔한 디자인으로 공간을
                                    돋보이게 만들어줘요.
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="des">
                                            * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br />
                                            ...
                                            Accessories,
                                            Video Displays 부문(88OLEDZ3), Digital Imaging / Photography 부문(118” 4K Micro
                                            LED), Embedded
                                            Technologies, Audio/Video Components & Accessories 부문 (OLED M4), Gaming &
                                            eSports
                                            부문(83OLEDM4), Audio/Video Components & Accessories 부문 (83OLEDC4), Mobile
                                            Devices,
                                            Accessories & Apps, Content & Entertainment 부문(StanbyME Go LX5), Video
                                            Display, Embedded
                                            Technologies, Digital Imaging / Photography 부문(4K Transparent OLED T),
                                            Content &
                                            Entertainment 부문(Voice ID 기반 컨텐츠 추천), Digital Health 부문 (Intelligent Fit),
                                            Content &
                                            Entertainment 부문(Transparent Screen UX), Artificial Intelligence (AI) 부문(LG
                                            Imagine
                                            Live)​<br />
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                                    ...
                                    <div class="content">
                                        <h5>알파11 AI 프로세서</h5>
                                        <p>
                                            내가 보는 영상과 사운드를 알아서 분석해 최적의 화질과 사운드를 바꿔주는 올레드의 12년 기술이 담긴 똑똑한 프로세서에요. 6.7배
                                            향상된 AI 성능과 2.2배
                                ...
                                <div class="point-wrap" id="buying-point-3-4" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 에이전트</h5>
                                        <p>
                                            친구와 대화하듯, 말을 걸면 AI가 문맥을 파악해 자연스럽게 답변합니다. 다양한 콘텐츠 검색은 기본, 날씨나 뉴스 같은 실시간 정보
                                            검색과 TV 등 가전 제어도
                                ...
                                <div class="point-wrap" id="buying-point-3-5" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 챗봇</h5>
                                        <p>
                                            화면 밝기 등의 TV 설정값을 조정하고 싶다면 AI 챗봇을 불러보세요. 메뉴를 찾아 헤매지 않아도 말 한마디에 원하는 설정으로 손쉽게
                                            변경할 수 있습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-3-6" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 매직 리모컨</h5>
                                        <p>
                                            홈 버튼으로 webOS에 바로 접속하고, AI 버튼을 눌러 궁금한 것을 물어보거나 도움을 요청해보세요. 휠을 마우스처럼 조작해 손쉽게
                                            사용할 수 있습니다.
                                        </p>
                                        <div class="img">
