...
AI 프로세서가 830만개의 픽셀을 정교하게 분석해 화질을 업스케일링하고 사운드를 콘텐츠에 맞게 최적화해 영화, 스포츠 등 다양한 장르에서 풍부한 감동을 전달합니다.
                        ...
                        <div class="des3 note">
                            <p class="des3-item">소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.</p>
                        </div>
                    ...
                    <div id="product-type-2" name="product-type">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                style="--pc-top: 35%;--pc-vertical: 63.5%;--mobile-top: 40%;--mobile-left: 22.5%;--mobile-m-left: 20px;">
                                <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                        ...
                        <div class="compare-wrap">
                                    ...
                                    <table class="single no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="product-table">
                                                ...
                                                <div class="table-wrap include-tab vertical-scroll-box" style="max-width: 920px; margin: 50px auto 0;">
                                                    <table>
                                            ...
                                            <div id="product-type-3" name="product-type" style="display: none">
                                                ...
                                                <div class="text-wrap">
                                                    <h4>
                                                        풍부하고 생생한 색감으로<br class="pc-only">
                                                        콘텐츠를 한층 더 몰입감 있게
                                                    </h4>
                                                    <p>
                                                        R(빨강), G(초록), B(파랑)를 더욱 섬세하게 표현하도록 설계되어 일반적인 LED, 미니 LED보다 더 넓은 색 영역을 표현합니다. 더블 컬러 100% 인증을 받아 보다 풍부하고 생생한
                                                        색감으로 콘텐츠를
                                                        한층 더 몰입감 있게 즐길 수 있습니다.
                                                        <!-- <br>
                                                                                                                                                                                                                                                                                                                <span class="des">※ 레드 칩을 대신한 레드 부스터와 그린. 블루 칩이 동시 발광하는 구조로 RGB 정밀 컬러 구현</> -->
                                                    </p>
                                                </div>
                                                <div class="des3 note">
                                                    <p class="des3-item">소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다. </p>
                                                    <p class="des3-item">레드 칩을 대신한 레드 부스터와 그린, 블루 칩이 동시 발광하는 구조로 RGB 정밀 컬러 구현
                                                    </p>
                                                </div>
                                                <div class="compare-wrap">
                                                    <h3 class="section-title"> <b>대표 모델</b>을 한눈에 비교하고, <br />내게 꼭 맞는 제품을 쉽게 찾아보세요. </h3>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> Mini RGB 컬러<br>(더블 100% 컬러) <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                            ...
                            <div class="des3" style="--max-table-width: 920px">
                                <p class="des3-item"> 본 내용은 라인업의 대표 모델 기준 사양으로 작성되었으며, 모델별 사양은 상이할 수 있습니다. <br> 구매 시
                                    선택하신 모델의 제품 정보 페이지에 기재된 사양을
                                    확인해 주시기 바랍니다. </p>
                                <p class="des3-item">LG Mini RGB evo AI는 LG Micro RGB evo AI와 다르게 그린, 블루 칩과 레드 부스터가 동시에
                                    발광하는 기술이 적용되어 있습니다.</p>
                                <p class="des3-item">High Purity RGB 스펙트럼 디스플레이 인증 / 더블 100% 컬러 인증</p> <button class="btn-collapse-toggle">
                                    <span class="collapse">더보기</span> <span class="active">접기</span> </button>
                                <div class="collapse-content">
                                    <p> [High Purity RGB 스펙트럼 디스플레이 인증]<br> ① 인증 기관: TUV<br> ② 인증 기준일: 2026년 5월<br> ③ 인증
                                        대상: 2026년형 MRGB9M
                                        기준<br> ④ 인증 내용(인증 번호): 스펙트럼 피크 분리 지수(mPSI), 스펙트럼 중첩 비율(SOR)을 측정해 TUV 평가 기준
                                        충족(1111318248)<br><br> [더블
                                        100% 컬러 인증]<br> ① 인증기관: InterTek<br> ② 인증 기준일: 2025년 12월<br> ③ 인증 대상: 2026년형
                                        MRGB9M, MRGB8*시리즈 기준<br> ④
...
AI 프로세서가 화질과 사운드를 자동으로 분석하고 최적화해 선명한 4K 시청 경험을 제공합니다. </p>
                                    ...
                                    <table class="no-btn">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="procuct-spec">
                                                ...
                                                <td>
                                                    <div class="spec-img">
                                                        <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_QNED.svg"
                                                            alt="QNED 컬러" />
                                                    </div>
                                                    <p>
                                                        다이내믹 QNED 컬러
                                                        <span class="des">
                                                            <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">밝고 풍부한 컬러 표현으로 장면의 디테일까지 또렷하게 표현
                                                            </span>
                                                        </span>
                                                    </p>
                                                </td>
                                            ...
                                            <tr class="procuct-spec">
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        알파7 AI 프로세서<br class="mo-only"> (9세대)
                                                        <span class="des">
                                                            <button class="info pc-only"
                                                                aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">딥러닝 알고리즘으로 최적의 화질과 사운드 제공</span>
                                            ...
                                            <tr class="procuct-spec last gray">
                                                <td>
                                                    <div class="spec-img">
                                                        <img src="/kr/story/buying-guide/2025/img/tv/ic48_14_144HZ.svg" alt="게이밍 주사율 120Hz" />
                                                    </div>
                                                    <p>
                                                        게이밍 주사율 120Hz<br>(VRR 최대 144Hz)
                                                        <span class="des">
                        ...
                        <div class="product-table">
                            ...
                            <div class="table-wrap include-tab vertical-scroll-box">
                                <table>
                                    <caption class="blind">
                                        LG QNED TV 모델 라인업 스펙 비교표 - QNED evo, QNED 라인업의 해상도, 컬러, 주사율, 사운드,
                                        운영체제와 리모컨 정보를 비교합니다.
                                    </caption>
                                    <colgroup>
                                        <col class="col1" />
...
AI 프로세서가 화질과 사운드를 분석해 장면에 맞게 조정함으로써 일상적인 시청 환경에서도 균형 잡힌 화질과 사운드를 제공합니다.
                    ...
                    <div id="product-type-6" name="product-type">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                style="--pc-top: 35%;--pc-vertical: 63.5%;--mobile-top: 40%;--mobile-left: 22.5%;--mobile-m-left: 20px;">
                                <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                    ...
                                    <table class="single no-btn">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="procuct-img"> <img
                                                            src="/kr/story/buying-guide/2025/img/tv/NANO 4K UHD_front.png"
                                                            alt="TV LG NANO 4K UHD 제품 이미지" class="front" /> <img
                                                            src="/kr/story/buying-guide/2025/img/tv/NANO 4K UHD_side.png"
...
AI로 TV 설정을 간편하게 변경해 편리하게 시청할 수 있습니다.
            ...
            <section id="buying-point" name="buying-guide-content" style="display: none">
                ...
                <h3 class="section-title">
                    영화부터 게임까지, <b>우리 집 즐거움</b>의 시작 <br />
                            ...
                            <div class="subtab-content">
                                ...
                                <div class="point-wrap" id="buying-point-1-2" name="buying-point-1"
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            ...
                                            <p>
                                                ...
                                                ② 인증 기준일 : 2024년 10월<br />
                                                ③ 인증 대상 : 2025년형 올레드 전 모델 모듈 기준<br />
                                                ④ 인증 내용 (인증 번호) : 500lux 환경에서 CIE DE 2000에 따른 125가지 색상 패턴의 목푯값과 측정값 차이가
                                                2.0보다 작아 색 정확도
                                    ...
                                    <div class="content">
                                        <h5>끊김 없는 게이밍</h5>
                                        <p>
                                            NVIDIA G-Sync 호환, 165Hz 가변 주사율(VRR), 0.1ms의 응답속도, AMD FreeSync Premium으로 화면
                                            티어링이나 지연 걱정 없이
                                            게임을 플레이 할 수 있습니다.
                                        </p>
                                        <div class="img">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            <p>
                                                ...
                                                ④ 인증 내용(인증 번호) : 일주기 성능 계수(CPF: Circadian Performance Factor) 60이상
                                                (V745354)
                                            </p>
                                            <button class="btn-collapse-close">접기</button>
                                        </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="des">
                                            * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br />
                                            ...
                                            Accessories, Video Displays 부문(88OLEDZ3),
                                            Digital Imaging / Photography 부문(118” 4K Micro LED), Embedded Technologies,
                                            Audio/Video Components & Accessories 부문
                                            (OLED M4), Gaming & eSports 부문(83OLEDM4), Audio/Video Components &
                                            Accessories 부문 (83OLEDC4), Mobile Devices,
                                            Accessories & Apps, Content & Entertainment 부문(StanbyME Go LX5), Video
                                            Display, Embedded Technologies, Digital Imaging /
                                            Photography 부문(4K Transparent OLED T), Content & Entertainment 부문(Voice ID
                                            기반 콘텐츠 추천), Digital Health 부문 (Intelligent
                                            Fit), Content & Entertainment 부문(Transparent Screen UX), Artificial
                                            Intelligence (AI) 부문(LG Imagine Live)​<br />
                                            ※ CES혁신상은 제출된 설명 자료에 근거하여 심사하는 상으로, 수여기관인 CTA는 지원서나 주장 내용의 사실관계를 입증하거나, 수상제품
                                            테스트를 진행하지 않습니다.​<br />
                                            ※ 한국소비자원 성능평가: 소비자의 선호도에 따라 주요 고려 요소는 다를 수 있음, SDR 영상품질/HDR영상품질/시야각 부문에서 매우
                                            우수 평가​
                                        </p>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="point-wrap" id="buying-point-1-3" name="buying-point-1"
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            기존 나노셀 TV에서 색 재현율, 명암비, 밝기를 개선해 출시한 QNED TV 입니다. 순도 높은 컬러를 표현하는 나노셀 기준, 각각의
                                            색 표현을 끌어올리는
                                    ...
                                    <div class="content">
                                        <h5>디테일이 살아있는 선명한 화질 NANO 4K UHD</h5>
                                        <p>
                            ...
                            <div class="subtab-content">
                                ...
                                <div class="point-wrap" id="buying-point-2-5" name="buying-point-2"
                                    ...
                                    <div class="content">
                                        <h5>권장 TV 사이즈</h5>
                                        <p>
                                            앉는 위치에서 TV까지의 거리를 기준으로 화면 크기를 계산하면 더 편안하고 몰입감 높은 시청 환경을 만들 수 있습니다. 시청 거리(m)에 100÷1.2를 곱해 적정 TV 사이즈(cm)를 확인하고, 우리 집에 맞는
                                            TV를 선택해보세요.
                                        </p>
                                        <div class="img">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            <p>
                                                * 13년의 기술력: 2013년 LG 올레드 출시 기준<br>
                                ...
                                <div class="point-wrap" id="buying-point-3-2" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            <p>
                                                [듀얼 업스케일링 & 다이내믹 톤 매핑 울트라] <br>
                                                * 이미지는 최대 4K 화질로 업스케일링됩니다. 결과는 원본 해상도에 따라 달라질 수 있습니다. <br>
                                ...
                                <div class="point-wrap" id="buying-point-3-3" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            <p>
                                                [AI 보이스 리마스터링 프로] <br>
                                                * 사운드 모드 메뉴를 통해 활성화해야 합니다. <br>
                                                * 소리는 청취 환경에 따라 다를 수 있습니다. <br>
                                                * AI 보이스 리마스터링 프로는 3세대 알파11 AI 프로세서를 탑재한 모델에서 지원합니다. <br><br>
                                                [버추얼 11.1.2 서라운드] <br>
                                                * 버추얼 11.1.2 서라운드는 영상의 사운드를 분석해 가상의 스피커 채널을 추가하는(업믹싱) AI 기술입니다. <br>
                                                * 주변 환경에 따라 차이가 있을 수 있습니다. <br>
                                                * 시청 콘텐츠와 파일 형식에 따라 차이가 있을 수 있습니다. <br>
                                ...
                                <div class="point-wrap" id="buying-point-3-4" name="buying-point-3"
                                    ...
                                    <div class="content">
                                                ...
                                                <div class="slider">
                                                    <div>
                                                        <img src="/kr/story/buying-guide/2025/img/tv/img_P14_101_24.jpg"
                                                            alt="TV 화면에서 멀티AI가 콘텐츠를 추천하는 화면" />
                                                    </div>
                                                    <div>
                                        ...
                                        <p class="des">
                                            webOS 26의 일부 AI 서비스 및 OTT 기능을 이용하려면 LG 계정 로그인 및 관련 이용약관 동의가 필요합니다.<br />
                                            * AI 기능 사용을 위해서는 인터넷 연결이 필요합니다.<br />
                                        ...
                                        <div class="collapse-content">
                                            <p>
                                                * 제공되는 AI 서비스 모델은 변경되거나 구독이 필요할 수 있습니다. <br>
                                                * 기능은 지역과 모델에 따라 다를 수 있습니다. <br>
                                ...
                                <div class="point-wrap" id="buying-point-3-6" name="buying-point-3"
                                    ...
                                    <div class="content">
                                        <h5>AI 매직 리모컨</h5>
                                        <p>
                                            가장 자주 사용하는 기능만 담아 컴팩트하게 완성한 AI 매직 리모컨입니다. <br>
                                            홈 버튼으로 webOS에 바로 접속하고, AI 버튼으로 궁금한 점을 물어보거나 도움을 요청할 수 있으며,
                                        ...
                                        <p class="des">
                                            * 소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.<br />
                                            * TV의 AI 기능에 빠르게 접근할 수 있도록 설계된 제품으로, 자체적인 AI 처리 기능은 포함되어 있지 않습니다.<br />
                                            * webOS 26의 일부 AI 서비스 및 OTT 기능을 이용하려면 LG 계정 로그인 및 관련 이용약관 동의가 필요합니다.<br />
                                            * AI 기능 사용을 위해서는 인터넷 연결이 필요합니다.<br />
                                            * AI 기능은 요구 사항에 따라 결과값에 차이가 있을 수 있습니다.
                                        </p>
                                ...
                                <div class="point-wrap" id="buying-point-4-1" name="buying-point-4">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="des">
                                            ...
                                            * 세계 최초 무선 : 4K 120Hz 무선 AV 전송 기술, CES 2023 공식 어워드 인증 및 수상(혁신상)기준, 美 라스베이거스
                                            (‘23년 1월)
                                        </p>
                                    </div>
                                </div>
                                            ...
                                            <div class="detail-wrap">
                                                ...
                                                <div class="collapse-content">
                                                    <p>
                                                        ...
                                                        * 보이스 ID는 LG Apps, 홈 화면, LG 피트니스, 스포츠 알람, 홈 오피스, 음악, 게임 등의 메뉴에서
                                                        사용 가능합니다.
                                                    </p>
                                                    <p>
                                                        <b>[webOS 25]</b><br />
                                                        * 구매한 TV의 기본 탑재된 webOS 버전을 기준으로, 최대 5년간 총 4회의 OS 업그레이드를
                                                        지원합니다.<br />
                                                        * 2023년형 이후 모델은 올레드, QNED, 나노셀, UHD 전모델 대상, 2022년형 모델은 올레드 전제품 및
                                                        8K QNED 대상
                                                    </p>
                                                    <button class="btn-collapse-close">접기</button>
                                                </div>
                                    ...
                                    <div class="col">
                                        <div>
                                            ...
                                            <div class="detail-wrap">
                                                ...
                                                <div class="collapse-content">
                                                    <p>
                                                        * LG Gallery+의 모든 콘텐츠와 기능을 이용하려면 구독이 필요하며, 유료 구독시 4천여개 이상의 콘텐츠를
                                                        제한 없이 이용할 수
                                                        있습니다.<br />
                                                        * 월간 구독료는 매월 5천 원이며, 구독 시 webOS Pay를 통해 요금이 부과됩니다. 구독료는 추후 변동될 수
                                                        있습니다.<br />
                                                        * 신규 가입 고객에게는 1개월 무료 체험이 제공되며, 해당 혜택은 사전 안내 없이 변경 및 중단될 수
                                                        있습니다.<br />
