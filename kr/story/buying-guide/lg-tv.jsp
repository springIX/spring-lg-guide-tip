                    ...
                    <div id="product-type-1" name="product-type">
                        <div class="img-wrap">
                            ...
                            <img src="/kr/story/buying-guide/2025/img/tv/img_P14_001_10.png"
                                alt="따뜻한 톤의 거실 벽면에 TV가 설치되어 있고, 화면의 보라·노랑 색감의 추상 패턴이 공간 전체에 세련되고 차분한 분위기를 더하는 모습입니다."
                                class="pc-only" />
                        ...
                        <div class="text-wrap">
                            ...
                            <p>
                            백라이트 없이 스스로 빛을 내는 올레드 기술로<br class="mo-only"> 밝은 곳에서도 완벽한 블랙과 생생한 색감을 구현해<br class="mo-only"> 차원이 다른 몰입도의 시청 경험을
                            제공합니다.<br class="mo-only">
                            AI 프로세서가 830만개의 픽셀을 정교하게 분석해<br class="mo-only"> 화질을 업스케일링하고 사운드를 콘텐츠에 맞게<br class="mo-only"> 최적화해 영화, 스포츠 등 다양한 장르에서
                            풍부한
                            감동을<br class="mo-only"> 전달합니다.
                            </p>
                        </div>
                                            ...
                                            <tr class="procuct-spec">
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="des">
                                                            <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">밝기 향상 알고리즘으로 빛과 어둠의 디테일까지 생생하게
                                                                표현</span>
                                                        </span>
                                                    </p>
                                                </td>
                            ...
                            <div class="btn-wrap">
                                ...
                                <div class="product-table">
                                    ...
                                    <div class="table-wrap include-tab vertical-scroll-box">
                                        <table>
                                            <caption class="blind">
                                        LG 올레드 TV 모델 라인업 스펙 비교표 - M 시리즈, G 시리즈, C 시리즈, B 시리즈의 올레드 evo, 해상도, 화질, 사운드, 게임
                                        기능과 제품 링크 정보를 비교합니다.
                                    </caption>
                                    <colgroup>
                                        <col class="col1" />
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>120Hz <br> (VRR 최대 144Hz) <p class="des2">* B6B, B6X : 최대 120Hz
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div id="product-type-2" name="product-type" style="display: none">
                        <div class="img-wrap">
                            ...
                            <img src="/kr/story/buying-guide/2025/img/tv/micro_rgb_evo_01.jpg"
                                alt="따뜻한 톤의 거실 벽면에 TV가 설치되어 있고, 화면의 알록달록 색감의 보석이 공간 전체에 세련된 분위기를 더하는 모습입니다."
                                class="pc-only" />
...
<div class="guide-disclaimer guide-disclaimer--pc-right">
                        ...
                        <div class="compare-wrap">
                            <h3 class="section-title"> <b>대표 모델</b>을 한눈에 비교하고, <br />내게 꼭 맞는 제품을 쉽게 찾아보세요. </h3>
                            <div class="procuct-summary vertical-scroll-box" id="micro-rgb-evo-summary" style="--max-table-width: 620px">
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        <caption class="blind">LG Micro RGB evo TV 대표 모델 비교표 - 초정밀 컬러로 구현하는 생생한 화질의 주요 특징을 확인할 수 있습니다.</caption>
                                        <thead>
                                            <tr class="procuct-name">
                                                <th scope="col">
                                                    <h4>RGB</h4>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="procuct-img"> <img src="/kr/story/buying-guide/2025/img/tv/Micro_RGB_evo_front.png"
                                                            alt="TV LG Micro RGB evo 제품 이미지" class="front" /> <img
                                                            src="/kr/story/buying-guide/2025/img/tv/Micro_RGB_evo_side.png"
                                                            alt="TV LG Micro RGB evo 측면 이미지" class="side" /> <button
                                                            class="btn-angle" name="btn-angle"> 다른 각도 보기 </button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> 4K 해상도 <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">탁월한 컬러와 밝기로 4K 영상을 생생하게</span> </span>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> Micro RGB 초정밀 컬러<br>(트리플 100% 컬러) <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">빨강, 초록, 파랑 색상을 더욱 정밀하게
                                                                제어하여, 영상 속 빛과 색을 실시간으로 아주 미세한 단위까지 조절해 넓은 색 영역을 한층 더
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> webOS 26 <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button> <span class="bubble">영상부터
                                                                음악, 게임, 앱까지 빠르고 원활하게 접근할 수 있는 플랫폼
                                                                제공</span> </span> </p>
                                                </td>
                                            </tr>
                                            <tr class="procuct-spec last">
                                            ...
                                            <div class="product-table">
                                                ...
                                                <div class="table-wrap margin-custom-x include-tab vertical-scroll-box" style="max-width: 920px;">
                                                    <table>
                                                        <caption class="blind"> LG Micro RGB evo TV 모델 라인업 스펙 비교표 - 해상도, 컬러, 주사율, 사운드, 운영체제와 리모컨 정보를 비교합니다.
                                                        </caption>
                                                        <colgroup>
                                                            <col class="col1" />
                                                            <col />
                                            ...
                                            <div id="product-type-3" name="product-type" style="display: none">
                                                <div class="img-wrap">
                                                    <div class="bubble-wrap left"
                                                        ...
                                                        <button type="button" class="dot" aria-label="제품 정보 보기"><span></span></button>
                                                        <div class="bubble">
                                                            <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001181&SUB_CATE_ID_PARAM=CT50041000" target="_blank"
                                                                rel="noopener"
                                                                title="새창열림"><span>LG
                                                    ...
                                                    <img src="/kr/story/buying-guide/2025/img/tv/mini_rgb_evo_01.jpg"
                                                        alt="따뜻한 톤의 거실에 스탠드 TV가 설치되어 있고, 화면의 알록달록 색감의 보석이 공간 전체에 세련된 분위기를 더하는 모습입니다." class="pc-only" />
                                                    <img src="/kr/story/buying-guide/2025/img/tv/mini_rgb_evo_02.jpg"
                                                        alt="따뜻한 톤의 거실에 스탠드 TV가 설치되어 있고, 화면의 알록달록 색감의 보석이 공간 전체에 세련된 분위기를 더하는 모습입니다." class="mobile-only" />
                                                </div>
                                                <div class="text-wrap">
                                                    <h4>
                                                        풍부하고 생생한 색감으로<br>
                                                    ...
                                                    <div class="procuct-summary vertical-scroll-box" style="--max-table-width: 620px">
                                                        ...
                                                        <div class="summary-table">
                                                            <table class="single no-btn">
                                                                <caption class="blind">LG Mini RGB evo TV 대표 모델 비교표 - 풍부하고 생생한 색감의 주요 특징을 확인할 수 있습니다.</caption>
                                                                <thead>
                                                                    <tr class="procuct-name">
                                                                        <th scope="col">
                                                                            <h4>RGB</h4>
                                                ...
                                                <td>
                                                    <div class="procuct-img"> <img src="/kr/story/buying-guide/2025/img/tv/Mini_RGB_evo_front.png"
                                                            ...
                                                            alt="TV LG Mini RGB evo 측면 이미지" class="side" /> <button
                                                            class="btn-angle" name="btn-angle"> 다른 각도 보기 </button>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> Mini RGB 정밀 컬러<br>(더블 100% 컬러) <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                ...
                                <p class="des3-item"> 본 내용은 라인업의 대표 모델 기준 사양으로 작성되었으며, 모델별 사양은 상이할 수 있습니다. <br> 구매 시
                                    선택하신 모델의 제품 정보 페이지에 기재된 사양을
                                    확인해 주시기 바랍니다. </p>
                                <p class="des3-item">26년 출시 제품을 기준으로 작성된 표로, 제품별 스펙은 다를 수 있으니 정확한 내용은 제품별 상세 스펙을 확인해주세요.</p>
                                </div>

                            <div class="btn-wrap"> <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001181&SUB_CATE_ID_PARAM=CT50041000"
                        ...
                        <div class="product-table">
                            ...
                            <div class="table-wrap margin-custom-x include-tab vertical-scroll-box" style="max-width: 920px;">
                                <table>
                                    <caption class="blind"> LG Mini RGB evo TV 모델 라인업 스펙 비교표 - 해상도, 컬러, 주사율, 사운드, 운영체제와 리모컨 정보를 비교합니다. </caption>
                                    <colgroup>
                                        <col class="col1" />
                                        <col />
                                        <col />
                    ...
                    <div id="product-type-4" name="product-type" style="display: none">
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                ...
                                class="pc-only" /> <img src="/kr/story/buying-guide/2025/img/tv/img_M14_001_07.jpg"
                                alt="밝은 거실 공간에 대형 TV가 놓여 있으며, 화면의 생동감 넘치는 원색 추상 패턴이 공간에 활기와 선명한 분위기를 더하는 이미지입니다."
                                class="mobile-only" />
                        </div>
                        <div class="text-wrap">
                            <h4> LG만의 QNED 컬러 솔루션으로 <br>마치 눈앞에 있는 듯 생생하게 </h4>
                            <p> 나노셀 기반의 LG의 고색재현 기술을 적용해 <br class="mo-only">색 표현을 강화하고, 전 모델 컬러볼륨 100% 인증을<br class="mo-only"> 받은 프리미엄 LCD
                                TV입니다.<br class="mo-only">
                                AI 프로세서가 화질과 사운드를 자동으로 분석하고<br class="mo-only"> 최적화해 선명한 4K 시청 경험을 제공합니다. </p>
                            </div>
                            <div class="guide-disclaimer guide-disclaimer--pc-right">
                                <p class="guide-disclaimer__item">소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.</p>
                            </div>
                        <div class="compare-wrap">
                            ...
                            <div class="procuct-summary vertical-scroll-box" style="--col-width: 50%; --max-table-width: 620px">
                                ...
                                <div class="summary-table">
                                    <table class="no-btn">
                                        <caption class="blind">
                                            LG QNED TV 대표 모델 비교표 - 컬러와 화질 경험을 강화한 QNED 라인업의 주요 특징을 확인할 수 있습니다.
                                        </caption>
                                        <thead>
                                            <tr class="procuct-name">
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="des">
                                                            <button class="info pc-only" aria-label="제품 내용 상세보기"></button>
                                                            <span class="bubble">LG만의 고색재현 기술로 색의 깊이와 생동감 있는 컬러 구현
                                                            </span>
                                                        </span>
                                                    </p>
                                                </td>
                            ...
                            <div class="btn-wrap">
                                ...
                                <div class="product-table">
                                    ...
                                    <div class="table-wrap include-tab vertical-scroll-box">
                                        <table>
                                            <caption class="blind">
                                        LG QNED TV 모델 라인업 스펙 비교표 - QNED9*, QNED86, QNED82, QNED80, QNED 70 모델의 해상도, 컬러, 주사율, 사운드,
                                        운영체제와 리모컨 정보를 비교합니다.
                                    </caption>
                                    <colgroup>
                                        <col class="col1" />
                    ...
                    <div id="product-type-5" name="product-type" style="display: none">
                        ...
                        <div class="compare-wrap">
                            ...
                            <div class="procuct-summary vertical-scroll-box" style="--max-table-width: 620px">
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        <caption class="blind">
                                            LG 나노셀 TV 대표 모델 비교표 - 퓨어 컬러로 완성한 리얼 4K 나노셀 라인업의 주요 특징을 확인할 수 있습니다.
                                        </caption>
                                        <thead>
                                            <tr class="procuct-name">
                                                <th scope="col">
                        ...
                        <div class="compare-wrap">
                            ...
                            <div class="procuct-summary vertical-scroll-box" style="--max-table-width: 620px">
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        <caption class="blind"> LG NANO 4K UHD TV 대표 모델 비교표 - 디테일이 살아있는 선명한 화질의 NANO 4K
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="procuct-img"> <img src="/kr/story/buying-guide/2025/img/tv/NANO_4K_UHD_front.png"
                                                            alt="TV LG NANO 4K UHD 제품 이미지" class="front" /> <img
                                                            src="/kr/story/buying-guide/2025/img/tv/NANO_4K_UHD_side.png"
                                                            alt="TV LG NANO 4K UHD 측면 이미지" class="side" /> <button
                                                            class="btn-angle" name="btn-angle"> 다른 각도 보기 </button>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="procuct-spec">
                                                <td>
                                                    ...
                                                    <p> HDR10 PRO <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button> <span
                                                                class="bubble">장면별로 명암비와 컬러를 극대화하여 더 밝고, 생동감 넘치는 화질
                                                                구현</span> </span> </p>
                                                </td>
                                            </tr>
                                            <tr class="procuct-spec">
                                            ...
                                            <tr class="procuct-spec last gray">
                                                <td>
                                                    ...
                                                    <p> 게이밍 주사율 60Hz <span class="des"> <button class="info pc-only" aria-label="제품 내용 상세보기"></button> <span
                                                                class="bubble">60Hz 가변 주사율로 끊김 없이 즐기는 게임 환경</span>
                                                        </span> </p>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="img-wrap">
                            <div class="bubble-wrap left"
                                ...
                                <div class="bubble"> <a href="https://www.lge.co.kr/category/tvs?lineupId=CD00001006" target="_blank" rel="noopener"
                                        title="새창열림"><span>LG 울트라 HD TV AI</span></a>
                                    <p>스탠드/벽걸이형<span></span>4K</p>
                                </div>
                                ...
                                class="pc-only" /> <img src="/kr/story/buying-guide/2025/img/tv/img_M14_001_09.jpg"
                                alt="밝은 거실에 TV가 놓여 있고, 화면에는 다채로운 색상의 구 모양 오브제들이 선명하게 표현되어 공간에 생동감과 화려한 분위기를 더합니다."
                                class="mobile-only" />
                        </div>
                        <div class="text-wrap">
                            <h4>선명한 4K 화질과 AI 기능을 <br>합리적 가격으로 부담 없이</h4>
                            <p> 4K 해상도와 HDR 기술로 장면별 밝기와 색감을 조정해 또렷한 화면을 제공하며, AI 프로세서가 영상과 사운드를 분석해 시청 환경을 최적화합니다.
                        ...
                        <div class="compare-wrap">
                            ...
                            <div class="procuct-summary vertical-scroll-box" style="--max-table-width: 620px">
                                ...
                                <div class="summary-table">
                                    <table class="single no-btn">
                                        <caption class="blind">
                                            LG 울트라 HD TV 대표 모델 비교표 - 선명한 4K 화질의 울트라 HD 라인업 주요 특징을 확인할 수 있습니다.
                                        </caption>
                                        <thead>
                                            <tr class="procuct-name">
                                                <th scope="col">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-1-1" name="buying-point-1">
                                    ...
                                    <div class="content">
                                        <h5>LCD와 올레드의 차이</h5>
                                        <p>
                                            TV는 백라이트 없이 스스로 빛을 내는 올레드 TV와<br class="mo-only"> 백라이트의 빛을 LCD를 이용해 조절하는 LCD TV<br class="mo-only"> (LED TV, 미니LED
                                            TV 등) 로 나뉘어요.<br class="mo-only"> 올레드
                                            TV는 픽셀 단위로 빛과 색을 직접 조절해<br class="mo-only"> 정확한 블랙과 무한대 명암비를 구현하고,<br class="mo-only"> 백라이트 없이 스스로 빛을 냅니다.<br
                                                class="mo-only"> 반면 LCD
                                            TV는 백라이트를 통해 화면을
                                            표현하고,<br class="mo-only"> 빛 번짐과 블랙 표현에 한계가 있지만, 미니 LED와<br class="mo-only"> 고색재현 기술 등 정교한 백라이트 제어 기술을 적용해<br
                                                class="mo-only"> 생생하고 균일한
                                            화질을 제공합니다.
                                        </p>
                                        <div class="img">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="img video-contain">
                                            ...
                                            <video autoplay playsinline loop muted
                                                src="/kr/story/buying-guide/2025/video/tv/OLEDG6_01_01.mp4"></video>
                                        </div>
                                        <p class="des asterisk-note-list">
                                            <span class="asterisk-note-list__item">
...
<div class="content">
                                                <h5>하이퍼 올레드 컬러</h5>
                                                <p>
                                                    올레드는 세상의 모든 색을 만드는 빛의 삼원색인<br class="mo-only"> 레드, 그린, 블루를 온전히 담아 순수하고
                                                    정확한 컬러를 <br class="mo-only">표현할 수 있습니다. <br class="mo-only">글로벌 인증기관으로부터 인증 받은 100% 컬러 볼륨과 <br class="pc-only"><br
                                                        class="mo-only">
                                                    100% 색 정확도로 원작의 색 왜곡 없이 실물 그대로의 <br class="mo-only">색감을 담아냅니다.
                                                </p>
                                                <div class="img">
                                                    <img src="/kr/story/buying-guide/2025/img/tv/OLEDG6_01_02_pc.png" alt="화려한 컬러의 장면이 표시된 올레드 TV 화면 이미지" />
                                                </div>
                                                <p class="des asterisk-note-list">
                                            <span class="asterisk-note-list__item">
                                                소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.
                                                ...
                                                <button class="btn-collapse-toggle">
                                                    <span class="asterisk-toggle-label">
                                                        ...
                                                        <b>[100% 컬러 볼륨 인증]</b>
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ① 인증 기관 : Intertek
                                                        </span>
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ② 인증 기준일 : 2025년 12월
                                                    ...
                                                    <p class="asterisk-note-list">
                                                        ...
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ...
                                                            <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                                ④ 인증 내용 (인증 번호) : 500lux 환경에서 CIE DE 2000에 따른<br class="mo-only"> 125가지 색상 패턴의 목푯값과 측정값 차이가 2.0보다 작아<br
                                                                    class="mo-only"> 색 정확도 100% 기준 충족
                                                                (24KRQ0950-02)
                                                </span>
                                            </p>
                                            ...
                                            <div class="content">
                                                <h5>퍼펙트 블랙 &amp; 퍼펙트 컬러</h5>
                                                <p>
                                                    픽셀 하나하나 필요한 부분에 필요한 만큼의<br class="mo-only"> 빛을 켜기 때문에 완벽한 블랙을 표현할 수 있습니다.<br class="mo-only"> <br class="pc-only">
                                                    밝은 곳에서도 흔들리지 않는 진정한 블랙과 선명한<br class="mo-only"> 컬러로 밝은 거실에서도 블랙이 회색으로
                                                    흐려지지 않고<br class="mo-only"> 선명한 컬러를 제공합니다.
                                                </p>
                                                <div class="img video-contain">
                                                    <button class="btn-pause">일시멈춤</button>
                                                    <video autoplay playsinline loop muted src="/kr/story/buying-guide/2025/video/tv/OLEDG6_01_03_01.mp4"></video>
                                                </div>
                                                <p class="des asterisk-note-list">
                                                    <span class="asterisk-note-list__item">
                                                        ...
                                                        <span class="asterisk-note-list__item">
                                                            실제 성능은 시청환경에 따라 달라질 수 있습니다.
                                                        </span>
                                                        </p>
                                                        <button class="btn-collapse-toggle">
                                                            <span class="asterisk-toggle-label">
                                                퍼펙트 블랙 인증 / 퍼펙트 컬러 인증 / 100% 색 정확도 인증 / <br class="mo-only">
                                                100% 컬러 볼륨 인증 / Reflection Free Premium 인증
                                                </span>
                                                </button>
                                                <div class="collapse-content">
                                                    <p class="asterisk-note-list">
                                                ...
                                                <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                    ...
                                                    <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                        ④ 인증 내용 (인증 번호) : 최대 500lux 환경에서 블랙 휘도 0.24nit 이하 (V183632)
                                                        </span>
                                                    </p>
                                                    <p class="asterisk-note-list">
                                                        <b>[퍼펙트 컬러 인증]</b>
                                                        ...
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ④ 인증 내용 (인증 번호) : 최대 500lux 환경에서 색 일관성 99% 이상 (V569367)
                                                        </span>
                                                        </p>
                                                    <p class="asterisk-note-list">
                                                        <b>[100% 색 정확도 인증]</b>
                                                        ...
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ...
                                                            <p class="asterisk-note-list">
                                                        <b>[Reflection Free Premium 인증]</b>
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ① 인증 기관 : Intertek
                                                        </span>
                                                        <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                            ...
                                                            <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                                ③ 인증 대상 : 2026년형 OLED W6 / G6 모듈 기준 (97형 제외)
                                                </span>
                                                <span class="asterisk-note-list__item no-bullet numbered-note numbered-note--tight">
                                                    ④ 인증 내용 (인증 번호) : 전원을 끈 상태에서 550nm 파장의<br class="mo-only"> SCI 반사율 측정 시 측정값 0.5% 미만 (23KRQ0587-04)
                                                </span>
                                            </p>
                                            <button class="btn-collapse-close">접기</button>
                                            </div>
                                        ...
                                        <h5>넓은 시야각</h5>
                                        <p>
                                            어느 각도에서도 선명한 화질을 제공해 거실과 같은<br class="mo-only"> 넓은 공간에서 여러 명이 함께 시청해도 <br class="pc-only"> 왜곡 없이<br class="mo-only"> 즐길
                                            수
                                            있습니다.
                                        </p>
                                        <div class="img">
                                            ...
                                            <div class="content">
                                                <h5>홈 시네마 구현</h5>
                                                <p>
                                            마치 우리 집에 영화관을 옮겨 놓은 듯, 돌비비전의 원작<br class="mo-only"> 그대로의 선명한 색감과 <br class="pc-only">돌비 애트모스의 입체
                                            사운드로 <br class="mo-only">영화 속 생생한
                                            몰입감을 경험할 수 있습니다.
                                        </p>
                                        <div class="img">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            13년 연속 세계 판매 1위를 기록한 LG 올레드. <br class="pc-only"><br class="mo-only">
                                            어떤 TV를 살지 고민된다면, 세계에서 가장 많이<br class="mo-only"> 선택 받은 LG 올레드가 정답입니다.
                                        </p>
                                        <div class="img">
                                            <img src="/kr/story/buying-guide/2025/img/tv/img_P14_101_09.jpg" alt="세계 판매 1위 올레드 TV 13년 연속 기록을 안내하는 그래픽 이미지" />
                                            </div>
                                            <p class="des asterisk-note-list">
                                                <span class="asterisk-note-list__item">
                                                    소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.
                                            ...
                                            <span class="asterisk-note-list__item">
                                                2024년 CES 혁신상 수상: Digital Imaging / Photography, Audio/Video Components & Accessories, Video Displays 부문(88OLEDZ3),
                                                Digital Imaging / Photography 부문(118” 4K Micro LED), Embedded Technologies, Audio/Video Components & Accessories 부문
                                                (OLED M4), Gaming & eSports 부문(83OLEDM4), Audio/Video Components & Accessories 부문 (83OLEDC4), Mobile Devices,
                                                Accessories & Apps, Content & Entertainment 부문(StanbyME Go LX5), Video Display, Embedded Technologies, Digital
                                                Imaging / Photography 부문(4K Transparent OLED T), Content & Entertainment 부문<br class="mo-only">(Voice ID 기반 컨텐츠 추천),
                                                Digital Health 부문 (Intelligent Fit), Content & Entertainment 부문(Transparent Screen UX), Artificial Intelligence (AI)
                                                부문(LG Imagine Live)​
                                            </span>
                                            <span class="asterisk-note-list__item">
                                                CES혁신상은 제출된 설명 자료에 근거하여 심사하는 상으로, 수여기관인 CTA는 지원서나 주장 내용의 사실관계를 입증하거나, 수상제품 테스트를 진행하지 않습니다.
                                            </span>
                                            <span class="asterisk-note-list__item">
                                ...
                                <div class="point-wrap" id="buying-point-1-3" name="buying-point-1" style="display: none">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Micro RGB Technology는 LG만의 독자적인 기술로 트리플 100% 컬러 인증을 획득한 차세대 디스플레이 백라이트
                                            기술입니다. <br class="pc-only">
                                            고색순도 RGB 스펙트럼 디스플레이가 적용되어 색을 보다 정확하고 선명하게 표현하며, <br class="pc-only">기존 Mini LED 백라이트 대비 더욱 풍부한
                                            컬러와 명암비를 제공합니다.
                                        </p>
                                        <div class="btn-wrap">
                                    ...
                                    <div class="content">
                                        <h5>3원색의 선명한 컬러 Mini RGB evo</h5>
                                        <p>
                                            3원색인 R (빨강), G (초록), B (파랑)를<br class="mo-only"> 정밀 컬러 기술로 섬세하게 구현해 일반적인 LED,<br class="mo-only"><br class="pc-only">
                                            미니 LED보다 더 넓은 색 영역을 표현합니다.<br class="mo-only"> 정밀한 RGB 색상 제어 기술을 기반으로 디지털<br class="pc-only">
                                            시네마<br class="mo-only"> 표준(DCI-P3)과 사진 · 그래픽 표준(Adobe RGB)<br class="mo-only"> 두 가지 색 기준을 모두 100% 충족해<br
                                                class="pc-only">
                                            더블 100%<br class="mo-only"> 컬러 인증을 획득하여 영화는 물론 사진과 이미지 <br class="mo-only">작업에서도 보다 정확하고<br class="pc-only">
                                            풍부하게 색을 표현합니다.
                                        </p>
                                        <div class="btn-wrap">
                                            <a class="btn-product" href="https://www.lge.co.kr/category/tvs?lineupId=CD00001181&SUB_CATE_ID_PARAM=CT50041000"
                                                target="_blank" rel="noopener" title="새창열림">제품 보러 가기</a>
                                        </div>
                                        <div class="img">
                                            <img src="/kr/story/buying-guide/2025/img/tv/mini_rgb_evo_buying_point.jpg"
                                                alt="거실 공간에 설치된 TV 화면에 빨강, 초록, 파랑 등 선명한 색상의 보석 이미지가 표시된 모습" />
                                        </div>
                                        <p class="des asterisk-note-list">
                                            <span class="asterisk-note-list__item">
                                                소비자의 이해를 돕기 위해 연출된 이미지이며, 제품별 색상 및 스펙은 다를 수 있습니다.
                                            ...
                                            <span class="asterisk-note-list__item">
                                                레드 칩을 대신한 레드 부스터와 그린 · 블루 칩이 동시 발광하는 구조로 RGB 정밀 컬러 구현
                                            </span>
                                        </p>
                                        </div>
                                        <div class="content">
                                        ...
                                        <p>
                                            QNED의 상위 라인업인 QNED evo는 QNED TV의<br class="mo-only"> 정교한 색감에 더해 빛을 더 섬세하게<br class="pc-only"> 제어하는<br class="mo-only">
                                            미니 LED를 적용했습니다.
                                            작은 디테일까지 더 선명하게,<br class="mo-only">
                                            블랙은 더 깊게, 컬러는 더<br class="pc-only"> 생생하게 표현해줍니다.
                                        </p>
                                        <div class="btn-wrap">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            기존 나노셀 TV에서 색 재현율, 명암비, 밝기를 개선해<br class="mo-only"> 출시한 QNED TV 입니다. <br class="pc-only"> 순도 높은 컬러를 표현하는<br
                                                class="mo-only"> 나노셀 기준, 각각의
                                            색 표현을 끌어올리는<br class="mo-only">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            1나노미터(nm)의 미세 입자를 적용해 불순한 색의<br class="mo-only"> 파장을 제거하고 색의 순도를 높여 실제 눈으로 보는 듯<br class="mo-only"> 생생하게 표현해줍니다. 넓은
                                            시야각으로<br class="mo-only"> 어떤 각도에서
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            나노 디테일 향상 기술로 화면 속 미세한 명암과 질감,<br class="mo-only"> 윤곽선을 정밀하게 분석해 작은 디테일까지<br class="mo-only"> 또렷하게 표현해주고, 머리카락 한 올의
                                            결, 옷감의 질감, <br class="mo-only">풍경의 섬세한 입자까지 자연스럽게 살아나 <br class="mo-only">더욱 깊이 있고
                                            입체적인 화면을 완성합니다.
                                        </p>
                                        <div class="btn-wrap">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="btn-wrap">
                                            <a class="btn-product"
                                                href="https://www.lge.co.kr/category/tvs?lineupId=CD00001006&SUB_CATE_ID_PARAM=CT50000030"
                                                target="_blank" rel="noopener" title="새창열림">제품 보러 가기</a>
                                        </div>
                                        <div class="img">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-2-1" name="buying-point-2">
                                    ...
                                    <div class="content">
                                        <h5>190cm 이상</h5>
                                        <p>
                                            거실은 물론 별도 공간에서도 영화관처럼 홈시어터를<br class="mo-only"> 꾸릴 수 있을 만큼 초대형 화면과 8K 고화질로 생동감<br class="mo-only"> 넘치는 영상을 즐길 수
                                            있습니다.
                                        </p>
                                        <div class="btn-wrap">
                                ...
                                <div class="point-wrap" id="buying-point-2-2" name="buying-point-2" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>165~190cm</h5>
                                        <p>
                                            거실에서 가장 대중적으로 선호되는 사이즈로,<br class="mo-only"> 영화는 물론, 스포츠나 게임까지 대형 화면으로 한층 더 <br class="mo-only">생생하게 즐길 수 있습니다.
                                        </p>
                                        <div class="btn-wrap">
                                ...
                                <div class="point-wrap" id="buying-point-2-4" name="buying-point-2" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>109~139cm</h5>
                                        <p>
                                            침실이나 개인 공간에 서브 TV로 사용하기에 알맞은 크기입니다. 책상 위에서 모니터나 게이밍 TV로 활용할 수 있어 공간 효율도 높일 수
                                            있습니다.
                                        </p>
                                        <div class="btn-wrap">
                                ...
                                <div class="point-wrap" id="buying-point-2-5" name="buying-point-2" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>권장 TV 사이즈</h5>
                                        <p>
                                            앉는 위치에서 TV까지의 거리를 기준으로 화면 크기를 계산하면 더 편안하고 몰입감 높은 시청 환경을 만들 수 있습니다. 시청 거리(m)에 100÷1.2를 곱해 적정 TV 사이즈(cm)를 확인하고, <br
                                                class="pc-only"> 우리 집에 맞는
                                            TV를 선택해보세요.
                                        </p>
                                        <div class="img">
                        ...
                        <div class="point-tip">
                            ...
                            <div class="tip-content">
                                <div class="content">
                                    ...
                                    <p class="tip-text">
                                        우리 집에는 어떤 사이즈의 TV가 잘 어울릴지 고민되시나요? 요즘은 콘텐츠가 다양해지고 온라인 수업과 재택근무까지 늘면서, 큰 화면일수록
                                        활용도와 몰입감이 높아지고
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-3-1" name="buying-point-3">
                                    ...
                                    <div class="content">
                                        <h5>알파11 AI 프로세서</h5>
                                        <p>
                                            내가 보는 영상과 사운드를 알아서 분석해 최적의 화질과 <br class="mo-only">사운드를 바꿔주는 올레드의 13년 기술이 담긴 똑똑한 <br class="mo-only">프로세서에요. 5.6배
                                            향상된 AI 성능과 50%
                                            빨라진<br class="mo-only"> 처리 속도, 70% 개선된 그래픽 성능으로 원본 그대로<br class="mo-only"> 생생하게 고화질 영상과 게임을 즐길 수 있습니다.
                                        </p>
                                        <div class="btn-wrap">
                                ...
                                <div class="point-wrap" id="buying-point-3-2" name="buying-point-3" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>AI 화질 프로</h5>
                                        <p>
                                            장면을 세밀하게 분석하고 픽셀 단위로 업스케일해 <br class="mo-only">더 부드럽고 선명한 4K 화질로 감상할 수 있고 밝기, <br class="mo-only">선명도, 대비까지 섬세하게
                                            조절해줍니다.
                                        </p>
                                        <div class="img">
                                            <button class="btn-pause">일시멈춤</button>
                                ...
                                <div class="point-wrap" id="buying-point-3-3" name="buying-point-3" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>AI 사운드 프로</h5>
                                        <p>
                                            마치 14개의 스피커에 둘러싸인 듯 공간을 가득 채우는 입체 서라운드와 배경음 속에서도 등장인물의 목소리를 추출해 더욱 또렷하고 선명하게
                                            대사를 전달합니다.
                                        </p>
                                        <div class="img">
                                        ...
                                        <div class="collapse-content">
                                            <p class="asterisk-note-list">
                                                ...
                                                <span class="asterisk-note-list__item">
                                                    버추얼 11.1.2 서라운드는 영상의 사운드를 분석해 가상의 스피커 채널을 추가하는(업믹싱) AI 기술입니다.
                                                </span>
                                                <span class="asterisk-note-list__item">
                                ...
                                <div class="point-wrap" id="buying-point-3-4" name="buying-point-3" style="display: none">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="collapse-content">
                                            <p class="asterisk-note-list">
                                                <span class="asterisk-note-list__item">
                                                    webOS 26의 일부 AI 서비스 및 OTT 기능을 이용하려면 LG 계정 로그인 및 관련 이용약관 동의가 필요합니다.
                                                </span>
                                                <span class="asterisk-note-list__item">
                                                ...
                                                <span class="asterisk-note-list__item">
                                                    Gemini & Copilot은 4월부터 순차 업데이트 예정이며, 서비스 제공 시점은 변경될 수 있습니다.
                                                </span>
                                            </p>
                                            <button class="btn-collapse-close">접기</button>
                                        </div>
                                ...
                                <div class="point-wrap" id="buying-point-3-6" name="buying-point-3" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>AI 매직 리모컨</h5>
                                        <p>
                                            가장 자주 사용하는 기능만 담아 컴팩트하게 완성한 <br class="mo-only">AI 매직 리모컨입니다. <br>
                                            홈 버튼으로 webOS에 바로 접속하고, AI 버튼으로<br class="mo-only"> 궁금한 점을 물어보거나 도움을 요청할 수 있으며,<br class="mo-only">
                                        ...
                                        <p class="des asterisk-note-list">
                                            ...
                                            <span class="asterisk-note-list__item">
                                                TV의 AI 기능에 빠르게 접근할 수 있도록 설계된 제품으로, 자체적인 AI 처리 기능은 포함되어 있지 않습니다.
                                            </span>
                                            <span class="asterisk-note-list__item">
                                                webOS 26의 일부 AI 서비스 및 OTT 기능을 이용하려면 LG 계정 로그인 및 관련 이용약관 동의가 필요합니다.
                                            </span>
                                ...
                                <div class="point-tip">
                                    ...
                                    <div class="tip-content">
                                        ...
                                        시간을 보내곤 합니다. LG
                                        AI TV와 함께라면<br class="mo-only"> 그런 고민은 끝! 볼 만한 콘텐츠를 추천해주고, <br class="mo-only">날씨ㆍ뉴스 같은 실시간 정보 확인부터 해외여행 일정<br
                                            class="mo-only"> 계획까지 AI가 쉽고
                                        빠르게 도와줍니다.
                                    </p>
                                </div>
                                <div class="img">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-4-1" name="buying-point-4">
                                    ...
                                    <div class="content">
                                        <h5>무선 올레드 TV</h5>
                                        <p>
                                            LG 시그니처 OLED M 시리즈는 세계 최초 무선 연결로 모든 연결을 제로 커넥트 박스 하나에 담아 주변기기의 복잡한 선을 없애 공간을
                                            깔끔하게, 원하는 곳 어디든
                                            자유롭게 설치할 수 있습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-4-2" name="buying-point-4" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>아트 오브제 디자인</h5>
                                        <p>
                                            LG 올레드 오브제컬렉션 Pose (포제) TV는 벽에 걸거나 <br class="mo-only">스탠드에 놓는다는 고정관념을 깨고, 예술작품처럼<br class="mo-only"> 인테리어의 일부가 되도록
                                            디자인되었습니다.<br class="mo-only"> TV를
                                            시청하지 않을 때도 원하는 그림이나 사진을 화면에 <br class="mo-only">띄워 집안을 마치 갤러리처럼 연출할 수 있습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-4-4" name="buying-point-4" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>갤러리 디자인</h5>
                                        <p>
                                            LG 올레드 evo 벽걸이형 (벽밀착)은 벽면에 간격 없이 <br class="mo-only">밀착되어 액자처럼 연출할 수 있고 외부 입력 단자를<br class="mo-only"> 본체에 모두 내장해 마치
                                            벽과 하나 된 듯 깔끔하게<br class="mo-only">
                                            설치할 수 있습니다.
                                        </p>
                                        <div class="img">
                                            <button class="btn-pause">일시멈춤</button>
                                ...
                                <div class="point-wrap" id="buying-point-4-5" name="buying-point-4" style="display: none">
                                    ...
                                    <div class="content">
                                        <h5>갤러리 스탠드</h5>
                                        <p>
                                            TV를 보지 않을 땐 갤러리 스탠드를 활용해 공간을 갤러리처럼 바꿔보세요. 예술 작품을 화면에 띄워 분위기를 전환하거나 인테리어에
                                            감각적인 변화를 줄 수 있습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-wrap" id="buying-point-4-6" name="buying-point-4" style="display: none">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            원하는 곳에서 자유롭게 즐길 수 있는 이동형 스크린으로 집 안 곳곳을 이동하며 공간 제약 없이 콘텐츠를 감상할 수 있습니다. 스탠바이미
                                            Go는 캐리어형 디자인으로
                                            휴대성을 극대화하였습니다.
                                        </p>
                                        <div class="img">
                            ...
                            <div class="subtab-content">
                                <div class="point-wrap" id="buying-point-5-1" name="buying-point-5">
                                    ...
                                    <div class="content">
                                        <h5>버추얼 서라운드</h5>
                                        <p>
                                            공간 곳곳에 스피커가 펼쳐진 듯한 입체적인 음향을 <br class="mo-only">만들어줍니다. 소리가 상하좌우로 자연스럽게 퍼져,<br class="mo-only"> 영상 속에 들어간 듯 한층 깊은
                                            몰입감을 느낄 수 있습니다.
                                        </p>
                                        <div class="img">
                                ...
                                <div class="point-tip">
                                    ...
                                    <div class="tip-content">
                                        ...
                                        LG 사운드바를
                                        추가한다면 WOW 오케스트라 기능으로<br class="mo-only"> TV와 사운드바의 스피커를 동시에 활용해 더 풍성하고<br class="mo-only"> 입체적인 사운드를 경험할 수 있어요.
                                    </p>
                                </div>
                                <div class="img">
                                        ...
                                        <div>
                                            <div class="content-wrap">
                                                <div>
                                                    <h4>webOS 25</h4>
                                                    <p>
                                                        보이스 ID를 등록하면 별도의 조작 없이 자동으로<br class="mo-only"> 로그인되어, 개인 취향에 맞는 콘텐츠와 서비스를 바로<br class="mo-only"> 이용할 수
                                                        있습니다. 간단한 선택만으로 화면과
                                                        사운드를<br class="mo-only"> 각각 최적의 설정값으로 맞춰, 나에게 가장 편안한 <br class="mo-only">감상 환경을 제공합니다. 또한 최대 5년간 webOS<br
                                                            class="mo-only">
                                                    ...
                                                    <p class="asterisk-note-list">
                                                        <b>[webOS 25]</b>
                                                        <span class="asterisk-note-list__item">
                                                            구매한 TV의 기본 탑재된 webOS 버전을 기준으로, 최대 5년간 총 4회의 OS 업그레이드를 지원합니다.
                                                        </span>
                                                        <span class="asterisk-note-list__item">
                                        ...
                                        <div>
                                            <div class="content-wrap">
                                                <div>
                                                    <h4>LG Gallery+</h4>
                                                    <p>
                                                        LG Gallery+를 구독하면 4천여 점 이상의 아트, 사진, 음악 등 다양한 콘텐츠로 TV 화면을 꾸밀 수
                                                    ...
                                                    <div class="media-wrap">
                                                        ...
                                                        <div class="detail-wrap">
                                                            ...
                                                            <div class="collapse-content">
                                                                <p class="asterisk-note-list">
                                                                    <span class="asterisk-note-list__item">
                                                            LG Gallery+의 모든 콘텐츠와 기능을 이용하려면 구독이 필요하며, 유료 구독시 4천여개 이상의 콘텐츠를 제한 없이 이용할 수 있습니다.
                                                        </span>
                                                        <span class="asterisk-note-list__item">
                                                            월간 구독료는 매월 5천 원이며, 구독 시 webOS Pay를 통해 요금이 부과됩니다. 구독료는 추후 변동될 수 있습니다.
                                                        </span>
                                                        <span class="asterisk-note-list__item">
                                                            신규 가입 고객에게는 1개월 무료 체험이 제공되며, 해당 혜택은 사전 안내 없이 변경 및 중단될 수 있습니다.
                                                        </span>
                                                        <span class="asterisk-note-list__item">
