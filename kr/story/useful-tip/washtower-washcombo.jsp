      ...
      <div class="wrap subRenewWrap subRenewWrap--share">
        ...
        <div class="container container-washtower-washcombo">
          ...
          <section class=" page-tit">
            ...
            <div class="main-tab">
              <div class="con-box">
                <button tabindex="0" class="on" data-con="compare">워시타워 &middot; 워시콤보 비교</button>
                <button tabindex="0" data-con="find">내게 맞는 제품 찾기</button>
              </div>
            </div>
          </section>
              ...
              <section id="section1-1" class="solution-survey">
                ...
                <div class="survey-wrap">
                  ...
                  <div class="survey-slot step-slot step1">
                    ...
                    <div class="answer-box">
                      ...
                      <div class="ip-box">
                        <label tabindex="0" for="q1-space-y" class="dp-fade-up">
                          <input hidden type="radio" name="sol-q1" id="q1-space-y" />
                          <p>설치 공간이 충분해요
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q1-space-n" class="dp-fade-up dly1">
                          <input hidden type="radio" name="sol-q1" id="q1-space-n" />
                          <p>설치 공간이 부족해요
                            <i></i>
                          </p>
                        </label>
                    ...
                    <div class="btn-wrap">
                      <button class="prv disabled" tabindex="1" data-btn="prv">이전</button>
                  ...
                  <div class="survey-slot step-slot step2">
                    ...
                    <div class="answer-box">
                      ...
                      <div class="ip-box">
                        ...
                        <label tabindex="0" for="q2-member2" class="dp-fade-up dly1">
                          <input hidden type="radio" name="sol-q2" id="q2-member2" title="2명 혹은 3명이 함께 살고 있어요" />
                          <p>2명 혹은 3명이 함께 살고 있어요
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q2-member3" class="dp-fade-up dly2">
                          <input hidden type="radio" name="sol-q2" id="q2-member3" title="4인 이상이 함께 살고 있어요" />
                          <p>4인 이상이 함께 살고 있어요
                            <i></i>
                          </p>
                        </label>
                    ...
                    <div class="answer-box">
                      ...
                      <div class="ip-box">
                        <label tabindex="0" for="q3-cycle1" class="dp-fade-up">
                          <input hidden type="radio" name="sol-q3" id="q3-cycle1" title="적은 양으로 자주 빨아요" />
                          <p>적은 양으로 자주 빨아요
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q3-cycle2" class="dp-fade-up dly1">
                          <input hidden type="radio" name="sol-q3" id="q3-cycle2" title="중간 양으로 이불은 가끔 빨아요" />
                          <p>중간 양으로 이불은 가끔 빨아요
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q3-cycle3" class="dp-fade-up dly2">
                          <input hidden type="radio" name="sol-q3" id="q3-cycle3" title="많은 양을 한 번에 많이 빨아요" />
                          <p>많은 양을 한 번에 많이 빨아요
                            <i></i>
                          </p>
                        </label>
                  ...
                  <div class="survey-slot step-slot step4">
                    ...
                    <div class="answer-box">
                      ...
                      <div class="ip-box ty2">
                        ...
                        <label tabindex="0" for="q4-function2" class="dp-fade-up dly1">
                          <input hidden type="radio" name="sol-q4" id="q4-function2" title="옷감 관리" />
                          <p>옷감 관리
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q4-function3" class="dp-fade-up dly2">
                          <input hidden type="radio" name="sol-q4" id="q4-function3" title="자동 세제" />
                          <p>자동 세제
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q4-function4" class="dp-fade-up dly3">
                          <input hidden type="radio" name="sol-q4" id="q4-function4" title="아이옷 세탁" />
                          <p>아이옷 세탁
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q4-function5" class="dp-fade-up dly4">
                          <input hidden type="radio" name="sol-q4" id="q4-function5" title="반려동물" />
                          <p>반려동물
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q4-function6" class="dp-fade-up dly5">
                          <input hidden type="radio" name="sol-q4" id="q4-function6" title="세탁 건조 시간" />
                          <p>세탁 건조 시간
                            <i></i>
                          </p>
                        </label>
                        <label tabindex="0" for="q4-function7" class="dp-fade-up dly6">
                          <input hidden type="radio" name="sol-q4" id="q4-function7" title="번거로움 최소화" />
                          <p>번거로움 최소화
                            <i></i>
                          </p>
                        </label>
                        ...
                        <div class="info-box">
                          ...
                          <div class="txt-box">
                            ...
                            <div class="func-nav mo-only">
                              <span class="prv disabled" tabindex="1"></span>
                              <span class="nxt"></span>
                            </div>
                            <div class="swiper">
                        ...
                        <div class="info-box">
                          ...
                          <div class="txt-box">
                            ...
                            <div class="swiper">
                              ...
                              <div class="sld-nav pc-only">
                                <span class="prv" tabindex="0"></span>
                                <span class="nxt" tabindex="0"></span>
                              </div>
                              <div class="pagi"></div>
                            </div>
                          </div>
                      ...
                      <div class="swiper-slide info-slot f_easy">
                        <div class="info-box">
                          ...
                          <div class="txt-box">
                            ...
                            <div class="func-nav mo-only">
                              <span class="prv"></span>
                              <span class="nxt disabled" tabindex="1"></span>
                            </div>
                            <div class="swiper">
                              <ul class="swiper-wrapper">
                                <li class="swiper-slide">
                ...
                <div class="color-info animate__animated animate__fadeInUp">
                  <div class="info-slot color-tower" style="display: block;">
                    ...
                    <div class="swiper-wrap">
                      ...
                      <div class="swiper">
                        <ul class="swiper-wrapper">
                          <li class="swiper-slide on" tabindex="0">
                            <div class="inner">
                              <div class="palette">
                                <span>
