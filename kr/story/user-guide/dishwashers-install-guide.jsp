      ...
      <div class="install-guide-wrap animate__animated animate__fadeIn">
              ...
              <li>
                <div class="btn-recommend" role="tab" tabindex="0" aria-selected="false">
                  ...
                  <p>카운터 탑 전용은 싱크대에 빌트인 하지 않고<br class="pc-show">
                    ...
                    모델입니다.</p>
                  <p><span class="point-color">&#8251; 해당 모델 : DFCF*로 시작하는 모델</span></p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <section class="con-box section03 animate__animated animate__fadeIn">
          <div class="choice-wrap animate__animated animate__fadeInUp" role="tablist">
            ...
            <div class="choice-btn-wrap">
              <button class="on" role="tab" id="choice-tab05" aria-selected="true" aria-controls="choice-panel05">
                <span>
                  <img src="/kr/story/user-guide/images/dishwashers-install-guide/recommend-list05-01.png" alt="카운터 탑 전용 식기세척기">
                </span>
                <em class="font-medium">카운터 탑 설치</em>
              </button>
            </div>
          </div>
          <!--choice-content 리스트-->
          <div class="choice-content animate__animated animate__fadeIn">
                    ...
                    <li class="m-show table-wrap animate__animated animate__fadeInUp">
                      ...
                      <div class="table-detail m-show">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>상판 없는 기준 (Leg 조정 필요)<br><span class="explanation"> 상판이 없는 기준에서
                                  Leg조정가능 높이만<br class="m-show">더하여 최대
                                  880mm 높이까지 설치<br class="m-show">가능하다는 의미입니다.</span>
                              </td>
                            </tr>
                            <tr>
                              <td>815~820</td>
                        ...
                        <div class="table-explanation">
                          <p class="explanation">
                            상판 : 제품 상단의 탑 플레이트를 의미하여 싱크대 높이에<br class="m-show">따라 탈부착하여 설치
                            가능합니다.
                          </p>
                          <p class="explanation">
                            Leg : 식기세척기 제품 바닥면에 제품 높이를 조정할 수<br class="m-show">있도록 스크류 형식으로 된
                            다리입니다.
                          </p>
                          <p class="explanation">
                            제품 설치를 위해서는 최소 높이 815mm의 설치 공간이<br class="m-show">필요합니다.
                          </p>
                          <div>
                          ...
                          <ul class="explanation-notice">
                            <li>※ 주의 : 싱크대 아닌 외부노출 설치 시 제품의 뒷면이 노출되지 않도록
                              설치하십시오. 손가락이 끼어 상해를<br class="m-show"> 입을 수 있습니다.</li>
                  ...
                  <div class="table-section-wrap">
                    ...
                    <ul class="explanation-notice">
                      <li>※ 주의 : 싱크대 아닌 외부노출 설치 시 제품의 뒷면이 노출되지 않도록 설치하십시오. 손가락이 끼어
                        상해를<br class="m-show"> 입을 수 있습니다.</li>
                ...
                <div class="img-cont03">
                  <div class="pc-show animate__animated animate__fadeInUp">
                    ...
                    <div class="img-detail">
                      ...
                      <div class="img-txt">
                        <p class="molding-explanation">식기세척기 높이 조절하여 설치할 경우(빌트인 전용 최대 60mm, 프리스탠딩 겸용 최대
                      ...
                      <div class="img-cont03-tab-cont on" id="molding-panel01" role="tabpanel"
                        ...
                        <div class="pc-show">
                          <div class="img-detail">
                            ...
                            <div class="img-txt">
                              <p class="molding-explanation">식기세척기 높이 조절하여 설치할 경우(빌트인 전용 최대 60mm,
                        ...
                        <table class="table-type02">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>820~850</td>
                              <td>상판 없는 기준 (Leg 조정 필요)<br><span class="explanation"> 상판이 없는 기준에서
                                  Leg조정가능 높이만<br class="m-show">더하여 최대 850mm 높이까지 설치
                                  가능하다는 의미입니다.</span></td>
                            </tr>
                            <tr>
                              <td>815~820</td>
            ...
            <div class="choice-content-list countertop-content">
              <div class="list-content" id="choice-panel05" role="tabpanel" aria-labelledby="choice-tab05">
                <span class="blind">카운터 탑 설치 내용 시작</span>
                <div class="img-cont01 animate__animated animate__fadeInUp">
                  <div>
                ...
                <div class="countertop-install-check animate__animated animate__fadeInUp" hidden>
                  <h5>*설치 장소 확인</h5>
                  <div class="countertop-install-check__inner">
                    <div class="countertop-table-grid">
                      <table class="table-type02">
                        <caption>카운터 탑 식기세척기 설치 장소 내 싱크대 깊이 정보</caption>
                        <colgroup>
                          <col style="width: 25.5319%">
                          <col>
                        </colgroup>
                        <thead>
                          <tr>
                            <th scope="col">싱크대<br>깊이 (mm)</th>
                            <th scope="col">참고사항</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            <td>567~600</td>
                            <td>설치는 가능 / 설치 시 주의<br class="m-show">(급/배수관 눌림 주의)</td>
                          </tr>
                          <tr>
                            <td>532~567</td>
                            <td>제품 전면이 돌출 / 고객 사전 동의 필요</td>
                      ...
                      <table class="table-type02">
                        <caption>카운터 탑 식기세척기 설치 장소 내 싱크대 폭 정보</caption>
                        <colgroup>
                          <col style="width: 25.5319%">
                          <col>
                        </colgroup>
                        ...
                        <tbody>
                          <tr>
                            <td>598 미만</td>
                            <td>설치 불가<br class="m-show">(제품 Size보다 작아서 빌트인 불가)</td>
                          </tr>
                          <tr>
                            <td>598~600</td>
                      ...
                      <table class="table-type02">
                        <caption>카운터 탑 식기세척기 설치 장소 내 싱크대 높이 정보</caption>
                        <colgroup>
                          <col style="width: 25.5319%">
                          <col>
                        </colgroup>
                        ...
                        <tbody>
                          <tr>
                            <td>820~880</td>
                            <td>상판 없는 기준 (Leg 조정 필요)<br>
                              <span class="explanation">*상판이 없는 기준에서 Leg 조정가능 높이만 더하여<br class="pc-show">
                                최대 880mm 높이까지 설치 가능하다는 의미입니다.</span>
                            </td>
                          </tr>
                          <tr>
                            <td>815~820</td>
                      ...
                      <div class="countertop-install-check__explanation">
                        <p class="mobile-star-line">*상판 : 제품 상단의 탑플레이트를 의미하며 싱크대 높이에 따라 탈부착하여 설치 가능합니다.</p>
                        <p class="mobile-star-line">*Leg : 식기세척기 제품 바닥면에 제품 높이를 조정할 수 있도록 스크류 형식으로 된 다리입니다.</p>
                        <p class="mobile-star-line">*제품 설치를 위해서는 최소 높이 815mm의 설치 공간이 필요합니다.</p>
                        <img src="/kr/story/user-guide/images/dishwashers-install-guide/recommend-list01-07.png"
                          alt="식기세척기의 상판과 하단 다리 조절 기능">
                      </div>
                    </div>
                    <ul class="explanation-notice">
                      <li>※ 주의 : 싱크대 아닌 외부노출 설치 시 제품의 뒷면이 노출되지 않도록 설치하십시오. 손가락이 끼어 상해를<br class="m-show"> 입을 수 있습니다.</li>
                      <li>※ 동절기 동결이 발생할 수 있어 식기세척기를 베란다에 설치하는 것은 불가합니다.<br>
                        <span class="notice-indent">(단, 확장공사를 통해 베란다와 주방이 연결되어 있는 경우에는 설치 가능함)</span>
                      </li>
                      <li>※ 빌트인 설치 시에는 식기세척기 설치공간 좌/우 스크류 고정이 가능한 경우에만 설치가 가능합니다.</li>
                    </ul>
                  </div>
                </div>

                <div class="countertop-molding animate__animated animate__fadeInUp" hidden>
        ...
        <section class="con-box section04">
          <div class="notice-cont choice-notice-content">
            <h4 class="main-tit animate__animated animate__fadeIn">
              싱크대 가구장 시공 공사<br>
              <span class="main-txt mobile-notice-indent">※ 시공 단가 기준(24년 4월 15일~)</span>
            </h4>
            <!--pc 테이블-->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="txt-left">
                        ...
                        <h5 class="main-txt mobile-notice-indent">※ 보강 작업에 따라 자재 필요시 별도 비용 발생함</h5>
                      </td>
                      <td>+50,000</td>
                    </tr>
                    <tr>
            ...
            <!--모바일 테이블-->
            <div class="table-wrap m-show mobile-install-table--standard animate__animated animate__fadeInUp">
              <h5 class="table-tit">1. 가구장 - 규격장(폭 600mm)</h5>
            ...
            <div class="table-wrap m-show mobile-install-table--nonstandard animate__animated animate__fadeInUp">
              <h5 class="table-tit">2. 가구장 - 비규격장(폭 600mm 外)</h5>
              <div class="table-cont img-table">
                <table class="table-type01">
                  <caption>
            ...
            <div class="table-wrap m-show mobile-install-table--finish animate__animated animate__fadeInUp">
              <h5 class="table-tit">[비규격장 기타 마감 비용]</h5>
              <div class="table-cont">
                <table class="table-type01">
                  <caption>
              ...
              <p><span class="mobile-notice-line">※ 판토스 시공 불가한 경우, 특수시공업체 추가 비용 발생할 수 있습니다.</span></p>
            </div>
            <div class="table-wrap m-show mobile-install-table--corner animate__animated animate__fadeInUp">
              <h5 class="table-tit">3. 가구장 - 코너장</h5>
              <div class="table-cont img-table">
                <table class="table-type01">
                  <caption>
                ...
                <table class="table-type01">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>150,000 ~</td>
                      <td>LG전문설치기사(판토스)/특수시공업체<br>
                        <span class="mobile-hanging-indent">* 시공 난이도에 따름</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p>
                <span class="mobile-notice-line">※ 코너장 : 구석에 있고 도어를 열면 안쪽, 깊숙히 물건이 수납되는 장</span>
                <span class="mobile-notice-line">※ 판토스 시공 불가한 경우, 특수시공업체 추가 비용 발생할 수 있습니다.</span>
              </p>
            </div>
            <div class="table-wrap m-show mobile-install-table--other animate__animated animate__fadeInUp">
              <h5 class="table-tit">4. 가구장 - 기타</h5>
              <div class="table-cont">
                <table class="table-type01">
                  <caption>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>일체형</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 브랜드 주방가구의 키 큰장 또는 일체형 철거</h5>
                        <span class="mobile-hanging-indent">* 단 키큰장 좌우에 마감판넬이 있는 경우에 한함, 부자재 필요시 별도 비용 발생함</span>
                      </td>
                      <td>300,000</td>
                    </tr>
                    <tr>
                      <td>분리형</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 높이 850mm 이 넘는 경우 철거 후 사이즈에 맞춰 주문장
                          제작</h5>
                        <span class="mobile-hanging-indent">* 단 상단과 하단이 분리되어 있고 하단장 높이(815~850mm)일 경우 철거 무상임</span>
                      </td>
                      <td>100,000</td>
                    </tr>
                    <tr>
                      ...
                      <td>축소</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 서랍장을 철거, 축소하여 식기세척기 공간 확보</h5>
                        <span class="mobile-hanging-indent">* 단 서랍재를 철판으로 조립한 경우 여건에 따라 시공이 불가할 수 있음</span>
                      </td>
                      <td>견적가</td>
                    </tr>
                    <tr>
                      ...
                      <td>축소</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 싱크볼장의 주변장 크기 W 600mm 이하일 경우 싱크볼장
                          축소</h5>
                      </td>
                      <td>300,000</td>
                    </tr>
                    <tr>
                      ...
                      <td>장 타공</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 급배수 호스, 전원연결을 위해 하부장 및 마감판넬 타공
                        </h5>
                      </td>
                      <td>무상</td>
                    </tr>
                    <tr>
                      <td>전기배선정리</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 빼내는 하부장 내부에 전기 플러그 및 단자함 있을 경우 해체 후 재설치</h5>
                      </td>
                      <td>무상</td>
                    </tr>
                    <tr>
                      ...
                      <td>출장비</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 특수시공업체의 사전 방문</h5>
                        <h5 class="main-txt mobile-bullet-indent">• 특수시공업체가 시공을 위해 방문하였으나, 최종적으로 시공
                          진행하지 않았을 경우 출장비</h5>
                      </td>
                      <td>20,000</td>
                    </tr>
            ...
            <div class="table-wrap m-show mobile-install-table--additional animate__animated animate__fadeInUp">
              <h5 class="table-tit">5. 추가 시공 (공통사항)</h5>
              <div class="table-cont">
                <table class="table-type01">
                  <caption>
                  ...
                  <tbody>
                    <tr>
                      <td rowspan="2">장이동</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 식기세척기가 설치될 자리에서 빼낸 규격장의 실용성을 높이고자
                          할때 동일한 벽면 라인에서 장 위치 이동</h5>
                      </td>
                      <td>+30,000<br>
                        (하부장 1개 기준 개당 20,000원씩 추가)</td>
                    ...
                    <tr>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 동일한 벽면 라인이 아닌 아일랜드 또는 대리석 상판에서
                          이탈하여 장 위치 이동</h5>
                      </td>
                      <td>+50,000</td>
                    </tr>
                    <tr>
                      <td>찬넬 (절단 또는 분리)</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 찬넬 소재가 목재 외의 소재로 마감부 커팅 작업 시
                        </h5>
                        <h5 class="main-txt mobile-bullet-indent">• 찬넬이 독립되어 있지 않아 분리를 위해 도어 2개 이상
                          분리해야 할 경우
                        </h5>
                      </td>
                      <td>+30,000</td>
                    ...
                    <tr>
                      <td>싱크대 상판 보강</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 싱크대 작업 시 상판을 받쳐주는 부분이 없어 상판 쳐짐으로
                    ...
                    <tr>
                      <td>장 분리</td>
                      <td class="txt-left">
                        <h5 class="main-txt mobile-bullet-indent">• 장과 장사이에 접착제가 떨어지지 않는 경우 장 분리</h5>
                      </td>
                      <td>+50,000</td>
                    </tr>
                  </tbody>
              ...
              <p>
                <span class="mobile-notice-line">※ 싱크대 노후화 등 환경에 따라 시공비 추가 또는 시공이 불가할 수 있습니다. (ex. 스커드장)</span>
                <span class="mobile-notice-line">※ LG전문설치기사(판토스) 최초 방문했을 때 사전 확인하기 어려운 작업이 있어, 실제 장시공을 위한 방문 시 기 고지되지 않은
                  추가 비용이 발생할 수 있습니다.</span>
              </p>
            </div>
          </div>
          <div class="notice-cont installation-cost-guide animate__animated animate__fadeInUp">
            ...
            <div class="installation-cost-guide__group">
              ...
              <div class="table-cont">
                <table class="table-type01">
                  <caption>식기세척기 공통 설치 추가 비용 - 내용, 단가의 내용을 확인할 수 있습니다.</caption>
                  <colgroup>
                    <col>
                    <col style="width: 30%;">
                  </colgroup>
              ...
              <div class="installation-cost-guide__notes">
                <p>* 걸레받이가 목재 외 알루미늄, 특수 소재로 되어있을 경우,<br class="m-show">가구 업체가 진행해야 함</p>
                <p>* 세라믹 재질 외 싱크대 홀 타공은 외부 업체를 통해 제품 설치 전<br class="m-show">진행해 놓아야 함</p>
              </div>
            </div>
            ...
            <div class="installation-cost-guide__group">
              ...
              <div class="table-cont">
                <table class="table-type01">
                  <caption>빌트인 식기세척기 설치 추가 비용 - 내용, 단가의 내용을 확인할 수 있습니다.</caption>
                  <colgroup>
                    <col>
                    <col style="width: 30%;">
                  </colgroup>
          ...
          <ol class="qna-list animate__animated animate__fadeInUp ani-delay04">
            <li class="qna">
              ...
              <div class="answer">
                ...
                <p><span class="txt-red">네.</span>
                  ...
                  줄일 수 있습니다.<br>
                  <br>
                  <span class="mobile-symbol-line mobile-number-line">1) 프리스탠딩 설치, 규격장 빌트인 설치, 기존 12인용 식기세척기 보유한 고객, 해당 제품 사이즈에 맞춰
                    리모델링 완료한 고객</span><br class="pc-only">
                  <br>
                  <span class="mobile-symbol-line mobile-star-line">* 비규격장의 경우 시공난이도에 따라 LG전문설치기사(판토스),
                    특수시공업체 이원 운영됩니다.<br>
                    LG전문설치기사 시공시 1회방문만으로 One-Stop 설치 가능하며, 특수시공업체 시공이 필요한 경우
                    기존과 동일하게 2회 이상 방문하여 설치합니다.<br>
                    (제품설치 위한 방문 및 점검, 특수시공업체 방문하여 싱크대 공사진행, 제품설치)</span>
                </p>
              </div>
            </li>
            <li class="qna">
              <div class="question" role="button" aria-expanded="false" tabindex="0">
                <span class="blind">질문</span>
                <span>Q2.</span>
                <p>특수시공업체는 꼭 LG전자 협력업체(닥터매직,<br class="m-show">키친앤홈)만 사용해야 하나요?</p>
              </div>
              <div class="answer">
                <span class="blind">답변</span>
                <p><span class="txt-red">업체는
                    권장사항입니다.</span><br>
                    <span class="mobile-symbol-line mobile-star-line">* 단, 해당 업체의 장 시공에 따른 A/S는 1년간 무상
                      제공됩니다. (키친앤홈, 닥터매직)</span><br class="pc-only">
                    <span class="mobile-symbol-line mobile-star-line">* 해당 업체 외에 고객이 원하실 경우 별도 업체로 장 시공
                      진행 가능합니다. 대신 장 시공을 진행 하신 후 제품 설치가 가능합니다.</span>
                </p>
              </div>
            </li>
            <li class="qna">
            ...
            <li class="qna">
              ...
              <div class="answer">
                ...
                <p>
                  ...
                  <span class="mobile-symbol-line mobile-dash-line">- 설치가 불가한 경우 : 영업, 산업, 연구/실험 용도로 사용하는 경우 (상업용 식기세척기를 사용해야 하는 음식점, 카페, 급식 시설, 연구소, 실험실 등)</span><br class="pc-only">
                  <span class="mobile-symbol-line mobile-dash-line">- 무상 보증 기간을 50% 단축하여 적용하는 경우 : 일반 가정 환경과 유사하나 불특정 다수 인원 또는 공용으로 사용하는 경우 (게스트하우스, 어린이집, 회사 탕비실,
                    기숙사 공용 공간, 노인정 공용 공간, 공방 등)</span>
                </p>
              </div>
            </li>
            <li class="qna">
              <div class="question" role="button" aria-expanded="false" tabindex="0">
                <span class="blind">질문</span>
                <span>Q5.</span>
                <p>식기세척기 설치, 걸레받이는 어떻게 해야<br class="m-show">하나요?</p>
              </div>
              <div class="answer">
                <span class="blind">답변</span>
                <p>
            ...
            <li class="qna">
              <div class="question" role="button" aria-expanded="false" tabindex="0">
                <span class="blind">질문</span>
                <span>Q9.</span>
                <p>제품을 주문했는데 배송 관련 정보는 어디서<br class="m-show">확인할 수 있나요?</p>
              </div>
              <div class="answer">
                <span class="blind">답변</span>
                <p>
            ...
            <li class="qna">
              <div class="question" role="button" aria-expanded="false" tabindex="0">
                <span class="blind">질문</span>
                <span>Q10.</span>
                <p>식기세척기 사용법이 궁금해요. 사용하다가 선반<br class="m-show">등 구성품 교체가 필요한 경우 어떻게 하면<br
                    class="m-show">되나요?</p>
              </div>
              <div class="answer">
                <span class="blind">답변</span>
                <p>
                  <span class="txt-red">사용할 수 있는 식기 종류를 확인한 후, 식기를 애벌 세척해요.<br>
                    ...
                    <span class="mobile-symbol-line mobile-number-line">1) 제품별 호환 여부가 궁금하시다면, 구매를 원하시는 소모품 하단에 사용가능모델을 확인해 주세요.</span><br class="pc-only">
                    <span class="mobile-symbol-line mobile-number-line">2) 2단 모델에는 모두 수저통이 기본 제공됩니다.</span><br class="pc-only">
